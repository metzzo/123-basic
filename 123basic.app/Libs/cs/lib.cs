...
namespace OTT
{
    public class OTTException : Exception
    {
        private string text;
        public OTTException( string text )
        {
            this.text = text;
        }
    ...
    public class OTTAssertException : Exception
    {
        private string text;
        public OTTAssertException( string text )
        {
            this.text = text;
        }
    ...
    public static partial class OTTNative
    {
        ...
        public static int GETFILELIST( string find, OTTArray<string> names )
        {
            //TODO
            return 0;
        }
    ...
    public class OTTArray<T>
    {
        ...
        public OTTArray<T> Copy( )
        {
            OTTArray<T> other = new OTTArray<T>( );
