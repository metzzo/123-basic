...
window['main'] = function(){
	...
	try {
		...
		__debugInfo = "37:\123basic.gbas";pool_TGenerator.free(local1_G_1787);
	} catch(ex) {
...
window['GetIdentifierByPart'] = function(param8_Text_Str) {
	...
	try {
		...
		func6_Parser();
		__debugInfo = "194:\123basic.gbas";
		global8_Compiler = local11_tmpCompiler_1790.clone(/* In Assign */);
		__debugInfo = "196:\123basic.gbas";
		return tryClone(local10_Result_Str_1789);
		__debugInfo = "197:\123basic.gbas";
		return "";
		__debugInfo = "179:\123basic.gbas";pool_TCompiler.free(local11_tmpCompiler_1790);
	} catch(ex) {
		if (isKnownException(ex)) throw ex;
		alert(formatError(ex));
		END();
...
window['func8_Analyser'] = function() {
	...
	try {
				...
				try {
					...
					__debugInfo = "88:\src\CompilerPasses\Analyser.gbas";
					{
						...
						if ((((local16___SelectHelper2__1800) === ("PROTOTYPE")) ? 1 : 0)) {
							...
							var forEachSaver2416 = global8_Compiler.attr5_Funcs_ref[0];
							for(var forEachCounter2416 = 0 ; forEachCounter2416 < forEachSaver2416.values.length ; forEachCounter2416++) {
								var local4_func_ref_1803 = forEachSaver2416.values[forEachCounter2416];
							{
								...
								forEachSaver2416.values[forEachCounter2416] = local4_func_ref_1803;
		...
		var forEachSaver2713 = global8_Compiler.attr5_Funcs_ref[0];
		for(var forEachCounter2713 = 0 ; forEachCounter2713 < forEachSaver2713.values.length ; forEachCounter2713++) {
			var local1_F_ref_1808 = forEachSaver2713.values[forEachCounter2713];
		{
				...
				if (local1_F_ref_1808[0].attr10_IsCallback) {
					...
					var forEachSaver2698 = global8_Compiler.attr5_Funcs_ref[0];
					for(var forEachCounter2698 = 0 ; forEachCounter2698 < forEachSaver2698.values.length ; forEachCounter2698++) {
						var local2_F2_ref_1810 = forEachSaver2698.values[forEachCounter2698];
					{
						...
						forEachSaver2698.values[forEachCounter2698] = local2_F2_ref_1810;
			...
			forEachSaver2713.values[forEachCounter2713] = local1_F_ref_1808;
		
		};
		__debugInfo = "175:\src\CompilerPasses\Analyser.gbas";
		var forEachSaver2752 = global8_Compiler.attr5_Funcs_ref[0];
		for(var forEachCounter2752 = 0 ; forEachCounter2752 < forEachSaver2752.values.length ; forEachCounter2752++) {
			var local1_F_ref_1811 = forEachSaver2752.values[forEachCounter2752];
		{
			...
			forEachSaver2752.values[forEachCounter2752] = local1_F_ref_1811;
		...
		var forEachSaver2853 = global8_Compiler.attr5_Types_ref[0];
		for(var forEachCounter2853 = 0 ; forEachCounter2853 < forEachSaver2853.values.length ; forEachCounter2853++) {
			var local3_typ_ref_1817 = forEachSaver2853.values[forEachCounter2853];
		{
				__debugInfo = "232:\src\CompilerPasses\Analyser.gbas";
				func10_ExtendType(unref(local3_typ_ref_1817[0]));
				__debugInfo = "232:\src\CompilerPasses\Analyser.gbas";
			}
			forEachSaver2853.values[forEachCounter2853] = local3_typ_ref_1817;
		
		};
		__debugInfo = "238:\src\CompilerPasses\Analyser.gbas";
		var forEachSaver2866 = global8_Compiler.attr5_Types_ref[0];
		for(var forEachCounter2866 = 0 ; forEachCounter2866 < forEachSaver2866.values.length ; forEachCounter2866++) {
			var local3_typ_ref_1818 = forEachSaver2866.values[forEachCounter2866];
		{
			...
			forEachSaver2866.values[forEachCounter2866] = local3_typ_ref_1818;
...
window['func11_CheckCyclic'] = function(param8_Name_Str, param3_typ) {
	...
	try {
		...
		var forEachSaver3220 = param3_typ.attr10_Attributes;
		for(var forEachCounter3220 = 0 ; forEachCounter3220 < forEachSaver3220.values.length ; forEachCounter3220++) {
			var local1_t_1833 = forEachSaver3220.values[forEachCounter3220];
		{
			...
			forEachSaver3220.values[forEachCounter3220] = local1_t_1833;
	...
	try {
		...
		if ((((param3_typ.attr9_Extending) !== (-(1))) ? 1 : 0)) {
			...
			while ((((local6_tmpTyp_1836) !== (-(1))) ? 1 : 0)) {
				...
				var forEachSaver3288 = global8_Compiler.attr5_Types_ref[0].arrAccess(local6_tmpTyp_1836).values[tmpPositionCache][0].attr7_Methods;
				for(var forEachCounter3288 = 0 ; forEachCounter3288 < forEachSaver3288.values.length ; forEachCounter3288++) {
					var local1_M_1838 = forEachSaver3288.values[forEachCounter3288];
				{
					...
					forEachSaver3288.values[forEachCounter3288] = local1_M_1838;
			...
			var forEachSaver3392 = local9_Abstracts_1837;
			for(var forEachCounter3392 = 0 ; forEachCounter3392 < forEachSaver3392.values.length ; forEachCounter3392++) {
				var local2_Ab_1839 = forEachSaver3392.values[forEachCounter3392];
			{
					...
					while ((((local6_tmpTyp_1836) !== (-(1))) ? 1 : 0)) {
						...
						var forEachSaver3365 = global8_Compiler.attr5_Types_ref[0].arrAccess(local6_tmpTyp_1836).values[tmpPositionCache][0].attr7_Methods;
						for(var forEachCounter3365 = 0 ; forEachCounter3365 < forEachSaver3365.values.length ; forEachCounter3365++) {
							var local1_M_1841 = forEachSaver3365.values[forEachCounter3365];
						{
							...
							forEachSaver3365.values[forEachCounter3365] = local1_M_1841;
				...
				forEachSaver3392.values[forEachCounter3392] = local2_Ab_1839;
			
			};
			__debugInfo = "414:\src\CompilerPasses\Analyser.gbas";
			var forEachSaver3450 = alias6_ExtTyp_ref_1835[0].attr10_Attributes;
			for(var forEachCounter3450 = 0 ; forEachCounter3450 < forEachSaver3450.values.length ; forEachCounter3450++) {
				var local1_A_1842 = forEachSaver3450.values[forEachCounter3450];
			{
					...
					var forEachSaver3438 = param3_typ.attr10_Attributes;
					for(var forEachCounter3438 = 0 ; forEachCounter3438 < forEachSaver3438.values.length ; forEachCounter3438++) {
						var local2_A2_1845 = forEachSaver3438.values[forEachCounter3438];
					{
						...
						forEachSaver3438.values[forEachCounter3438] = local2_A2_1845;
				...
				forEachSaver3450.values[forEachCounter3450] = local1_A_1842;
...
window['func5_Error'] = function(param7_Msg_Str, param4_Line, param8_File_Str) {
	...
	try {
		...
		return 0;
		__debugInfo = "387:\src\Compiler.gbas";pool_TToken.free(local3_tok_1850);
	} catch(ex) {
		if (isKnownException(ex)) throw ex;
		alert(formatError(ex));
		END();
...
window['func7_Warning'] = function(param7_Msg_Str) {
	...
	try {
		...
		return 0;
		__debugInfo = "412:\src\Compiler.gbas";pool_TToken.free(local3_tok_2575);
	} catch(ex) {
		if (isKnownException(ex)) throw ex;
		alert(formatError(ex));
		END();
...
window['func15_GetCurrentToken'] = function() {
	...
	try {
		...
		if ((((global8_Compiler.attr11_currentPosi) < (global8_Compiler.attr11_LastTokenID)) ? 1 : 0)) {
			...
			__debugInfo = "460:\src\Compiler.gbas";pool_TToken.free(local1_t_1851);
		};
...
window['func14_CreateDatatype'] = function(param8_Name_Str, param7_IsArray) {
	...
	try {
		...
		__debugInfo = "518:\src\Compiler.gbas";pool_TDatatype.free(local1_d_2588);
	} catch(ex) {
		if (isKnownException(ex)) throw ex;
		alert(formatError(ex));
		END();
...
window['func14_CreateOperator'] = function(param8_Name_Str, param7_Sym_Str, param4_Prio, param3_Typ) {
	...
	try {
		...
		return 0;
		__debugInfo = "533:\src\Compiler.gbas";pool_TOperator.free(local2_Op_ref_2593);
	} catch(ex) {
		if (isKnownException(ex)) throw ex;
		alert(formatError(ex));
		END();
...
window['func11_AddVariable'] = function(param4_Vari, param6_Ignore) {
	...
	try {
		...
		if (((((((param6_Ignore) === (0)) ? 1 : 0)) && (func13_IsVarExisting(local4_Vari_ref_1856[0].attr8_Name_Str))) ? 1 : 0)) {
			__debugInfo = "553:\src\Compiler.gbas";
			func5_Error((((("Variable already exists, is a keyword or a type: '") + (local4_Vari_ref_1856[0].attr8_Name_Str))) + ("'")), 552, "src\Compiler.gbas");
			__debugInfo = "553:\src\Compiler.gbas";
		};
...
window['func11_AddFunction'] = function(param4_Func) {
	...
	try {
		...
		if (((((((local4_Func_ref_1858[0].attr3_Typ) !== (3)) ? 1 : 0)) && (func14_IsFuncExisting(local4_Func_ref_1858[0].attr8_Name_Str, local4_Func_ref_1858[0].attr10_IsCallback))) ? 1 : 0)) {
			__debugInfo = "560:\src\Compiler.gbas";
			func5_Error((((("Function already exists, is a keyword or a type: '") + (local4_Func_ref_1858[0].attr8_Name_Str))) + ("'")), 559, "src\Compiler.gbas");
			__debugInfo = "560:\src\Compiler.gbas";
		};
...
window['InitCompiler'] = function() {
	...
	try {
		...
		var forEachSaver3941 = local12_Keywords_Str_1859;
		for(var forEachCounter3941 = 0 ; forEachCounter3941 < forEachSaver3941.values.length ; forEachCounter3941++) {
			var local7_key_Str_1860 = forEachSaver3941.values[forEachCounter3941];
		{
				__debugInfo = "597:\src\Compiler.gbas";
				(global10_KeywordMap).Put(local7_key_Str_1860, 1);
				__debugInfo = "597:\src\Compiler.gbas";
			}
			forEachSaver3941.values[forEachCounter3941] = local7_key_Str_1860;
		...
		return 0;
		__debugInfo = "567:\src\Compiler.gbas";pool_array.free(local12_Keywords_Str_1859);
	} catch(ex) {
		if (isKnownException(ex)) throw ex;
		alert(formatError(ex));
		END();
...
window['Compile_Str'] = function(param8_Text_Str, param10_Target_Str) {
	...
	try {
		var local1_c_1863 = pool_TCompiler.alloc(), local11_tmpPath_Str_1865 = "", local10_Output_Str_1866 = "";
		...
		var forEachSaver4016 = global8_Compiler.attr15_HeaderFiles_Str;
		for(var forEachCounter4016 = 0 ; forEachCounter4016 < forEachSaver4016.values.length ; forEachCounter4016++) {
			var local14_HeaderFile_Str_1864 = forEachSaver4016.values[forEachCounter4016];
		{
				__debugInfo = "645:\src\Compiler.gbas";
				param8_Text_Str = ((((((param8_Text_Str) + ("// HEADER "))) + (local14_HeaderFile_Str_1864))) + ("\n"));
				__debugInfo = "646:\src\Compiler.gbas";
				param8_Text_Str = ((param8_Text_Str) + (func12_LoadFile_Str((("Target/Header/") + (local14_HeaderFile_Str_1864)))));
				__debugInfo = "647:\src\Compiler.gbas";
				param8_Text_Str = ((param8_Text_Str) + ("\n"));
				__debugInfo = "645:\src\Compiler.gbas";
			}
			forEachSaver4016.values[forEachCounter4016] = local14_HeaderFile_Str_1864;
		...
		local11_tmpPath_Str_1865 = GETCURRENTDIR_Str();
		...
		SETCURRENTDIR(local11_tmpPath_Str_1865);
		__debugInfo = "726:\src\Compiler.gbas";
		func9_PushTimer();
		__debugInfo = "727:\src\Compiler.gbas";
		local10_Output_Str_1866 = func12_DoTarget_Str(param10_Target_Str);
		...
		return tryClone(local10_Output_Str_1866);
		__debugInfo = "739:\src\Compiler.gbas";
		return "";
		__debugInfo = "633:\src\Compiler.gbas";pool_TCompiler.free(local1_c_1863);
	} catch(ex) {
		if (isKnownException(ex)) throw ex;
		alert(formatError(ex));
		END();
...
window['func9_PushTimer'] = function() {
	...
	try {
		...
		DIMPUSH(global9_TimeStack, ~~(GETTIMERALL()));
...
window['func8_PopTimer'] = function(param8_Text_Str) {
	...
	try {
		var local1_n_1868 = 0.0;
		__debugInfo = "759:\src\Compiler.gbas";
		local1_n_1868 = FLOAT2STR(FORMAT_Str(6, 16, ((((GETTIMERALL()) - (global9_TimeStack.arrAccess(-(1)).values[tmpPositionCache]))) / (1000))));
		__debugInfo = "760:\src\Compiler.gbas";
		STDOUT((((((((("\t\tTimer: ") + (param8_Text_Str))) + (": '"))) + (CAST2STRING(local1_n_1868)))) + ("'\n")));
		__debugInfo = "761:\src\Compiler.gbas";
		DIMDEL(global9_TimeStack, -(1));
...
window['RegisterDefine'] = function(param7_Key_Str, param9_Value_Str) {
	...
	try {
		...
		return 0;
		__debugInfo = "768:\src\Compiler.gbas";pool_TDefine.free(local3_Def_1871);
	} catch(ex) {
		if (isKnownException(ex)) throw ex;
		alert(formatError(ex));
		END();
...
window['func22_GenerateDocForLanguage'] = function(param8_Lang_Str) {
	...
	try {
		...
		var forEachSaver4544 = global14_Documentations;
		for(var forEachCounter4544 = 0 ; forEachCounter4544 < forEachSaver4544.values.length ; forEachCounter4544++) {
			var local6_module_1876 = forEachSaver4544.values[forEachCounter4544];
		{
				...
				if ((((local6_module_1876.attr7_typ_Str) === ("MODULE")) ? 1 : 0)) {
					...
					var forEachSaver4542 = global14_Documentations;
					for(var forEachCounter4542 = 0 ; forEachCounter4542 < forEachSaver4542.values.length ; forEachCounter4542++) {
						var local1_D_1877 = forEachSaver4542.values[forEachCounter4542];
					{
							...
							if ((((local1_D_1877.attr10_module_Str) === (local6_module_1876.attr8_name_Str)) ? 1 : 0)) {
								...
								__debugInfo = "51:\src\DocParser.gbas";
								{
									...
									if ((((local16___SelectHelper7__1879) === ("FUNCTION")) ? 1 : 0)) {
										...
										var forEachSaver4381 = global8_Compiler.attr5_Funcs_ref[0];
										for(var forEachCounter4381 = 0 ; forEachCounter4381 < forEachSaver4381.values.length ; forEachCounter4381++) {
											var local1_F_ref_1880 = forEachSaver4381.values[forEachCounter4381];
										{
											...
											forEachSaver4381.values[forEachCounter4381] = local1_F_ref_1880;
										...
										if ((((BOUNDS(local1_D_1877.attr6_params, 0)) > (0)) ? 1 : 0)) {
											...
											var forEachSaver4438 = local1_D_1877.attr6_params;
											for(var forEachCounter4438 = 0 ; forEachCounter4438 < forEachSaver4438.values.length ; forEachCounter4438++) {
												var local1_P_1882 = forEachSaver4438.values[forEachCounter4438];
											{
												...
												forEachSaver4438.values[forEachCounter4438] = local1_P_1882;
										...
										if ((((BOUNDS(local1_D_1877.attr7_see_Str, 0)) > (0)) ? 1 : 0)) {
											...
											var forEachSaver4535 = local1_D_1877.attr7_see_Str;
											for(var forEachCounter4535 = 0 ; forEachCounter4535 < forEachSaver4535.values.length ; forEachCounter4535++) {
												var local5_s_Str_1885 = forEachSaver4535.values[forEachCounter4535];
											{
												...
												forEachSaver4535.values[forEachCounter4535] = local5_s_Str_1885;
						...
						forEachSaver4542.values[forEachCounter4542] = local1_D_1877;
			...
			forEachSaver4544.values[forEachCounter4544] = local6_module_1876;
...
window['func18_DocLangElement_Str'] = function(param5_Langs, param8_Lang_Str) {
	...
	try {
		...
		var forEachSaver4586 = param5_Langs;
		for(var forEachCounter4586 = 0 ; forEachCounter4586 < forEachSaver4586.values.length ; forEachCounter4586++) {
			var local1_L_1889 = forEachSaver4586.values[forEachCounter4586];
		{
			...
			forEachSaver4586.values[forEachCounter4586] = local1_L_1889;
...
window['method13_type7_HashMap_7_SetSize'] = function(param4_Size, param4_self) {
	...
	try {
		...
		var forEachSaver5138 = local3_Arr_1926;
		for(var forEachCounter5138 = 0 ; forEachCounter5138 < forEachSaver5138.values.length ; forEachCounter5138++) {
			var local1_E_1927 = forEachSaver5138.values[forEachCounter5138];
		{
				__debugInfo = "152:\src\Utils\Hashmap.gbas";
				(param4_self).Put(local1_E_1927.attr7_Key_Str, local1_E_1927.attr5_Value);
				__debugInfo = "152:\src\Utils\Hashmap.gbas";
			}
			forEachSaver5138.values[forEachCounter5138] = local1_E_1927;
	...
	try {
		__debugInfo = "291:\src\CompilerPasses\Generator\JSGenerator.gbas";
		{
			...
			try {
				...
				var forEachSaver5445 = global8_Compiler.attr5_Funcs_ref[0];
				for(var forEachCounter5445 = 0 ; forEachCounter5445 < forEachSaver5445.values.length ; forEachCounter5445++) {
					var local4_Func_ref_1936 = forEachSaver5445.values[forEachCounter5445];
				{
						...
						if (((((((local4_Func_ref_1936[0].attr6_Native) === (0)) ? 1 : 0)) && ((((local4_Func_ref_1936[0].attr3_Scp) !== (-(1))) ? 1 : 0))) ? 1 : 0)) {
							...
							var forEachSaver5371 = local4_Func_ref_1936[0].attr6_Params;
							for(var forEachCounter5371 = 0 ; forEachCounter5371 < forEachSaver5371.values.length ; forEachCounter5371++) {
								var local1_P_1938 = forEachSaver5371.values[forEachCounter5371];
							{
								...
								forEachSaver5371.values[forEachCounter5371] = local1_P_1938;
					...
					forEachSaver5445.values[forEachCounter5445] = local4_Func_ref_1936;
				
				};
				__debugInfo = "87:\src\CompilerPasses\Generator\JSGenerator.gbas";
				var forEachSaver5511 = global8_Compiler.attr5_Funcs_ref[0];
				for(var forEachCounter5511 = 0 ; forEachCounter5511 < forEachSaver5511.values.length ; forEachCounter5511++) {
					var local4_Func_ref_1939 = forEachSaver5511.values[forEachCounter5511];
				{
					...
					forEachSaver5511.values[forEachCounter5511] = local4_Func_ref_1939;
				
				};
				__debugInfo = "249:\src\CompilerPasses\Generator\JSGenerator.gbas";
				var forEachSaver6448 = global8_Compiler.attr5_Types_ref[0];
				for(var forEachCounter6448 = 0 ; forEachCounter6448 < forEachSaver6448.values.length ; forEachCounter6448++) {
					var local3_Typ_ref_1940 = forEachSaver6448.values[forEachCounter6448];
				{
						...
						while ((((local5_typId_1941) !== (-(1))) ? 1 : 0)) {
							...
							var forEachSaver5635 = global8_Compiler.attr5_Types_ref[0].arrAccess(local5_typId_1941).values[tmpPositionCache][0].attr7_Methods;
							for(var forEachCounter5635 = 0 ; forEachCounter5635 < forEachSaver5635.values.length ; forEachCounter5635++) {
								var local3_Mth_1944 = forEachSaver5635.values[forEachCounter5635];
							{
								...
								forEachSaver5635.values[forEachCounter5635] = local3_Mth_1944;
						...
						var forEachSaver5757 = local3_Typ_ref_1940[0].attr10_Attributes;
						for(var forEachCounter5757 = 0 ; forEachCounter5757 < forEachSaver5757.values.length ; forEachCounter5757++) {
							var local4_Attr_1945 = forEachSaver5757.values[forEachCounter5757];
						{
								...
								local8_Text_Str_1933 = ((((local8_Text_Str_1933) + (";"))) + (func11_NewLine_Str()));
								__debugInfo = "126:\src\CompilerPasses\Generator\JSGenerator.gbas";pool_TIdentifierVari.free(alias8_variable_ref_1946);
							}
							forEachSaver5757.values[forEachCounter5757] = local4_Attr_1945;
						...
						var forEachSaver5847 = local3_Typ_ref_1940[0].attr10_Attributes;
						for(var forEachCounter5847 = 0 ; forEachCounter5847 < forEachSaver5847.values.length ; forEachCounter5847++) {
							var local4_Attr_1947 = forEachSaver5847.values[forEachCounter5847];
						{
								...
								__debugInfo = "139:\src\CompilerPasses\Generator\JSGenerator.gbas";pool_TIdentifierVari.free(alias8_variable_ref_1948);
							}
							forEachSaver5847.values[forEachCounter5847] = local4_Attr_1947;
						...
						var forEachSaver6039 = local3_Typ_ref_1940[0].attr10_Attributes;
						for(var forEachCounter6039 = 0 ; forEachCounter6039 < forEachSaver6039.values.length ; forEachCounter6039++) {
							var local4_Attr_1949 = forEachSaver6039.values[forEachCounter6039];
						{
								...
								local8_Text_Str_1933 = ((((local8_Text_Str_1933) + (";"))) + (func11_NewLine_Str()));
								__debugInfo = "161:\src\CompilerPasses\Generator\JSGenerator.gbas";pool_TIdentifierVari.free(alias8_variable_ref_1950);
							}
							forEachSaver6039.values[forEachCounter6039] = local4_Attr_1949;
						...
						while ((((local5_typId_1941) !== (-(1))) ? 1 : 0)) {
							...
							var forEachSaver6437 = global8_Compiler.attr5_Types_ref[0].arrAccess(local5_typId_1941).values[tmpPositionCache][0].attr7_Methods;
							for(var forEachCounter6437 = 0 ; forEachCounter6437 < forEachSaver6437.values.length ; forEachCounter6437++) {
								var local3_Mth_1953 = forEachSaver6437.values[forEachCounter6437];
							{
								...
								forEachSaver6437.values[forEachCounter6437] = local3_Mth_1953;
					...
					forEachSaver6448.values[forEachCounter6448] = local3_Typ_ref_1940;
				
				};
				__debugInfo = "261:\src\CompilerPasses\Generator\JSGenerator.gbas";
				var forEachSaver6507 = global8_Compiler.attr10_DataBlocks;
				for(var forEachCounter6507 = 0 ; forEachCounter6507 < forEachSaver6507.values.length ; forEachCounter6507++) {
					var local5_block_1955 = forEachSaver6507.values[forEachCounter6507];
				{
						...
						var forEachSaver6499 = local5_block_1955.attr5_Datas;
						for(var forEachCounter6499 = 0 ; forEachCounter6499 < forEachSaver6499.values.length ; forEachCounter6499++) {
							var local1_d_1957 = forEachSaver6499.values[forEachCounter6499];
						{
							...
							forEachSaver6499.values[forEachCounter6499] = local1_d_1957;
					...
					forEachSaver6507.values[forEachCounter6507] = local5_block_1955;
			...
			switch(__pc) {
				...
				__debugInfo = "303:\src\CompilerPasses\Generator\JSGenerator.gbas";
					...
					case 11126:
						...
						if (!((((local17___SelectHelper10__1961) === (~~(2))) ? 1 : 0))) { __pc = 6642; break; }
					...
					case 6693:
						...
						if (!(((((((param4_expr.attr6_ScpTyp) === (2)) ? 1 : 0)) || ((((param4_expr.attr6_ScpTyp) === (4)) ? 1 : 0))) ? 1 : 0))) { __pc = 6688; break; }
				...
				case 6688: //dummy jumper1
					...
					case 6706:
						...
						if (!((((func12_ScopeHasGoto(param4_expr)) && (local13_IsStackPusher_1968)) ? 1 : 0))) { __pc = 6698; break; }
				...
				case 6698: //dummy jumper1
					;
						
					case 6743:
						__debugInfo = "332:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!((((param4_expr.attr6_ScpTyp) === (2)) ? 1 : 0))) { __pc = 6712; break; }
					
					var local1_i_1969 = 0;
					case 6742:
						__debugInfo = "331:\src\CompilerPasses\Generator\JSGenerator.gbas";
						var forEachSaver6742 = global8_Compiler.attr5_Funcs_ref[0];
					var forEachCounter6742 = 0
					
				case 6720: //dummy for1
					if (!(forEachCounter6742 < forEachSaver6742.values.length)) {__pc = 6716; break;}
					var local4_Func_ref_1970 = forEachSaver6742.values[forEachCounter6742];
					
					
					case 6738:
						__debugInfo = "329:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!((((local4_Func_ref_1970[0].attr3_Scp) === (param4_expr.attr2_ID)) ? 1 : 0))) { __pc = 6729; break; }
				...
				case 6729: //dummy jumper1
					...
					local1_i_1969+=1;
					__debugInfo = "329:\src\CompilerPasses\Generator\JSGenerator.gbas";
					forEachSaver6742.values[forEachCounter6742] = local4_Func_ref_1970;
					
					forEachCounter6742++
					__pc = 6720; break; //back jump
				...
				case 6712: //dummy jumper1
					...
					case 6759:
						...
						if (!((((((global8_IsInGoto) ? 0 : 1)) || (local7_mngGoto_1967)) ? 1 : 0))) { __pc = 6755; break; }
				...
				case 29434: //dummy jumper2
					...
					case 6790:
						...
						if (!((((global9_DEBUGMODE) && (local13_IsStackPusher_1968)) ? 1 : 0))) { __pc = 6768; break; }
				...
				case 6768: //dummy jumper1
					;
						
					case 6853:
						__debugInfo = "366:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!((((local6_IsFunc_1966) && (global8_Compiler.attr5_Funcs_ref[0].arrAccess(global11_CurrentFunc).values[tmpPositionCache][0].attr15_UsedAsPrototype)) ? 1 : 0))) { __pc = 6800; break; }
					
					case 6852:
						__debugInfo = "365:\src\CompilerPasses\Generator\JSGenerator.gbas";
						var forEachSaver6852 = global8_Compiler.attr5_Funcs_ref[0].arrAccess(global11_CurrentFunc).values[tmpPositionCache][0].attr6_Params;
					var forEachCounter6852 = 0
					
				case 6811: //dummy for1
					if (!(forEachCounter6852 < forEachSaver6852.values.length)) {__pc = 6803; break;}
					var local1_P_1971 = forEachSaver6852.values[forEachCounter6852];
					
					
					case 6851:
						__debugInfo = "364:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!((((global8_Compiler.attr5_Varis_ref[0].arrAccess(local1_P_1971).values[tmpPositionCache][0].attr3_ref) === (0)) ? 1 : 0))) { __pc = 6823; break; }
				...
				case 29437: //dummy jumper2
					...
					__debugInfo = "364:\src\CompilerPasses\Generator\JSGenerator.gbas";
					forEachSaver6852.values[forEachCounter6852] = local1_P_1971;
					
					forEachCounter6852++
					__pc = 6811; break; //back jump
				...
				case 6868: //dummy jumper1
					...
					case 6996:
						...
						var forEachSaver6996 = param4_expr.attr5_Varis;
					var forEachCounter6996 = 0
					
				case 6901: //dummy for1
					if (!(forEachCounter6996 < forEachSaver6996.values.length)) {__pc = 6897; break;}
					var local3_Var_1975 = forEachSaver6996.values[forEachCounter6996];
					
					
					case 6995:
						__debugInfo = "387:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!((((global8_Compiler.attr5_Varis_ref[0].arrAccess(local3_Var_1975).values[tmpPositionCache][0].attr8_datatype.attr7_IsArray) === (0)) ? 1 : 0))) { __pc = 6914; break; }
					
					case 6980:
						__debugInfo = "384:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!(func6_IsType(global8_Compiler.attr5_Varis_ref[0].arrAccess(local3_Var_1975).values[tmpPositionCache][0].attr8_datatype.attr8_Name_Str))) { __pc = 6926; break; }
					
					case 6979:
						__debugInfo = "383:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!((((((((((global8_Compiler.attr5_Varis_ref[0].arrAccess(local3_Var_1975).values[tmpPositionCache][0].attr3_Typ) !== (5)) ? 1 : 0)) && ((((global8_Compiler.attr5_Varis_ref[0].arrAccess(local3_Var_1975).values[tmpPositionCache][0].attr3_Typ) !== (4)) ? 1 : 0))) ? 1 : 0)) && (func17_JSShouldRedeclare(local3_Var_1975))) ? 1 : 0))) { __pc = 6950; break; }
				...
				case 29439: //dummy jumper2
					...
					__debugInfo = "387:\src\CompilerPasses\Generator\JSGenerator.gbas";
					forEachSaver6996.values[forEachCounter6996] = local3_Var_1975;
					
					forEachCounter6996++
					__pc = 6901; break; //back jump
				...
				case 6897: //dummy for
					...
					case 7074:
						...
						if (!(((((((global11_CurrentFunc) !== (-(1))) ? 1 : 0)) && ((((local5_oFunc_1963) === (-(1))) ? 1 : 0))) ? 1 : 0))) { __pc = 7009; break; }
					
					var local1_i_1976 = 0;
					case 7073:
						__debugInfo = "397:\src\CompilerPasses\Generator\JSGenerator.gbas";
						var forEachSaver7073 = global8_Compiler.attr5_Funcs_ref[0].arrAccess(global11_CurrentFunc).values[tmpPositionCache][0].attr6_Params;
					var forEachCounter7073 = 0
					
				case 7021: //dummy for1
					if (!(forEachCounter7073 < forEachSaver7073.values.length)) {__pc = 7013; break;}
					var local5_Param_1977 = forEachSaver7073.values[forEachCounter7073];
					
					
					case 7072:
						__debugInfo = "396:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!((((global8_Compiler.attr5_Varis_ref[0].arrAccess(local5_Param_1977).values[tmpPositionCache][0].attr9_OwnerVari) !== (-(1))) ? 1 : 0))) { __pc = 7034; break; }
				...
				case 7034: //dummy jumper1
					;
						
					__debugInfo = "396:\src\CompilerPasses\Generator\JSGenerator.gbas";
					forEachSaver7073.values[forEachCounter7073] = local5_Param_1977;
					
					forEachCounter7073++
					__pc = 7021; break; //back jump
				...
				case 7009: //dummy jumper1
					;
						
					case 7081:
						__debugInfo = "405:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!(local7_mngGoto_1967)) { __pc = 7076; break; }
				...
				case 7076: //dummy jumper1
					;
						
					case 7113:
						__debugInfo = "413:\src\CompilerPasses\Generator\JSGenerator.gbas";
						var forEachSaver7113 = param4_expr.attr5_Exprs;
					var forEachCounter7113 = 0
					
				case 7088: //dummy for1
					if (!(forEachCounter7113 < forEachSaver7113.values.length)) {__pc = 7084; break;}
					var local2_Ex_1979 = forEachSaver7113.values[forEachCounter7113];
				...
				case 7101: //dummy jumper1
					;
						
					__debugInfo = "408:\src\CompilerPasses\Generator\JSGenerator.gbas";
					forEachSaver7113.values[forEachCounter7113] = local2_Ex_1979;
					
					forEachCounter7113++
					__pc = 7088; break; //back jump
				...
				case 7084: //dummy for
					...
					case 7170:
						...
						if (!(local7_mngGoto_1967)) { __pc = 7115; break; }
					...
					case 7146:
						...
						if (!((((BOUNDS(local8_ERes_Str_1978, 0)) > (0)) ? 1 : 0))) { __pc = 7131; break; }
				...
				case 7179: //dummy for1
					if (!toCheck(local1_i_1982, ((BOUNDS(local8_ERes_Str_1978, 0)) - (1)), 2)) {__pc = 7190; break;}
				...
				case 7291: //dummy jumper1
					...
					case 7361:
						...
						if (!((((local13_FirstText_Str_1981) === ("")) ? 1 : 0))) { __pc = 7356; break; }
				...
				case 7356: //dummy jumper1
					;
						
					__debugInfo = "447:\src\CompilerPasses\Generator\JSGenerator.gbas";
					
				case 7311: //dummy jumper1
					;
					...
					case 7384:
						...
						if (!(local7_HasCase_1986)) { __pc = 7376; break; }
				...
				case 7376: //dummy jumper1
					...
					__debugInfo = "437:\src\CompilerPasses\Generator\JSGenerator.gbas";pool_TExpr.free(alias4_ExEx_ref_1985);
					local1_i_1982 += 2;
					__pc = 7179; break; //back jump
				...
				case 7190: //dummy for
					...
					case 7396:
						...
						if (!((((local13_FirstText_Str_1981) !== ("")) ? 1 : 0))) { __pc = 7389; break; }
				...
				case 7389: //dummy jumper1
					...
					case 7462:
						...
						if (!(local7_mngGoto_1967)) { __pc = 7403; break; }
				...
				case 7403: //dummy jumper1
					...
					case 7476:
						...
						if (!((((((global8_IsInGoto) ? 0 : 1)) || (local7_mngGoto_1967)) ? 1 : 0))) { __pc = 7469; break; }
				...
				case 7469: //dummy jumper1
					;
						
					case 7538:
						__debugInfo = "497:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!((((global9_DEBUGMODE) && (local13_IsStackPusher_1968)) ? 1 : 0))) { __pc = 7480; break; }
				...
				case 7480: //dummy jumper1
					...
					case 7564:
						...
						if (!((((((global8_IsInGoto) ? 0 : 1)) || (local7_mngGoto_1967)) ? 1 : 0))) { __pc = 7545; break; }
				...
				case 29456: //dummy jumper2
					...
					case 7585:
						...
						if (!(local7_mngGoto_1967)) { __pc = 7577; break; }
				...
				case 7577: //dummy jumper1
					;
						
					__debugInfo = "305:\src\CompilerPasses\Generator\JSGenerator.gbas";pool_array.free(local8_ERes_Str_1978);
					__pc = 29429;
					break;
					
				case 6642: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(1))) ? 1 : 0))) { __pc = 7587; break; }
				...
				case 7612: //dummy jumper1
					if (!((((local17___SelectHelper11__1991) === ("<>")) ? 1 : 0))) { __pc = 7622; break; }
				...
				case 7622: //dummy jumper1
					if (!((((local17___SelectHelper11__1991) === ("OR")) ? 1 : 0))) { __pc = 7632; break; }
				...
				case 7632: //dummy jumper1
					if (!((((local17___SelectHelper11__1991) === ("AND")) ? 1 : 0))) { __pc = 7642; break; }
				...
				case 7642: //dummy jumper1
					if (!((((local17___SelectHelper11__1991) === ("<")) ? 1 : 0))) { __pc = 7652; break; }
				...
				case 7652: //dummy jumper1
					if (!((((local17___SelectHelper11__1991) === (">")) ? 1 : 0))) { __pc = 7658; break; }
				...
				case 7658: //dummy jumper1
					if (!((((local17___SelectHelper11__1991) === (">=")) ? 1 : 0))) { __pc = 7664; break; }
				...
				case 7664: //dummy jumper1
					if (!((((local17___SelectHelper11__1991) === ("<=")) ? 1 : 0))) { __pc = 7670; break; }
				...
				case 7670: //dummy jumper1
					...
					case 7852:
						...
						if (!((((local10_HasToBeInt_1989) || (local10_MightBeInt_1990)) ? 1 : 0))) { __pc = 7680; break; }
					
					case 7794:
						__debugInfo = "559:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!(((((((local10_MightBeInt_1990) && ((((global5_Exprs_ref[0].arrAccess(param4_expr.attr4_Left).values[tmpPositionCache][0].attr8_datatype.attr8_Name_Str) === ("string")) ? 1 : 0))) ? 1 : 0)) && ((((global5_Exprs_ref[0].arrAccess(param4_expr.attr5_Right).values[tmpPositionCache][0].attr8_datatype.attr8_Name_Str) === ("string")) ? 1 : 0))) ? 1 : 0))) { __pc = 7707; break; }
					...
					case 7738:
						...
						if (!((((local17___SelectHelper12__1993) === ("<")) ? 1 : 0))) { __pc = 7715; break; }
				...
				case 7715: //dummy jumper1
					if (!((((local17___SelectHelper12__1993) === (">")) ? 1 : 0))) { __pc = 7721; break; }
				...
				case 7721: //dummy jumper1
					if (!((((local17___SelectHelper12__1993) === ("<=")) ? 1 : 0))) { __pc = 7727; break; }
				...
				case 7727: //dummy jumper1
					if (!((((local17___SelectHelper12__1993) === (">=")) ? 1 : 0))) { __pc = 7733; break; }
				...
				case 7680: //dummy jumper1
					...
					case 7851:
						...
						if (!(((((((local7_Sym_Str_1988) === ("-")) ? 1 : 0)) && ((((local5_l_Str_1994) === ("0")) ? 1 : 0))) ? 1 : 0))) { __pc = 7812; break; }
				...
				case 29459: //dummy jumper2
					...
					case 7889:
						...
						if (!((((((((((local7_Sym_Str_1988) === ("/")) ? 1 : 0)) && ((((global5_Exprs_ref[0].arrAccess(param4_expr.attr4_Left).values[tmpPositionCache][0].attr8_datatype.attr8_Name_Str) === ("int")) ? 1 : 0))) ? 1 : 0)) && ((((global5_Exprs_ref[0].arrAccess(param4_expr.attr5_Right).values[tmpPositionCache][0].attr8_datatype.attr8_Name_Str) === ("int")) ? 1 : 0))) ? 1 : 0))) { __pc = 7880; break; }
				...
				case 7587: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(3))) ? 1 : 0))) { __pc = 7891; break; }
				...
				case 7891: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(4))) ? 1 : 0))) { __pc = 7901; break; }
				...
				case 7901: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(5))) ? 1 : 0))) { __pc = 7910; break; }
				...
				case 7910: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(6))) ? 1 : 0))) { __pc = 7918; break; }
					
					case 8125:
						__debugInfo = "608:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!((((global8_Compiler.attr5_Funcs_ref[0].arrAccess(param4_expr.attr4_func).values[tmpPositionCache][0].attr3_Typ) === (3)) ? 1 : 0))) { __pc = 7931; break; }
					...
					case 8104:
						...
						if (!((((alias2_Ex_ref_1996[0].attr3_Typ) === (53)) ? 1 : 0))) { __pc = 7952; break; }
					
					var local5_Found_1997 = 0, local5_typId_1998 = 0;
					case 7975:
						__debugInfo = "585:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!(((func6_IsType(alias2_Ex_ref_1996[0].attr8_datatype.attr8_Name_Str)) ? 0 : 1))) { __pc = 7961; break; }
					
					case 7974:
						__debugInfo = "585:\src\CompilerPasses\Generator\JSGenerator.gbas";
						func5_Error((((("Internal error (Unable to find '") + (alias2_Ex_ref_1996[0].attr8_datatype.attr8_Name_Str))) + ("')")), 584, "src\CompilerPasses\Generator\JSGenerator.gbas");
						
					__debugInfo = "585:\src\CompilerPasses\Generator\JSGenerator.gbas";
					
				case 7961: //dummy jumper1
					;
					...
					case 8073:
						...
						if (!((((local5_typId_1998) !== (-(1))) ? 1 : 0))) {__pc = 29467; break;}
					
					case 8063:
						__debugInfo = "597:\src\CompilerPasses\Generator\JSGenerator.gbas";
						var forEachSaver8063 = global8_Compiler.attr5_Types_ref[0].arrAccess(local5_typId_1998).values[tmpPositionCache][0].attr7_Methods;
					var forEachCounter8063 = 0
					
				case 8003: //dummy for1
					if (!(forEachCounter8063 < forEachSaver8063.values.length)) {__pc = 7995; break;}
					var local3_Mth_1999 = forEachSaver8063.values[forEachCounter8063];
					
					
					case 8062:
						__debugInfo = "596:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!((((global8_Compiler.attr5_Funcs_ref[0].arrAccess(local3_Mth_1999).values[tmpPositionCache][0].attr9_OName_Str) === (global8_Compiler.attr5_Funcs_ref[0].arrAccess(param4_expr.attr4_func).values[tmpPositionCache][0].attr9_OName_Str)) ? 1 : 0))) { __pc = 8022; break; }
					...
					case 8043:
						...
						if (!((((local10_Params_Str_2000) !== ("")) ? 1 : 0))) { __pc = 8036; break; }
				...
				case 8022: //dummy jumper1
					...
					__debugInfo = "596:\src\CompilerPasses\Generator\JSGenerator.gbas";
					forEachSaver8063.values[forEachCounter8063] = local3_Mth_1999;
					
					forEachCounter8063++
					__pc = 8003; break; //back jump
				...
				case 29465: //dummy jumper2
					...
					__debugInfo = "581:\src\CompilerPasses\Generator\JSGenerator.gbas";pool_TExpr.free(alias2_Ex_ref_1996);
					__pc = 29464;
					break;
					
				case 7931: //dummy jumper1
				...
				case 7918: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(23))) ? 1 : 0))) { __pc = 8127; break; }
				...
				case 8127: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(9))) ? 1 : 0))) { __pc = 8146; break; }
					...
					case 8177:
						...
						if (!(global8_Compiler.attr5_Varis_ref[0].arrAccess(param4_expr.attr4_vari).values[tmpPositionCache][0].attr3_ref)) { __pc = 8170; break; }
				...
				case 8146: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(13))) ? 1 : 0))) { __pc = 8179; break; }
					...
					case 8277:
						...
						if (!((((BOUNDS(param4_expr.attr4_dims, 0)) !== (0)) ? 1 : 0))) { __pc = 8199; break; }
					...
					case 8269:
						...
						var forEachSaver8269 = param4_expr.attr4_dims;
					var forEachCounter8269 = 0
					
				case 8220: //dummy for1
					if (!(forEachCounter8269 < forEachSaver8269.values.length)) {__pc = 8216; break;}
					var local1_d_2003 = forEachSaver8269.values[forEachCounter8269];
					
					
					var local1_v_2004 = 0;
					case 8230:
						__debugInfo = "624:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!(local1_s_2001)) { __pc = 8223; break; }
				...
				case 8223: //dummy jumper1
					...
					case 8268:
						...
						if (!(((((((local1_v_2004) !== (-(1))) ? 1 : 0)) && (global8_Compiler.attr5_Varis_ref[0].arrAccess(local1_v_2004).values[tmpPositionCache][0].attr3_ref)) ? 1 : 0))) { __pc = 8263; break; }
				...
				case 8263: //dummy jumper1
					;
						
					__debugInfo = "624:\src\CompilerPasses\Generator\JSGenerator.gbas";
					forEachSaver8269.values[forEachCounter8269] = local1_d_2003;
					
					forEachCounter8269++
					__pc = 8220; break; //back jump
				...
				case 8179: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(10))) ? 1 : 0))) { __pc = 8279; break; }
					...
					case 8352:
						...
						if (!((((global5_Exprs_ref[0].arrAccess(param4_expr.attr4_vari).values[tmpPositionCache][0].attr8_datatype.attr7_IsArray) || (func6_IsType(global5_Exprs_ref[0].arrAccess(param4_expr.attr4_vari).values[tmpPositionCache][0].attr8_datatype.attr8_Name_Str))) ? 1 : 0))) { __pc = 8323; break; }
					
					case 8351:
						__debugInfo = "645:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!(((((((global5_Exprs_ref[0].arrAccess(param4_expr.attr5_Right).values[tmpPositionCache][0].attr3_Typ) !== (35)) ? 1 : 0)) && ((((global5_Exprs_ref[0].arrAccess(param4_expr.attr5_Right).values[tmpPositionCache][0].attr3_Typ) !== (36)) ? 1 : 0))) ? 1 : 0))) { __pc = 8344; break; }
				...
				case 8279: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(11))) ? 1 : 0))) { __pc = 8354; break; }
					...
					case 8387:
						...
						if (!(((((((local1_v_2005) === (-(1))) ? 1 : 0)) || (global8_Compiler.attr5_Varis_ref[0].arrAccess(local1_v_2005).values[tmpPositionCache][0].attr3_ref)) ? 1 : 0))) { __pc = 8382; break; }
				...
				case 8382: //dummy jumper1
					...
					case 8434:
						...
						var forEachSaver8434 = param4_expr.attr4_dims;
					var forEachCounter8434 = 0
					
				case 8410: //dummy for1
					if (!(forEachCounter8434 < forEachSaver8434.values.length)) {__pc = 8406; break;}
					var local1_D_2008 = forEachSaver8434.values[forEachCounter8434];
					
					
					case 8422:
						__debugInfo = "657:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!((((local4_Find_2007) === (1)) ? 1 : 0))) { __pc = 8415; break; }
				...
				case 8415: //dummy jumper1
					...
					local4_Find_2007 = 1;
					__debugInfo = "657:\src\CompilerPasses\Generator\JSGenerator.gbas";
					forEachSaver8434.values[forEachCounter8434] = local1_D_2008;
					
					forEachCounter8434++
					__pc = 8410; break; //back jump
				...
				case 8354: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(12))) ? 1 : 0))) { __pc = 8454; break; }
					...
					case 8487:
						...
						if (!(((((((local1_v_2009) === (-(1))) ? 1 : 0)) || (global8_Compiler.attr5_Varis_ref[0].arrAccess(local1_v_2009).values[tmpPositionCache][0].attr3_ref)) ? 1 : 0))) { __pc = 8482; break; }
				...
				case 8482: //dummy jumper1
					...
					case 8534:
						...
						var forEachSaver8534 = param4_expr.attr4_dims;
					var forEachCounter8534 = 0
					
				case 8510: //dummy for1
					if (!(forEachCounter8534 < forEachSaver8534.values.length)) {__pc = 8506; break;}
					var local1_D_2012 = forEachSaver8534.values[forEachCounter8534];
					
					
					case 8522:
						__debugInfo = "672:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!((((local4_Find_2011) === (1)) ? 1 : 0))) { __pc = 8515; break; }
				...
				case 8515: //dummy jumper1
					...
					local4_Find_2011 = 1;
					__debugInfo = "672:\src\CompilerPasses\Generator\JSGenerator.gbas";
					forEachSaver8534.values[forEachCounter8534] = local1_D_2012;
					
					forEachCounter8534++
					__pc = 8510; break; //back jump
				...
				case 8454: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(15))) ? 1 : 0))) { __pc = 8554; break; }
					...
					case 8640:
						...
						if (!((((global5_Exprs_ref[0].arrAccess(param4_expr.attr4_expr).values[tmpPositionCache][0].attr3_Typ) === (4)) ? 1 : 0))) { __pc = 8569; break; }
				...
				case 8592: //dummy for1
					if (!toCheck(local1_i_2015, (((local5_f_Str_2014).length) - (1)), 1)) {__pc = 8599; break;}
					
					case 8613:
						__debugInfo = "690:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!((((ASC(local5_f_Str_2014, ~~(local1_i_2015))) === (ASC(".", 0))) ? 1 : 0))) { __pc = 8607; break; }
				...
				case 8607: //dummy jumper1
					;
						
					__debugInfo = "690:\src\CompilerPasses\Generator\JSGenerator.gbas";
					local1_i_2015 += 1;
					__pc = 8592; break; //back jump
				...
				case 8569: //dummy jumper1
					if (!(((((((global5_Exprs_ref[0].arrAccess(param4_expr.attr4_expr).values[tmpPositionCache][0].attr8_datatype.attr8_Name_Str) === ("float")) ? 1 : 0)) && ((((global5_Exprs_ref[0].arrAccess(param4_expr.attr4_expr).values[tmpPositionCache][0].attr8_datatype.attr7_IsArray) === (0)) ? 1 : 0))) ? 1 : 0))) { __pc = 8638; break; }
				...
				case 8638: //dummy jumper1
					...
					case 8730:
						...
						if (!(local4_cast_2013)) { __pc = 8642; break; }
					...
					case 8718:
						...
						if (!((((local17___SelectHelper13__2016) === ("int")) ? 1 : 0))) { __pc = 8657; break; }
				...
				case 8657: //dummy jumper1
					if (!((((local17___SelectHelper13__2016) === ("float")) ? 1 : 0))) { __pc = 8670; break; }
				...
				case 8670: //dummy jumper1
					if (!((((local17___SelectHelper13__2016) === ("string")) ? 1 : 0))) { __pc = 8687; break; }
				...
				case 8554: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(16))) ? 1 : 0))) { __pc = 8732; break; }
					
					case 8827:
						__debugInfo = "729:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!((((global5_Exprs_ref[0].arrAccess(param4_expr.attr4_expr).values[tmpPositionCache][0].attr3_Typ) === (3)) ? 1 : 0))) { __pc = 8743; break; }
				...
				case 8743: //dummy jumper1
					...
					case 8826:
						...
						if (!((((local17___SelectHelper14__2017) === ("int")) ? 1 : 0))) { __pc = 8769; break; }
				...
				case 8769: //dummy jumper1
					if (!((((local17___SelectHelper14__2017) === ("float")) ? 1 : 0))) { __pc = 8782; break; }
				...
				case 8782: //dummy jumper1
					if (!((((local17___SelectHelper14__2017) === ("string")) ? 1 : 0))) { __pc = 8795; break; }
				...
				case 8732: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(17))) ? 1 : 0))) { __pc = 8829; break; }
				...
				case 8829: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(18))) ? 1 : 0))) { __pc = 8846; break; }
				...
				case 8846: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(19))) ? 1 : 0))) { __pc = 8868; break; }
					...
					case 8903:
						...
						if (!((((local17___SelectHelper15__2019) === (~~(3))) ? 1 : 0))) { __pc = 8886; break; }
				...
				case 8886: //dummy jumper1
					if (!((((local17___SelectHelper15__2019) === (~~(4))) ? 1 : 0))) { __pc = 8892; break; }
				...
				case 8892: //dummy jumper1
					if (!((((local17___SelectHelper15__2019) === (~~(5))) ? 1 : 0))) { __pc = 8898; break; }
				...
				case 8898: //dummy jumper1
					...
					case 8935:
						...
						if (!(local1_F_2018)) { __pc = 8910; break; }
				...
				case 8868: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(22))) ? 1 : 0))) { __pc = 8937; break; }
					...
					case 8977:
						...
						var forEachSaver8977 = global8_Compiler.attr5_Funcs_ref[0];
					var forEachCounter8977 = 0
					
				case 8956: //dummy for1
					if (!(forEachCounter8977 < forEachSaver8977.values.length)) {__pc = 8952; break;}
					var local4_Func_ref_2022 = forEachSaver8977.values[forEachCounter8977];
					
					
					case 8976:
						__debugInfo = "766:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!((((local4_Func_ref_2022[0].attr9_OName_Str) === (local8_Name_Str_2020)) ? 1 : 0))) { __pc = 8963; break; }
				...
				case 8963: //dummy jumper1
					;
						
					__debugInfo = "766:\src\CompilerPasses\Generator\JSGenerator.gbas";
					forEachSaver8977.values[forEachCounter8977] = local4_Func_ref_2022;
					
					forEachCounter8977++
					__pc = 8956; break; //back jump
				...
				case 8952: //dummy for
					...
					case 8987:
						...
						if (!(((local5_Found_2021) ? 0 : 1))) { __pc = 8980; break; }
				...
				case 8937: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(24))) ? 1 : 0))) { __pc = 8989; break; }
					
					case 9252:
						__debugInfo = "862:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!(global8_IsInGoto)) { __pc = 8992; break; }
				...
				case 9005: //dummy for1
					if (!toCheck(local1_i_2024, ((BOUNDS(param4_expr.attr10_Conditions, 0)) - (1)), 1)) {__pc = 9016; break;}
					...
					case 9088:
						...
						if (!((((param4_expr.attr9_elseScope) !== (-(1))) ? 1 : 0))) { __pc = 9067; break; }
				...
				case 9016: //dummy for
					...
					case 9152:
						...
						if (!((((param4_expr.attr9_elseScope) !== (-(1))) ? 1 : 0))) { __pc = 9121; break; }
				...
				case 8992: //dummy jumper1
					...
					case 9251:
						...
						if (!(local8_IsSwitch_2025)) { __pc = 9160; break; }
					
					
					__pc = 29493;
					break;
					
				case 9160: //dummy jumper1
				...
				case 9167: //dummy for1
					if (!toCheck(local1_i_2026, ((BOUNDS(param4_expr.attr10_Conditions, 0)) - (1)), 1)) {__pc = 9178; break;}
					
					case 9197:
						__debugInfo = "854:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!((((local1_i_2026) === (0)) ? 1 : 0))) { __pc = 9184; break; }
				...
				case 9178: //dummy for
					...
					case 9250:
						...
						if (!((((param4_expr.attr9_elseScope) !== (-(1))) ? 1 : 0))) { __pc = 9236; break; }
				...
				case 9236: //dummy jumper1
					;
						
					__debugInfo = "848:\src\CompilerPasses\Generator\JSGenerator.gbas";
					
				case 29493: //dummy jumper2
					;
						
					__debugInfo = "802:\src\CompilerPasses\Generator\JSGenerator.gbas";
					
				case 29490: //dummy jumper2
					;
				...
				case 8989: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(25))) ? 1 : 0))) { __pc = 9254; break; }
					
					case 9373:
						__debugInfo = "884:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!(global8_IsInGoto)) { __pc = 9257; break; }
				...
				case 9254: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(26))) ? 1 : 0))) { __pc = 9375; break; }
					
					case 9499:
						__debugInfo = "908:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!(global8_IsInGoto)) { __pc = 9378; break; }
				...
				case 9375: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(27))) ? 1 : 0))) { __pc = 9501; break; }
					
					var local13_CheckComm_Str_2031 = "";
					case 9516:
						__debugInfo = "915:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!(param4_expr.attr5_hasTo)) { __pc = 9507; break; }
				...
				case 9501: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(38))) ? 1 : 0))) { __pc = 9782; break; }
					...
					case 10086:
						...
						if (!(global8_IsInGoto)) { __pc = 9897; break; }
				...
				case 9782: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(30))) ? 1 : 0))) { __pc = 10088; break; }
					
					case 10109:
						__debugInfo = "996:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!(global8_IsInGoto)) { __pc = 10091; break; }
				...
				case 10088: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(29))) ? 1 : 0))) { __pc = 10111; break; }
					
					case 10132:
						__debugInfo = "1002:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!(global8_IsInGoto)) { __pc = 10114; break; }
				...
				case 10111: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(31))) ? 1 : 0))) { __pc = 10134; break; }
				...
				case 10134: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(32))) ? 1 : 0))) { __pc = 10254; break; }
				...
				case 10254: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(33))) ? 1 : 0))) { __pc = 10296; break; }
				...
				case 10296: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(34))) ? 1 : 0))) { __pc = 10310; break; }
					...
					case 10358:
						...
						var forEachSaver10358 = param4_expr.attr5_Reads;
					var forEachCounter10358 = 0
					
				case 10322: //dummy for1
					if (!(forEachCounter10358 < forEachSaver10358.values.length)) {__pc = 10318; break;}
					var local1_R_2045 = forEachSaver10358.values[forEachCounter10358];
					...
					case 10354:
						...
						if (!((((local1_i_2044) < (((BOUNDS(param4_expr.attr5_Reads, 0)) - (1)))) ? 1 : 0))) { __pc = 10345; break; }
				...
				case 10345: //dummy jumper1
					;
						
					__debugInfo = "1027:\src\CompilerPasses\Generator\JSGenerator.gbas";
					local1_i_2044+=1;
					__debugInfo = "1025:\src\CompilerPasses\Generator\JSGenerator.gbas";
					forEachSaver10358.values[forEachCounter10358] = local1_R_2045;
					
					forEachCounter10358++
					__pc = 10322; break; //back jump
					
				case 10318: //dummy for
					;
				...
				case 10310: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(35))) ? 1 : 0))) { __pc = 10360; break; }
				...
				case 10360: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(36))) ? 1 : 0))) { __pc = 10373; break; }
					...
					case 10427:
						...
						var forEachSaver10427 = param4_expr.attr4_dims;
					var forEachCounter10427 = 0
					
				case 10403: //dummy for1
					if (!(forEachCounter10427 < forEachSaver10427.values.length)) {__pc = 10399; break;}
					var local1_D_2048 = forEachSaver10427.values[forEachCounter10427];
					
					
					case 10415:
						__debugInfo = "1036:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!((((local4_Find_2047) === (1)) ? 1 : 0))) { __pc = 10408; break; }
				...
				case 10408: //dummy jumper1
					...
					local4_Find_2047 = 1;
					__debugInfo = "1036:\src\CompilerPasses\Generator\JSGenerator.gbas";
					forEachSaver10427.values[forEachCounter10427] = local1_D_2048;
					
					forEachCounter10427++
					__pc = 10403; break; //back jump
					
				case 10399: //dummy for
					;
				...
				case 10373: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(37))) ? 1 : 0))) { __pc = 10438; break; }
					...
					case 10510:
						...
						if (!((((global5_Exprs_ref[0].arrAccess(param4_expr.attr4_expr).values[tmpPositionCache][0].attr3_Typ) === (54)) ? 1 : 0))) { __pc = 10464; break; }
				...
				case 10438: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(20))) ? 1 : 0))) { __pc = 10517; break; }
				...
				case 10517: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(21))) ? 1 : 0))) { __pc = 10531; break; }
				...
				case 10531: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(39))) ? 1 : 0))) { __pc = 10561; break; }
				...
				case 10561: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(40))) ? 1 : 0))) { __pc = 10583; break; }
				...
				case 10583: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(41))) ? 1 : 0))) { __pc = 10610; break; }
					
					case 10659:
						__debugInfo = "1066:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!((((param4_expr.attr4_kern) !== (-(1))) ? 1 : 0))) { __pc = 10619; break; }
				...
				case 10610: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(45))) ? 1 : 0))) { __pc = 10661; break; }
				...
				case 10661: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(42))) ? 1 : 0))) { __pc = 10687; break; }
					...
					case 10731:
						...
						var forEachSaver10731 = param4_expr.attr5_Exprs;
					var forEachCounter10731 = 0
					
				case 10709: //dummy for1
					if (!(forEachCounter10731 < forEachSaver10731.values.length)) {__pc = 10705; break;}
					var local4_Elem_2050 = forEachSaver10731.values[forEachCounter10731];
					
					
					case 10719:
						__debugInfo = "1073:\src\CompilerPasses\Generator\JSGenerator.gbas";
						if (!(local4_Find_2049)) { __pc = 10712; break; }
				...
				case 10712: //dummy jumper1
					...
					local4_Find_2049 = 1;
					__debugInfo = "1073:\src\CompilerPasses\Generator\JSGenerator.gbas";
					forEachSaver10731.values[forEachCounter10731] = local4_Elem_2050;
					
					forEachCounter10731++
					__pc = 10709; break; //back jump
					
				case 10705: //dummy for
					;
				...
				case 10687: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(43))) ? 1 : 0))) { __pc = 10738; break; }
				...
				case 10738: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(44))) ? 1 : 0))) { __pc = 10803; break; }
				...
				case 10803: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(46))) ? 1 : 0))) { __pc = 10829; break; }
				...
				case 10829: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(48))) ? 1 : 0))) { __pc = 10846; break; }
				...
				case 10846: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(49))) ? 1 : 0))) { __pc = 10862; break; }
				...
				case 10862: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(50))) ? 1 : 0))) { __pc = 10890; break; }
				...
				case 10890: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(51))) ? 1 : 0))) { __pc = 10907; break; }
				...
				case 10907: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(52))) ? 1 : 0))) { __pc = 10946; break; }
				...
				case 10946: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(53))) ? 1 : 0))) { __pc = 10980; break; }
					...
					case 11070:
						...
						if (!((((((((((local3_Scp_2053) !== (-(1))) ? 1 : 0)) && (((((((((global5_Exprs_ref[0].arrAccess(local3_Scp_2053).values[tmpPositionCache][0].attr6_ScpTyp) === (2)) ? 1 : 0)) || ((((global5_Exprs_ref[0].arrAccess(local3_Scp_2053).values[tmpPositionCache][0].attr6_ScpTyp) === (4)) ? 1 : 0))) ? 1 : 0)) ? 0 : 1))) ? 1 : 0)) && (((local5_Found_2052) ? 0 : 1))) ? 1 : 0))) {__pc = 29508; break;}
					...
					case 11062:
						...
						var forEachSaver11062 = local5_Varis_2054;
					var forEachCounter11062 = 0
					
				case 11030: //dummy for1
					if (!(forEachCounter11062 < forEachSaver11062.values.length)) {__pc = 11028; break;}
					var local1_V_2055 = forEachSaver11062.values[forEachCounter11062];
					...
					case 11061:
						...
						if (!((((alias3_Var_ref_2056[0].attr8_Name_Str) === ((("param4_self_") + (CAST2STRING(alias3_Var_ref_2056[0].attr2_ID))))) ? 1 : 0))) { __pc = 11048; break; }
				...
				case 11048: //dummy jumper1
					;
						
					__debugInfo = "1109:\src\CompilerPasses\Generator\JSGenerator.gbas";pool_TIdentifierVari.free(alias3_Var_ref_2056);
					forEachSaver11062.values[forEachCounter11062] = local1_V_2055;
					
					forEachCounter11062++
					__pc = 11030; break; //back jump
					
				case 11028: //dummy for
					;
					...
					__debugInfo = "1107:\src\CompilerPasses\Generator\JSGenerator.gbas";pool_array.free(local5_Varis_2054);
					__pc = 11070; break; //back jump
				...
				case 29508:
					...
					case 11079:
						...
						if (!(((local5_Found_2052) ? 0 : 1))) { __pc = 11073; break; }
				...
				case 10980: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(54))) ? 1 : 0))) { __pc = 11081; break; }
				...
				case 11081: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(7))) ? 1 : 0))) { __pc = 11107; break; }
					
					
					__pc = 29429;
					break;
					
				case 11107: //dummy jumper1
					if (!((((local17___SelectHelper10__1961) === (~~(8))) ? 1 : 0))) { __pc = 11110; break; }
...
window['func17_JSDoParameter_Str'] = function(param4_expr, param4_func, param7_DoParam) {
	...
	try {
		...
		var forEachSaver11420 = param4_expr.attr6_Params;
		for(var forEachCounter11420 = 0 ; forEachCounter11420 < forEachSaver11420.values.length ; forEachCounter11420++) {
			var local5_param_2067 = forEachSaver11420.values[forEachCounter11420];
		{
			...
			forEachSaver11420.values[forEachCounter11420] = local5_param_2067;
...
window['func13_JSVariDef_Str'] = function(param5_Varis, param12_ForceDefault, param8_NoStatic, param7_InitVal) {
	...
	try {
		...
		var forEachSaver11574 = param5_Varis;
		for(var forEachCounter11574 = 0 ; forEachCounter11574 < forEachSaver11574.values.length ; forEachCounter11574++) {
			var local3_Var_2074 = forEachSaver11574.values[forEachCounter11574];
		{
			...
			forEachSaver11574.values[forEachCounter11574] = local3_Var_2074;
...
window['func17_JSShouldRedeclare'] = function(param3_Var) {
	...
	try {
		...
		if ((((global11_CurrentFunc) !== (-(1))) ? 1 : 0)) {
			...
			var forEachSaver11629 = global8_Compiler.attr5_Funcs_ref[0].arrAccess(global11_CurrentFunc).values[tmpPositionCache][0].attr10_CopyParams;
			for(var forEachCounter11629 = 0 ; forEachCounter11629 < forEachSaver11629.values.length ; forEachCounter11629++) {
				var local1_P_2077 = forEachSaver11629.values[forEachCounter11629];
			{
				...
				forEachSaver11629.values[forEachCounter11629] = local1_P_2077;
...
window['func5_Lexer'] = function() {
	...
	try {
		...
		var forEachSaver11821 = local12_Splitter_Str_2085;
		for(var forEachCounter11821 = 0 ; forEachCounter11821 < forEachSaver11821.values.length ; forEachCounter11821++) {
			var local9_Split_Str_2087 = forEachSaver11821.values[forEachCounter11821];
		{
				__debugInfo = "17:\src\CompilerPasses\Lexer.gbas";
				(local11_SplitterMap_2086).Put(local9_Split_Str_2087, 1);
				__debugInfo = "17:\src\CompilerPasses\Lexer.gbas";
			}
			forEachSaver11821.values[forEachCounter11821] = local9_Split_Str_2087;
...
window['func7_FuncDef'] = function(param6_Native, param10_IsCallBack, param3_Typ, param6_CurTyp) {
	...
	try {
		...
		var forEachSaver13104 = global8_Compiler.attr5_Funcs_ref[0];
		for(var forEachCounter13104 = 0 ; forEachCounter13104 < forEachSaver13104.values.length ; forEachCounter13104++) {
			var local4_func_ref_2130 = forEachSaver13104.values[forEachCounter13104];
		{
			...
			forEachSaver13104.values[forEachCounter13104] = local4_func_ref_2130;
...
window['func6_SubDef'] = function() {
	...
	try {
		...
		var forEachSaver13203 = global8_Compiler.attr5_Funcs_ref[0];
		for(var forEachCounter13203 = 0 ; forEachCounter13203 < forEachSaver13203.values.length ; forEachCounter13203++) {
			var local4_func_ref_2135 = forEachSaver13203.values[forEachCounter13203];
		{
			...
			forEachSaver13203.values[forEachCounter13203] = local4_func_ref_2135;
...
window['func8_TypeDefi'] = function() {
	...
	try {
		...
		var forEachSaver13458 = global8_Compiler.attr5_Types_ref[0];
		for(var forEachCounter13458 = 0 ; forEachCounter13458 < forEachSaver13458.values.length ; forEachCounter13458++) {
			var local3_typ_ref_2136 = forEachSaver13458.values[forEachCounter13458];
		{
				...
				if (func7_IsToken(local3_typ_ref_2136[0].attr8_Name_Str)) {
					...
					if ((((local11_ExtName_Str_2137) !== ("")) ? 1 : 0)) {
						...
						var forEachSaver13303 = global8_Compiler.attr5_Types_ref[0];
						for(var forEachCounter13303 = 0 ; forEachCounter13303 < forEachSaver13303.values.length ; forEachCounter13303++) {
							var local1_T_ref_2138 = forEachSaver13303.values[forEachCounter13303];
						{
							...
							forEachSaver13303.values[forEachCounter13303] = local1_T_ref_2138;
					...
					var forEachSaver13369 = local3_typ_ref_2136[0].attr7_Methods;
					for(var forEachCounter13369 = 0 ; forEachCounter13369 < forEachSaver13369.values.length ; forEachCounter13369++) {
						var local2_M1_2139 = forEachSaver13369.values[forEachCounter13369];
					{
							__debugInfo = "219:\src\CompilerPasses\Parser.gbas";
							var forEachSaver13368 = local3_typ_ref_2136[0].attr7_Methods;
							for(var forEachCounter13368 = 0 ; forEachCounter13368 < forEachSaver13368.values.length ; forEachCounter13368++) {
								var local2_M2_2140 = forEachSaver13368.values[forEachCounter13368];
							{
								...
								forEachSaver13368.values[forEachCounter13368] = local2_M2_2140;
							
							};
							__debugInfo = "219:\src\CompilerPasses\Parser.gbas";
						}
						forEachSaver13369.values[forEachCounter13369] = local2_M1_2139;
			...
			forEachSaver13458.values[forEachCounter13458] = local3_typ_ref_2136;
	...
	try {
		...
		if ((((param4_Prio) < (15)) ? 1 : 0)) {
			...
			do {
				...
				var forEachSaver13561 = global9_Operators_ref[0];
				for(var forEachCounter13561 = 0 ; forEachCounter13561 < forEachSaver13561.values.length ; forEachCounter13561++) {
					var local2_Op_ref_2147 = forEachSaver13561.values[forEachCounter13561];
				{
					...
					forEachSaver13561.values[forEachCounter13561] = local2_Op_ref_2147;
...
window['func6_Factor'] = function() {
	...
	try {
		...
		if (func7_IsToken("(")) {
			...
			var forEachSaver14479 = global8_Compiler.attr5_Funcs_ref[0];
			for(var forEachCounter14479 = 0 ; forEachCounter14479 < forEachSaver14479.values.length ; forEachCounter14479++) {
				var local4_Func_ref_2179 = forEachSaver14479.values[forEachCounter14479];
			{
				...
				forEachSaver14479.values[forEachCounter14479] = local4_Func_ref_2179;
			...
			var forEachSaver14694 = global7_Defines;
			for(var forEachCounter14694 = 0 ; forEachCounter14694 < forEachSaver14694.values.length ; forEachCounter14694++) {
				var local3_Def_2185 = forEachSaver14694.values[forEachCounter14694];
			{
				...
				forEachSaver14694.values[forEachCounter14694] = local3_Def_2185;
			...
			if (((global6_STRICT) ? 0 : 1)) {
				...
				var forEachSaver14875 = local5_Varis_2190;
				for(var forEachCounter14875 = 0 ; forEachCounter14875 < forEachSaver14875.values.length ; forEachCounter14875++) {
					var local4_Vari_2191 = forEachSaver14875.values[forEachCounter14875];
				{
					...
					forEachSaver14875.values[forEachCounter14875] = local4_Vari_2191;
	...
	try {
		__debugInfo = "1007:\src\CompilerPasses\Parser.gbas";
		{
			...
			try {
				...
				var forEachSaver14947 = global8_Compiler.attr5_Funcs_ref[0];
				for(var forEachCounter14947 = 0 ; forEachCounter14947 < forEachSaver14947.values.length ; forEachCounter14947++) {
					var local4_func_ref_2192 = forEachSaver14947.values[forEachCounter14947];
				{
					...
					forEachSaver14947.values[forEachCounter14947] = local4_func_ref_2192;
				...
				while (1) {
					...
					var forEachSaver14985 = global8_Compiler.attr5_Funcs_ref[0];
					for(var forEachCounter14985 = 0 ; forEachCounter14985 < forEachSaver14985.values.length ; forEachCounter14985++) {
						var local4_func_ref_2194 = forEachSaver14985.values[forEachCounter14985];
					{
						...
						forEachSaver14985.values[forEachCounter14985] = local4_func_ref_2194;
					...
					for (local1_i_2199 = 0;toCheck(local1_i_2199, ((global10_LastExprID) - (1)), 1);local1_i_2199 += 1) {
						...
						if (((((((global5_Exprs_ref[0].arrAccess(~~(local1_i_2199)).values[tmpPositionCache][0].attr3_Typ) === (6)) ? 1 : 0)) || ((((global5_Exprs_ref[0].arrAccess(~~(local1_i_2199)).values[tmpPositionCache][0].attr3_Typ) === (23)) ? 1 : 0))) ? 1 : 0)) {
							...
							if ((((BOUNDS(global5_Exprs_ref[0].arrAccess(~~(local1_i_2199)).values[tmpPositionCache][0].attr6_Params, 0)) === (BOUNDS(global8_Compiler.attr5_Funcs_ref[0].arrAccess(global5_Exprs_ref[0].arrAccess(~~(local1_i_2199)).values[tmpPositionCache][0].attr4_func).values[tmpPositionCache][0].attr6_Params, 0))) ? 1 : 0)) {
								...
								var forEachSaver15412 = global5_Exprs_ref[0].arrAccess(~~(local1_i_2199)).values[tmpPositionCache][0].attr6_Params;
								for(var forEachCounter15412 = 0 ; forEachCounter15412 < forEachSaver15412.values.length ; forEachCounter15412++) {
									var local1_P_2203 = forEachSaver15412.values[forEachCounter15412];
								{
									...
									forEachSaver15412.values[forEachCounter15412] = local1_P_2203;
						...
						__debugInfo = "935:\src\CompilerPasses\Parser.gbas";
						{
							...
							if ((((local17___SelectHelper24__2220) === (~~(2))) ? 1 : 0)) {
								...
								if ((((((((((alias4_Expr_ref_2219[0].attr6_ScpTyp) === (2)) ? 1 : 0)) || ((((alias4_Expr_ref_2219[0].attr6_ScpTyp) === (4)) ? 1 : 0))) ? 1 : 0)) && (BOUNDS(alias4_Expr_ref_2219[0].attr5_Gotos, 0))) ? 1 : 0)) {
									...
									var forEachSaver16097 = alias4_Expr_ref_2219[0].attr5_Gotos;
									for(var forEachCounter16097 = 0 ; forEachCounter16097 < forEachSaver16097.values.length ; forEachCounter16097++) {
										var local1_G_2221 = forEachSaver16097.values[forEachCounter16097];
									{
											var local5_Found_2222 = 0;
											__debugInfo = "942:\src\CompilerPasses\Parser.gbas";
											local5_Found_2222 = 0;
											__debugInfo = "948:\src\CompilerPasses\Parser.gbas";
											var forEachSaver16070 = alias4_Expr_ref_2219[0].attr6_Labels;
											for(var forEachCounter16070 = 0 ; forEachCounter16070 < forEachSaver16070.values.length ; forEachCounter16070++) {
												var local1_L_2223 = forEachSaver16070.values[forEachCounter16070];
											{
												...
												forEachSaver16070.values[forEachCounter16070] = local1_L_2223;
										...
										forEachSaver16097.values[forEachCounter16097] = local1_G_2221;
				...
				var forEachSaver16123 = global8_Compiler.attr5_Types_ref[0];
				for(var forEachCounter16123 = 0 ; forEachCounter16123 < forEachSaver16123.values.length ; forEachCounter16123++) {
					var local3_Typ_ref_2224 = forEachSaver16123.values[forEachCounter16123];
				{
					...
					forEachSaver16123.values[forEachCounter16123] = local3_Typ_ref_2224;
				
				};
				__debugInfo = "972:\src\CompilerPasses\Parser.gbas";
				var forEachSaver16133 = global8_Compiler.attr5_Funcs_ref[0];
				for(var forEachCounter16133 = 0 ; forEachCounter16133 < forEachSaver16133.values.length ; forEachCounter16133++) {
					var local4_Func_ref_2225 = forEachSaver16133.values[forEachCounter16133];
				{
						__debugInfo = "971:\src\CompilerPasses\Parser.gbas";
						func14_ChangeFuncName(unref(local4_Func_ref_2225[0]));
						__debugInfo = "971:\src\CompilerPasses\Parser.gbas";
					}
					forEachSaver16133.values[forEachCounter16133] = local4_Func_ref_2225;
				
				};
				__debugInfo = "978:\src\CompilerPasses\Parser.gbas";
				var forEachSaver16143 = global8_Compiler.attr5_Varis_ref[0];
				for(var forEachCounter16143 = 0 ; forEachCounter16143 < forEachSaver16143.values.length ; forEachCounter16143++) {
					var local4_Vari_ref_2226 = forEachSaver16143.values[forEachCounter16143];
				{
						__debugInfo = "977:\src\CompilerPasses\Parser.gbas";
						func13_ChangeVarName(unref(local4_Vari_ref_2226[0]));
						__debugInfo = "977:\src\CompilerPasses\Parser.gbas";
					}
					forEachSaver16143.values[forEachCounter16143] = local4_Vari_ref_2226;
				
				};
				__debugInfo = "986:\src\CompilerPasses\Parser.gbas";
				var forEachSaver16179 = global8_Compiler.attr5_Varis_ref[0];
				for(var forEachCounter16179 = 0 ; forEachCounter16179 < forEachSaver16179.values.length ; forEachCounter16179++) {
					var local1_V_ref_2227 = forEachSaver16179.values[forEachCounter16179];
				{
					...
					forEachSaver16179.values[forEachCounter16179] = local1_V_ref_2227;
					...
					for (local1_i_2228 = 0;toCheck(local1_i_2228, ((global10_LastExprID) - (1)), 1);local1_i_2228 += 1) {
						...
						if (((((((((((((alias1_E_ref_2229[0].attr8_datatype.attr8_Name_Str) === ("void")) ? 1 : 0)) || ((((alias1_E_ref_2229[0].attr8_datatype.attr8_Name_Str) === ("int")) ? 1 : 0))) ? 1 : 0)) || ((((alias1_E_ref_2229[0].attr8_datatype.attr8_Name_Str) === ("float")) ? 1 : 0))) ? 1 : 0)) || ((((alias1_E_ref_2229[0].attr8_datatype.attr8_Name_Str) === ("string")) ? 1 : 0))) ? 1 : 0)) {
							...
							if ((((func6_IsType(alias1_E_ref_2229[0].attr8_datatype.attr8_Name_Str)) === (0)) ? 1 : 0)) {
								...
								var forEachSaver16270 = global8_Compiler.attr5_Funcs_ref[0];
								for(var forEachCounter16270 = 0 ; forEachCounter16270 < forEachSaver16270.values.length ; forEachCounter16270++) {
									var local1_F_ref_2230 = forEachSaver16270.values[forEachCounter16270];
								{
									...
									forEachSaver16270.values[forEachCounter16270] = local1_F_ref_2230;
...
window['func15_CheckPrototypes'] = function() {
	...
	try {
		...
		if ((((BOUNDS(global8_Compiler.attr13_protoCheckers, 0)) > (0)) ? 1 : 0)) {
			...
			var forEachSaver16459 = global8_Compiler.attr13_protoCheckers;
			for(var forEachCounter16459 = 0 ; forEachCounter16459 < forEachSaver16459.values.length ; forEachCounter16459++) {
				var local7_checker_2232 = forEachSaver16459.values[forEachCounter16459];
			{
				...
				forEachSaver16459.values[forEachCounter16459] = local7_checker_2232;
...
window['func5_Scope'] = function(param12_CloseStr_Str, param4_func) {
	...
	try {
		...
		if (((((((local6_ScpTyp_2241) === (2)) ? 1 : 0)) && ((((param4_func) !== (-(1))) ? 1 : 0))) ? 1 : 0)) {
			...
			var forEachSaver16689 = global8_Compiler.attr5_Funcs_ref[0].arrAccess(param4_func).values[tmpPositionCache][0].attr6_Params;
			for(var forEachCounter16689 = 0 ; forEachCounter16689 < forEachSaver16689.values.length ; forEachCounter16689++) {
				var local5_param_2247 = forEachSaver16689.values[forEachCounter16689];
			{
				...
				forEachSaver16689.values[forEachCounter16689] = local5_param_2247;
					...
					if (func9_IsKeyword()) {
						...
						if (func7_IsToken(":")) {
							...
							do {
								...
								var forEachSaver16864 = global5_Exprs_ref[0].arrAccess(local3_Scp_2254).values[tmpPositionCache][0].attr6_Labels;
								for(var forEachCounter16864 = 0 ; forEachCounter16864 < forEachSaver16864.values.length ; forEachCounter16864++) {
									var local3_lbl_2255 = forEachSaver16864.values[forEachCounter16864];
								{
									...
									forEachSaver16864.values[forEachCounter16864] = local3_lbl_2255;
...
window['func10_Identifier'] = function(param9_IsCommand) {
	...
	try {
		...
		do {
			...
			var forEachSaver17604 = local5_Varis_2274;
			for(var forEachCounter17604 = 0 ; forEachCounter17604 < forEachSaver17604.values.length ; forEachCounter17604++) {
				var local4_Vari_2276 = forEachSaver17604.values[forEachCounter17604];
			{
					...
					if ((((local8_Name_Str_2272) === (global8_Compiler.attr5_Varis_ref[0].arrAccess(local4_Vari_2276).values[tmpPositionCache][0].attr8_Name_Str)) ? 1 : 0)) {
						...
						if ((((((((((global8_Compiler.attr11_currentFunc) !== (-(1))) ? 1 : 0)) && ((((global8_Compiler.attr5_Funcs_ref[0].arrAccess(global8_Compiler.attr11_currentFunc).values[tmpPositionCache][0].attr6_MyType) !== (-(1))) ? 1 : 0))) ? 1 : 0)) && ((((local4_Expr_ref_2267[0]) === (-(1))) ? 1 : 0))) ? 1 : 0)) {
							...
							var forEachSaver17545 = local5_Varis_2274;
							for(var forEachCounter17545 = 0 ; forEachCounter17545 < forEachSaver17545.values.length ; forEachCounter17545++) {
								var local9_OtherVari_2278 = forEachSaver17545.values[forEachCounter17545];
							{
								...
								forEachSaver17545.values[forEachCounter17545] = local9_OtherVari_2278;
							...
							if (((local13_IsNotImplicit_2277) ? 0 : 1)) {
								...
								var forEachSaver17590 = alias3_Typ_ref_2279[0].attr10_Attributes;
								for(var forEachCounter17590 = 0 ; forEachCounter17590 < forEachSaver17590.values.length ; forEachCounter17590++) {
									var local1_A_2280 = forEachSaver17590.values[forEachCounter17590];
								{
									...
									forEachSaver17590.values[forEachCounter17590] = local1_A_2280;
				...
				forEachSaver17604.values[forEachCounter17604] = local4_Vari_2276;
			...
			if ((((local5_Found_2275) === (0)) ? 1 : 0)) {
				...
				if ((((local4_Expr_ref_2267[0]) !== (-(1))) ? 1 : 0)) {
					...
					while ((((local5_typId_2283) !== (-(1))) ? 1 : 0)) {
						...
						var forEachSaver17747 = global8_Compiler.attr5_Types_ref[0].arrAccess(local5_typId_2283).values[tmpPositionCache][0].attr7_Methods;
						for(var forEachCounter17747 = 0 ; forEachCounter17747 < forEachSaver17747.values.length ; forEachCounter17747++) {
							var local1_M_2284 = forEachSaver17747.values[forEachCounter17747];
						{
							...
							forEachSaver17747.values[forEachCounter17747] = local1_M_2284;
					...
					if ((global8_Compiler.attr11_GlobalFuncs).GetValue(local8_Name_Str_2272, local3_Val_ref_2286)) {
						...
						while ((((local5_typId_2289) !== (-(1))) ? 1 : 0)) {
							...
							var forEachSaver17890 = global8_Compiler.attr5_Types_ref[0].arrAccess(local5_typId_2289).values[tmpPositionCache][0].attr7_Methods;
							for(var forEachCounter17890 = 0 ; forEachCounter17890 < forEachSaver17890.values.length ; forEachCounter17890++) {
								var local1_M_2290 = forEachSaver17890.values[forEachCounter17890];
							{
								...
								forEachSaver17890.values[forEachCounter17890] = local1_M_2290;
				...
				if ((((local5_Found_2275) === (0)) ? 1 : 0)) {
					...
					if ((((local4_Expr_ref_2267[0]) !== (-(1))) ? 1 : 0)) {
						...
						var forEachSaver17994 = local5_Varis_2274;
						for(var forEachCounter17994 = 0 ; forEachCounter17994 < forEachSaver17994.values.length ; forEachCounter17994++) {
							var local4_Vari_2295 = forEachSaver17994.values[forEachCounter17994];
						{
							...
							forEachSaver17994.values[forEachCounter17994] = local4_Vari_2295;
		...
		__debugInfo = "1540:\src\CompilerPasses\Parser.gbas";
		{
			...
			if ((((local17___SelectHelper27__2313) === (func7_IsToken("CALLBACK"))) ? 1 : 0)) {
				...
				do {
					...
					var forEachSaver18678 = global8_Compiler.attr7_Globals;
					for(var forEachCounter18678 = 0 ; forEachCounter18678 < forEachSaver18678.values.length ; forEachCounter18678++) {
						var local1_V_2315 = forEachSaver18678.values[forEachCounter18678];
					{
						...
						forEachSaver18678.values[forEachCounter18678] = local1_V_2315;
				...
				do {
					...
					if (func13_IsVarExisting(func17_CleanVariable_Str(func14_GetCurrent_Str()))) {
						...
						var forEachSaver18757 = local5_Varis_2319;
						for(var forEachCounter18757 = 0 ; forEachCounter18757 < forEachSaver18757.values.length ; forEachCounter18757++) {
							var local1_V_2320 = forEachSaver18757.values[forEachCounter18757];
						{
							...
							forEachSaver18757.values[forEachCounter18757] = local1_V_2320;
				...
				var forEachSaver19734 = global8_Compiler.attr5_Funcs_ref[0];
				for(var forEachCounter19734 = 0 ; forEachCounter19734 < forEachSaver19734.values.length ; forEachCounter19734++) {
					var local1_F_ref_2353 = forEachSaver19734.values[forEachCounter19734];
				{
					...
					forEachSaver19734.values[forEachCounter19734] = local1_F_ref_2353;
				
				};
				__debugInfo = "1829:\src\CompilerPasses\Parser.gbas";
				if (((local5_Found_2352) ? 0 : 1)) {
					__debugInfo = "1828:\src\CompilerPasses\Parser.gbas";
					var forEachSaver19774 = global8_Compiler.attr7_Globals;
					for(var forEachCounter19774 = 0 ; forEachCounter19774 < forEachSaver19774.values.length ; forEachCounter19774++) {
						var local1_V_2354 = forEachSaver19774.values[forEachCounter19774];
					{
						...
						forEachSaver19774.values[forEachCounter19774] = local1_V_2354;
				...
				var forEachSaver21051 = global8_Compiler.attr10_DataBlocks;
				for(var forEachCounter21051 = 0 ; forEachCounter21051 < forEachSaver21051.values.length ; forEachCounter21051++) {
					var local5_block_2407 = forEachSaver21051.values[forEachCounter21051];
				{
					...
					forEachSaver21051.values[forEachCounter21051] = local5_block_2407;
	...
	try {
		...
		if ((((((((((global8_Compiler.attr11_currentFunc) !== (-(1))) ? 1 : 0)) && ((((global8_Compiler.attr5_Funcs_ref[0].arrAccess(global8_Compiler.attr11_currentFunc).values[tmpPositionCache][0].attr6_MyType) !== (-(1))) ? 1 : 0))) ? 1 : 0)) && (((param18_IgnoreImplicitSelf) ? 0 : 1))) ? 1 : 0)) {
			...
			while ((((local5_myTyp_2435) !== (-(1))) ? 1 : 0)) {
				...
				var forEachSaver21738 = global8_Compiler.attr5_Types_ref[0].arrAccess(local5_myTyp_2435).values[tmpPositionCache][0].attr7_Methods;
				for(var forEachCounter21738 = 0 ; forEachCounter21738 < forEachSaver21738.values.length ; forEachCounter21738++) {
					var local1_M_2436 = forEachSaver21738.values[forEachCounter21738];
				{
					...
					forEachSaver21738.values[forEachCounter21738] = local1_M_2436;
			...
			var forEachSaver21769 = alias3_Typ_ref_2434[0].attr10_Attributes;
			for(var forEachCounter21769 = 0 ; forEachCounter21769 < forEachSaver21769.values.length ; forEachCounter21769++) {
				var local1_A_2437 = forEachSaver21769.values[forEachCounter21769];
			{
				...
				forEachSaver21769.values[forEachCounter21769] = local1_A_2437;
...
window['func6_IsType'] = function(param7_Str_Str) {
	...
	try {
		...
		var forEachSaver21870 = global8_Compiler.attr5_Types_ref[0];
		for(var forEachCounter21870 = 0 ; forEachCounter21870 < forEachSaver21870.values.length ; forEachCounter21870++) {
			var local3_typ_ref_2440 = forEachSaver21870.values[forEachCounter21870];
		{
			...
			forEachSaver21870.values[forEachCounter21870] = local3_typ_ref_2440;
...
window['func14_IsFuncExisting'] = function(param8_func_Str, param10_IsCallback) {
	...
	try {
		...
		var forEachSaver21995 = global8_Compiler.attr5_Types_ref[0];
		for(var forEachCounter21995 = 0 ; forEachCounter21995 < forEachSaver21995.values.length ; forEachCounter21995++) {
			var local1_T_ref_2446 = forEachSaver21995.values[forEachCounter21995];
		{
			...
			forEachSaver21995.values[forEachCounter21995] = local1_T_ref_2446;
		...
		var forEachSaver22039 = global8_Compiler.attr5_Funcs_ref[0];
		for(var forEachCounter22039 = 0 ; forEachCounter22039 < forEachSaver22039.values.length ; forEachCounter22039++) {
			var local1_F_ref_2447 = forEachSaver22039.values[forEachCounter22039];
		{
			...
			forEachSaver22039.values[forEachCounter22039] = local1_F_ref_2447;
...
window['func10_IsOperator'] = function() {
	...
	try {
		...
		var forEachSaver22060 = global9_Operators_ref[0];
		for(var forEachCounter22060 = 0 ; forEachCounter22060 < forEachSaver22060.values.length ; forEachCounter22060++) {
			var local2_Op_ref_2448 = forEachSaver22060.values[forEachCounter22060];
		{
			...
			forEachSaver22060.values[forEachCounter22060] = local2_Op_ref_2448;
...
window['func15_IsValidDatatype'] = function() {
	...
	try {
		...
		var forEachSaver22095 = global8_Compiler.attr5_Funcs_ref[0];
		for(var forEachCounter22095 = 0 ; forEachCounter22095 < forEachSaver22095.values.length ; forEachCounter22095++) {
			var local4_func_ref_2449 = forEachSaver22095.values[forEachCounter22095];
		{
			...
			forEachSaver22095.values[forEachCounter22095] = local4_func_ref_2449;
		
		};
		__debugInfo = "2428:\src\CompilerPasses\Parser.gbas";
		var forEachSaver22109 = global8_Compiler.attr5_Types_ref[0];
		for(var forEachCounter22109 = 0 ; forEachCounter22109 < forEachSaver22109.values.length ; forEachCounter22109++) {
			var local3_typ_ref_2450 = forEachSaver22109.values[forEachCounter22109];
		{
				__debugInfo = "2427:\src\CompilerPasses\Parser.gbas";
				STDOUT(((local3_typ_ref_2450[0].attr12_RealName_Str) + ("\n")));
				__debugInfo = "2427:\src\CompilerPasses\Parser.gbas";
			}
			forEachSaver22109.values[forEachCounter22109] = local3_typ_ref_2450;
...
window['func8_IsDefine'] = function(param7_Def_Str) {
	...
	try {
		...
		var forEachSaver22146 = global7_Defines;
		for(var forEachCounter22146 = 0 ; forEachCounter22146 < forEachSaver22146.values.length ; forEachCounter22146++) {
			var local3_Def_2452 = forEachSaver22146.values[forEachCounter22146];
		{
			...
			forEachSaver22146.values[forEachCounter22146] = local3_Def_2452;
...
window['func8_GetVaris'] = function(param5_Varis, param3_Scp, param9_PreferVar) {
	...
	try {
		...
		if (((((((param9_PreferVar) === (-(1))) ? 1 : 0)) && ((((BOUNDS(param5_Varis, 0)) === (0)) ? 1 : 0))) ? 1 : 0)) {
			...
			var forEachSaver22193 = global8_Compiler.attr7_Globals;
			for(var forEachCounter22193 = 0 ; forEachCounter22193 < forEachSaver22193.values.length ; forEachCounter22193++) {
				var local4_Vari_2456 = forEachSaver22193.values[forEachCounter22193];
			{
					__debugInfo = "2452:\src\CompilerPasses\Parser.gbas";
					DIMPUSH(param5_Varis, local4_Vari_2456);
					__debugInfo = "2452:\src\CompilerPasses\Parser.gbas";
				}
				forEachSaver22193.values[forEachCounter22193] = local4_Vari_2456;
		...
		if ((((param3_Scp) !== (-(1))) ? 1 : 0)) {
			...
			var forEachSaver22217 = global5_Exprs_ref[0].arrAccess(~~(param3_Scp)).values[tmpPositionCache][0].attr5_Varis;
			for(var forEachCounter22217 = 0 ; forEachCounter22217 < forEachSaver22217.values.length ; forEachCounter22217++) {
				var local4_Vari_2457 = forEachSaver22217.values[forEachCounter22217];
			{
					__debugInfo = "2458:\src\CompilerPasses\Parser.gbas";
					DIMPUSH(param5_Varis, local4_Vari_2457);
					__debugInfo = "2458:\src\CompilerPasses\Parser.gbas";
				}
				forEachSaver22217.values[forEachCounter22217] = local4_Vari_2457;
			...
			if (((((((global8_Compiler.attr11_currentFunc) !== (-(1))) ? 1 : 0)) && ((((global8_Compiler.attr5_Funcs_ref[0].arrAccess(global8_Compiler.attr11_currentFunc).values[tmpPositionCache][0].attr6_MyType) !== (-(1))) ? 1 : 0))) ? 1 : 0)) {
				...
				var forEachSaver22266 = alias3_Typ_ref_2458[0].attr10_Attributes;
				for(var forEachCounter22266 = 0 ; forEachCounter22266 < forEachSaver22266.values.length ; forEachCounter22266++) {
					var local1_A_2459 = forEachSaver22266.values[forEachCounter22266];
				{
						__debugInfo = "2464:\src\CompilerPasses\Parser.gbas";
						DIMPUSH(param5_Varis, local1_A_2459);
						__debugInfo = "2464:\src\CompilerPasses\Parser.gbas";
					}
					forEachSaver22266.values[forEachCounter22266] = local1_A_2459;
		...
		if (((((((global5_Exprs_ref[0].arrAccess(~~(param3_Scp)).values[tmpPositionCache][0].attr10_SuperScope) !== (-(1))) ? 1 : 0)) && ((((global5_Exprs_ref[0].arrAccess(~~(param3_Scp)).values[tmpPositionCache][0].attr6_ScpTyp) !== (2)) ? 1 : 0))) ? 1 : 0)) {
			...
			var forEachSaver22315 = global8_Compiler.attr7_Globals;
			for(var forEachCounter22315 = 0 ; forEachCounter22315 < forEachSaver22315.values.length ; forEachCounter22315++) {
				var local4_Vari_2460 = forEachSaver22315.values[forEachCounter22315];
			{
					__debugInfo = "2474:\src\CompilerPasses\Parser.gbas";
					DIMPUSH(param5_Varis, local4_Vari_2460);
					__debugInfo = "2474:\src\CompilerPasses\Parser.gbas";
				}
				forEachSaver22315.values[forEachCounter22315] = local4_Vari_2460;
...
window['func17_BuildPrototyp_Str'] = function(param1_F) {
	...
	try {
		...
		var forEachSaver22657 = alias4_Func_ref_2478[0].attr6_Params;
		for(var forEachCounter22657 = 0 ; forEachCounter22657 < forEachSaver22657.values.length ; forEachCounter22657++) {
			var local1_P_2481 = forEachSaver22657.values[forEachCounter22657];
		{
			...
			forEachSaver22657.values[forEachCounter22657] = local1_P_2481;
...
window['func14_SearchOperator'] = function(param8_Name_Str) {
	...
	try {
		...
		var forEachSaver22723 = global9_Operators_ref[0];
		for(var forEachCounter22723 = 0 ; forEachCounter22723 < forEachSaver22723.values.length ; forEachCounter22723++) {
			var local2_Op_ref_2486 = forEachSaver22723.values[forEachCounter22723];
		{
			...
			forEachSaver22723.values[forEachCounter22723] = local2_Op_ref_2486;
...
window['func12_ScopeHasGoto'] = function(param3_scp) {
	...
	try {
		...
		var forEachSaver22928 = param3_scp.attr5_Exprs;
		for(var forEachCounter22928 = 0 ; forEachCounter22928 < forEachSaver22928.values.length ; forEachCounter22928++) {
			var local1_E_2490 = forEachSaver22928.values[forEachCounter22928];
		{
				...
				__debugInfo = "2614:\src\CompilerPasses\Parser.gbas";
				{
					...
					if ((((local17___SelectHelper34__2492) === (~~(24))) ? 1 : 0)) {
						...
						var forEachSaver22808 = alias4_SubE_ref_2491[0].attr6_Scopes;
						for(var forEachCounter22808 = 0 ; forEachCounter22808 < forEachSaver22808.values.length ; forEachCounter22808++) {
							var local1_E_2493 = forEachSaver22808.values[forEachCounter22808];
						{
							...
							forEachSaver22808.values[forEachCounter22808] = local1_E_2493;
			...
			forEachSaver22928.values[forEachCounter22928] = local1_E_2490;
	...
	try {
		...
		__debugInfo = "2680:\src\CompilerPasses\Parser.gbas";
		{
			...
			if ((((local17___SelectHelper37__2498) === (~~(1))) ? 1 : 0)) {
				...
				var forEachSaver23139 = global8_Compiler.attr7_Exports;
				for(var forEachCounter23139 = 0 ; forEachCounter23139 < forEachSaver23139.values.length ; forEachCounter23139++) {
					var local3_Exp_2500 = forEachSaver23139.values[forEachCounter23139];
				{
					...
					forEachSaver23139.values[forEachCounter23139] = local3_Exp_2500;
		...
		__debugInfo = "2723:\src\CompilerPasses\Parser.gbas";
		{
			...
			if ((((local17___SelectHelper38__2502) === (~~(3))) ? 1 : 0)) {
				...
				if ((((param4_Func.attr6_Native) === (0)) ? 1 : 0)) {
					...
					var forEachSaver23443 = global8_Compiler.attr7_Exports;
					for(var forEachCounter23443 = 0 ; forEachCounter23443 < forEachSaver23443.values.length ; forEachCounter23443++) {
						var local3_Exp_2504 = forEachSaver23443.values[forEachCounter23443];
					{
						...
						forEachSaver23443.values[forEachCounter23443] = local3_Exp_2504;
...
window['func23_ManageFuncParamOverlaps'] = function() {
	...
	try {
		...
		var forEachSaver23674 = global8_Compiler.attr5_Funcs_ref[0];
		for(var forEachCounter23674 = 0 ; forEachCounter23674 < forEachSaver23674.values.length ; forEachCounter23674++) {
			var local4_Func_ref_2508 = forEachSaver23674.values[forEachCounter23674];
		{
				...
				if ((((((((((local4_Func_ref_2508[0].attr6_Native) === (0)) ? 1 : 0)) && ((((local4_Func_ref_2508[0].attr3_Scp) !== (-(1))) ? 1 : 0))) ? 1 : 0)) && ((((local4_Func_ref_2508[0].attr10_IsAbstract) === (0)) ? 1 : 0))) ? 1 : 0)) {
					...
					var forEachSaver23672 = local4_Func_ref_2508[0].attr6_Params;
					for(var forEachCounter23672 = 0 ; forEachCounter23672 < forEachSaver23672.values.length ; forEachCounter23672++) {
						var local1_P_2510 = forEachSaver23672.values[forEachCounter23672];
					{
						...
						forEachSaver23672.values[forEachCounter23672] = local1_P_2510;
			...
			forEachSaver23674.values[forEachCounter23674] = local4_Func_ref_2508;
			...
			__debugInfo = "21:\src\CompilerPasses\Preprocessor.gbas";
			{
				...
				if ((((local17___SelectHelper39__2514) === ("DEFINE")) ? 1 : 0)) {
					...
					if (((param9_IgnoreAll) ? 0 : 1)) {
						...
						var forEachSaver23769 = global7_Defines;
						for(var forEachCounter23769 = 0 ; forEachCounter23769 < forEachSaver23769.values.length ; forEachCounter23769++) {
							var local3_Def_2516 = forEachSaver23769.values[forEachCounter23769];
						{
								__debugInfo = "36:\src\CompilerPasses\Preprocessor.gbas";
								if (func7_IsToken(local3_Def_2516.attr7_Key_Str)) {
									__debugInfo = "36:\src\CompilerPasses\Preprocessor.gbas";
									forEachSaver23769.values[forEachCounter23769] = local3_Def_2516;
									DIMDEL(forEachSaver23769, forEachCounter23769);
									forEachCounter23769--;
									continue;
									__debugInfo = "36:\src\CompilerPasses\Preprocessor.gbas";
								};
					...
					if (((param9_IgnoreAll) ? 0 : 1)) {
						...
						var forEachSaver23800 = global7_Defines;
						for(var forEachCounter23800 = 0 ; forEachCounter23800 < forEachSaver23800.values.length ; forEachCounter23800++) {
							var local3_Def_2518 = forEachSaver23800.values[forEachCounter23800];
						{
							...
							forEachSaver23800.values[forEachCounter23800] = local3_Def_2518;
					...
					if (((param9_IgnoreAll) ? 0 : 1)) {
						...
						var forEachSaver23845 = global7_Defines;
						for(var forEachCounter23845 = 0 ; forEachCounter23845 < forEachSaver23845.values.length ; forEachCounter23845++) {
							var local3_Def_2520 = forEachSaver23845.values[forEachCounter23845];
						{
							...
							forEachSaver23845.values[forEachCounter23845] = local3_Def_2520;
...
window['func12_DoTarget_Str'] = function(param8_Name_Str) {
	...
	try {
		...
		var forEachSaver24461 = global10_Generators;
		for(var forEachCounter24461 = 0 ; forEachCounter24461 < forEachSaver24461.values.length ; forEachCounter24461++) {
			var local1_G_2537 = forEachSaver24461.values[forEachCounter24461];
		{
			...
			forEachSaver24461.values[forEachCounter24461] = local1_G_2537;
