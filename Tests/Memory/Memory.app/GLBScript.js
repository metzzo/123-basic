...
var static2_SelNumPlayers_fx_ref = [0], static2_SelNumPlayers_fy_ref = [0], static1_SelNumPlayers_i = 0, static2_SelNumPlayers_mx_ref = [0], static2_SelNumPlayers_my_ref = [0], static2_SelNumPlayers_b1_ref = [0], static2_SelNumPlayers_b2_ref = [0], static3_SelNumPlayers_blk = 0, static5_SelNumPlayers_start = 0;
var __debugInfo = "";
var debugMode = true;
window["main"] = function() {
  ...
  try {
    ...
    var local16___SelectHelper1__597 = 0;
    __debugInfo = "13:Memory.gbas";
    local16___SelectHelper1__597 = global8_hardness;
    __debugInfo = "23:Memory.gbas";
    if(local16___SelectHelper1__597 == 1 ? 1 : 0) {
      __debugInfo = "16:Memory.gbas";
      global9_blocksize = INTEGER(global7_screenx_ref[0] / 4);
      __debugInfo = "16:Memory.gbas"
    }else {
      if(local16___SelectHelper1__597 == 2 ? 1 : 0) {
        __debugInfo = "19:Memory.gbas";
        global9_blocksize = INTEGER(global7_screenx_ref[0] / 5);
        __debugInfo = "19:Memory.gbas"
      }else {
        if(local16___SelectHelper1__597 == 3 ? 1 : 0) {
    ...
    for(local1_i_601 = 1;toCheck(local1_i_601, 4, 1);local1_i_601 += 1) {
      __debugInfo = "29:Memory.gbas";
      LOADSPRITE("p" + CAST2STRING(local1_i_601) + ".bmp", ~~(49 + local1_i_601));
      __debugInfo = "29:Memory.gbas"
    }
...
window["GLB_ON_LOOP"] = function() {
  ...
  try {
    ...
    func9_MakeLevel(global4_feld, INTEGER(global7_screenx_ref[0] / global9_blocksize), INTEGER(global7_screeny_ref[0] / global9_blocksize));
    __debugInfo = "80:Memory.gbas";
    global4_save = global4_feld.clone();
    __debugInfo = "83:Memory.gbas";
    DIM(unref(global5_Click), [2, 2], 0);
    __debugInfo = "84:Memory.gbas";
    DIM(unref(global5_score), [~~global11_num_players], 0);
    __debugInfo = "84:Memory.gbas";
...
window["MainGame"] = function() {
  ...
  try {
    ...
    if(global10_gridCreate ? 0 : 1) {
      ...
      for(local1_i_610 = 0;toCheck(local1_i_610, 13, 1);local1_i_610 += 1) {
        __debugInfo = "101:Memory.gbas";
        STRETCHSPRITE(14, -local1_i_610 * global9_blocksize, 0, 14 * global9_blocksize, unref(global9_blocksize));
        __debugInfo = "103:Memory.gbas";
        GRABSPRITE(unref(~~local1_i_610), 0, 0, unref(~~global9_blocksize), unref(~~global9_blocksize));
        __debugInfo = "101:Memory.gbas"
      }
      ...
      if(global6_winner == 0 ? 1 : 0) {
        ...
        func9_ShowLevel(global4_feld, global5_Click);
        __debugInfo = "112:Memory.gbas";
        ALPHAMODE(-0.75);
        __debugInfo = "122:Memory.gbas";
        for(local1_i_611 = 1;toCheck(local1_i_611, global11_num_players, 1);local1_i_611 += 1) {
          __debugInfo = "117:Memory.gbas";
          if((local1_i_611 != global10_cur_player + 1 ? 1 : 0) || (MOD(GETTIMERALL(), 1E3) < 500 ? 1 : 0) ? 1 : 0) {
            __debugInfo = "116:Memory.gbas";
            STRETCHSPRITE(~~(local1_i_611 + 49), global9_blocksize * (local1_i_611 - 0.25), 3, global9_blocksize * 0.5, global9_blocksize * 0.5);
            __debugInfo = "116:Memory.gbas"
          }
          __debugInfo = "120:Memory.gbas";
          DRAWRECT((local1_i_611 - 0.5) * global9_blocksize - 1, global9_blocksize * 0.5 - 1, global5_score.arrAccess(~~(local1_i_611 - 1)).values[tmpPositionCache] * global10_scorescale + 2, 5, RGB(0, 0, 0));
          __debugInfo = "121:Memory.gbas";
          STRETCHSPRITE(~~(local1_i_611 + 49), (local1_i_611 - 0.5) * global9_blocksize, global9_blocksize * 0.5, global5_score.arrAccess(~~(local1_i_611 - 1)).values[tmpPositionCache] * global10_scorescale, 3);
          __debugInfo = "117:Memory.gbas"
        }
        ...
        if(global8_PocketPC == 0 ? 1 : 0) {
          __debugInfo = "125:Memory.gbas";
          func7_Pointer(global2_mx_ref, global2_my_ref);
          __debugInfo = "125:Memory.gbas"
        }
        ...
        if(global2_b1_ref[0] && global8_released ? 1 : 0) {
          ...
          if(global6_turned < 2 ? 1 : 0) {
            __debugInfo = "131:Memory.gbas";
            global4_good = func4_Flip(global4_feld, global2_mx_ref[0] / global9_blocksize, global2_my_ref[0] / global9_blocksize);
            __debugInfo = "131:Memory.gbas"
          }
          ...
          if(global4_good || ((global4_good == 0 ? 1 : 0) && (global6_turned == 2 ? 1 : 0) ? 1 : 0) ? 1 : 0) {
            ...
            if(global6_turned < 2 ? 1 : 0) {
              ...
              PLAYSOUND(unref(~~global4_feld.arrAccess(~~global5_Click.arrAccess(~~global6_turned, 0).values[tmpPositionCache], ~~global5_Click.arrAccess(~~global6_turned, 1).values[tmpPositionCache]).values[tmpPositionCache]), 0, 1);
              __debugInfo = "135:Memory.gbas"
            }
            ...
            if(global6_turned == 3 ? 1 : 0) {
              ...
              if(global4_feld.arrAccess(~~global5_Click.arrAccess(0, 0).values[tmpPositionCache], ~~global5_Click.arrAccess(0, 1).values[tmpPositionCache]).values[tmpPositionCache] == global4_feld.arrAccess(~~global5_Click.arrAccess(1, 0).values[tmpPositionCache], ~~global5_Click.arrAccess(1, 1).values[tmpPositionCache]).values[tmpPositionCache] ? 1 : 0) {
                ...
                global6_winner = func11_WhoIsWinner(global4_feld, global5_score);
                __debugInfo = "145:Memory.gbas"
              }else {
                __debugInfo = "152:Memory.gbas";
                PLAYSOUND(20, 0, 1);
                __debugInfo = "153:Memory.gbas";
                global10_cur_player = MOD(~~(global10_cur_player + 1), unref(~~global11_num_players));
                __debugInfo = "154:Memory.gbas";
                global4_feld = global4_save.clone();
                __debugInfo = "152:Memory.gbas"
              }
...
window["func9_MakeLevel"] = function(param4_feld, param2_sx, param2_sy) {
  ...
  try {
    param4_feld = unref(param4_feld);
    param2_sx = unref(param2_sx);
    param2_sy = unref(param2_sy);
    var local3_num_618 = 0, local4_tile_619 = 0, local1_x_620 = 0, local1_y_621 = 0;
    __debugInfo = "180:Memory.gbas";
    DIM(unref(param4_feld), [~~param2_sx, ~~param2_sy], 0);
    __debugInfo = "185:Memory.gbas";
    for(local1_x_620 = 0;toCheck(local1_x_620, param2_sx - 1, 1);local1_x_620 += 1) {
      __debugInfo = "184:Memory.gbas";
      for(local1_y_621 = 0;toCheck(local1_y_621, param2_sy - 1, 1);local1_y_621 += 1) {
        __debugInfo = "183:Memory.gbas";
        param4_feld.arrAccess(~~local1_x_620, ~~local1_y_621).values[tmpPositionCache] = -1;
        __debugInfo = "183:Memory.gbas"
      }
      __debugInfo = "184:Memory.gbas"
    }
    ...
    for(local3_num_618 = 1;toCheck(local3_num_618, param2_sx * param2_sy / 2, 1);local3_num_618 += 1) {
      __debugInfo = "194:Memory.gbas";
      for(local4_tile_619 = 0;toCheck(local4_tile_619, 1, 1);local4_tile_619 += 1) {
        __debugInfo = "192:Memory.gbas";
        while(param4_feld.arrAccess(~~local1_x_620, ~~local1_y_621).values[tmpPositionCache] != -1 ? 1 : 0) {
          __debugInfo = "190:Memory.gbas";
          local1_x_620 = RND(param2_sx - 1);
          __debugInfo = "191:Memory.gbas";
          local1_y_621 = RND(param2_sy - 1);
          __debugInfo = "190:Memory.gbas"
        }
        __debugInfo = "193:Memory.gbas";
        param4_feld.arrAccess(~~local1_x_620, ~~local1_y_621).values[tmpPositionCache] = MOD(unref(~~local3_num_618), 13) + 100;
        __debugInfo = "192:Memory.gbas"
      }
      __debugInfo = "194:Memory.gbas"
    }
...
window["func9_ShowLevel"] = function(param4_feld, param5_Click) {
  ...
  try {
    param4_feld = unref(param4_feld);
    param5_Click = unref(param5_Click);
    var local1_x_624 = 0, local1_y_625 = 0, local3_num_626 = 0, local1_c_627 = 0;
    __debugInfo = "219:Memory.gbas";
    for(local1_x_624 = 0;toCheck(local1_x_624, BOUNDS(param4_feld, 0) - 1, 1);local1_x_624 += 1) {
      __debugInfo = "218:Memory.gbas";
      for(local1_y_625 = 0;toCheck(local1_y_625, BOUNDS(param4_feld, 1) - 1, 1);local1_y_625 += 1) {
        __debugInfo = "206:Memory.gbas";
        local3_num_626 = param4_feld.arrAccess(~~local1_x_624, ~~local1_y_625).values[tmpPositionCache];
        __debugInfo = "207:Memory.gbas";
        if(local3_num_626 >= 100 ? 1 : 0) {
          __debugInfo = "207:Memory.gbas";
          local3_num_626 = 13;
          __debugInfo = "207:Memory.gbas"
        }
        __debugInfo = "217:Memory.gbas";
        if(local3_num_626 >= 0 ? 1 : 0) {
          __debugInfo = "209:Memory.gbas";
          DRAWSPRITE(unref(~~local3_num_626), local1_x_624 * global9_blocksize, local1_y_625 * global9_blocksize);
          __debugInfo = "216:Memory.gbas";
          for(local1_c_627 = 0;toCheck(local1_c_627, 1, 1);local1_c_627 += 1) {
            __debugInfo = "215:Memory.gbas";
            if((param5_Click.arrAccess(~~local1_c_627, 0).values[tmpPositionCache] == local1_x_624 ? 1 : 0) && (param5_Click.arrAccess(~~local1_c_627, 1).values[tmpPositionCache] == local1_y_625 ? 1 : 0) ? 1 : 0) {
              __debugInfo = "212:Memory.gbas";
              ALPHAMODE(ABS(SIN(MOD(GETTIMERALL(), 2E3) / 2E3 * 360 + local1_c_627 * 90)));
...
window["SelNumPlayers"] = function() {
  ...
  try {
    ...
    for(static1_SelNumPlayers_i = 1;toCheck(static1_SelNumPlayers_i, 4, 1);static1_SelNumPlayers_i += 1) {
      ...
      ZOOMSPRITE(~~(static1_SelNumPlayers_i + 49), static1_SelNumPlayers_i * static3_SelNumPlayers_blk * 1.5, unref(static3_SelNumPlayers_blk), static3_SelNumPlayers_blk / global9_blocksize * 1.4, static3_SelNumPlayers_blk / global9_blocksize * 1.4);
      __debugInfo = "245:Memory.gbas";
      PRINT(unref(CAST2STRING(static1_SelNumPlayers_i)), static1_SelNumPlayers_i * static3_SelNumPlayers_blk * 1.5 + static3_SelNumPlayers_blk / 2 - static2_SelNumPlayers_fx_ref[0] / 2, static3_SelNumPlayers_blk * 2.2, 0);
      __debugInfo = "244:Memory.gbas"
    }
    __debugInfo = "250:Memory.gbas";
    if(global8_PocketPC == 0 ? 1 : 0) {
      __debugInfo = "249:Memory.gbas";
      func7_Pointer(static2_SelNumPlayers_mx_ref, static2_SelNumPlayers_my_ref);
      __debugInfo = "249:Memory.gbas"
    }
...
window["func11_WhoIsWinner"] = function(param4_feld, param5_score) {
  ...
  try {
    param4_feld = unref(param4_feld);
    param5_score = unref(param5_score);
    var local1_x_642 = 0, local1_y_643 = 0, local8_maxscore_644 = 0;
    __debugInfo = "297:Memory.gbas";
    for(local1_x_642 = 0;toCheck(local1_x_642, BOUNDS(param4_feld, 0) - 1, 1);local1_x_642 += 1) {
      __debugInfo = "296:Memory.gbas";
      for(local1_y_643 = 0;toCheck(local1_y_643, BOUNDS(param4_feld, 1) - 1, 1);local1_y_643 += 1) {
        __debugInfo = "295:Memory.gbas";
        if(param4_feld.arrAccess(~~local1_x_642, ~~local1_y_643).values[tmpPositionCache] >= 100 ? 1 : 0) {
          __debugInfo = "295:Memory.gbas";
          return tryClone(0);
          __debugInfo = "295:Memory.gbas"
        }
    ...
    local8_maxscore_644 = 0;
    __debugInfo = "299:Memory.gbas";
    local1_y_643 = 0;
    __debugInfo = "305:Memory.gbas";
    for(local1_x_642 = 0;toCheck(local1_x_642, BOUNDS(param5_score, 0) - 1, 1);local1_x_642 += 1) {
      __debugInfo = "304:Memory.gbas";
      if(param5_score.arrAccess(~~local1_x_642).values[tmpPositionCache] > local8_maxscore_644 ? 1 : 0) {
        __debugInfo = "302:Memory.gbas";
        local8_maxscore_644 = param5_score.arrAccess(~~local1_x_642).values[tmpPositionCache];
        __debugInfo = "303:Memory.gbas";
        local1_y_643 = local1_x_642 + 1;
        __debugInfo = "302:Memory.gbas"
      }
      __debugInfo = "304:Memory.gbas"
    }
    __debugInfo = "310:Memory.gbas";
    for(local1_x_642 = 1;toCheck(local1_x_642, global7_screenx_ref[0] / global9_blocksize, (global7_screenx_ref[0] / global9_blocksize - 1) / 150);local1_x_642 += (global7_screenx_ref[0] / global9_blocksize - 1) / 150) {
      __debugInfo = "308:Memory.gbas";
      ROTOZOOMSPRITE(~~(local1_y_643 + 49), (global7_screenx_ref[0] - global9_blocksize) / 2, (global7_screeny_ref[0] - global9_blocksize) / 2, local1_x_642 * 180, unref(local1_x_642));
      __debugInfo = "309:Memory.gbas";
      SHOWSCREEN();
      __debugInfo = "308:Memory.gbas"
    }
    __debugInfo = "312:Memory.gbas";
    return tryClone(unref(local1_y_643));
...
window["func7_Pointer"] = function(param2_px, param2_py) {
  ...
  try {
    ...
    for(local1_i_647 = 20;toCheck(local1_i_647, 70, 1);local1_i_647 += 1) {
      __debugInfo = "327:Memory.gbas";
      DRAWLINE(unref(param2_px), unref(param2_py), param2_px + COS(unref(local1_i_647)) * 16, param2_py + SIN(unref(local1_i_647)) * 16, RGB(180, 200, 255));
      __debugInfo = "327:Memory.gbas"
    }
...
var global10_gridCreate = 0, global7_screenx_ref = [0], global7_screeny_ref = [0], global2_mx_ref = [0], global2_my_ref = [0], global2_b1_ref = [0], global2_b2_ref = [0], global8_hardness = 0, global9_blocksize = 0, global10_device_Str = "", global8_PocketPC = 0, global10_scorescale = 0, global4_feld = new GLBArray, global4_save = new GLBArray, global5_Click = new GLBArray, global11_num_players = 0, global5_score = new GLBArray, global8_released = 0, global6_winner = 0, global10_cur_player = 0, global4_good = 
0, global6_turned = 0;
window["initStatics"] = function() {
  static2_SelNumPlayers_fx_ref = [0], static2_SelNumPlayers_fy_ref = [0], static1_SelNumPlayers_i = 0, static2_SelNumPlayers_mx_ref = [0], static2_SelNumPlayers_my_ref = [0], static2_SelNumPlayers_b1_ref = [0], static2_SelNumPlayers_b2_ref = [0], static3_SelNumPlayers_blk = 0, static5_SelNumPlayers_start = 0
};
