...
window['main'] = function(){
	...
	DIM(global3_hit, [20, 30], 0.0);
	DIM(global2_bx, [100], 0.0);
	DIM(global2_by, [100], 0.0);
	DIM(global5_bdirx, [100], 0.0);
	DIM(global5_bdiry, [100], 0.0);
	DIM(global4_batx, [4], 0.0);
	DIM(global4_baty, [4], 0.0);
	...
	{
		var local1_x_1264 = 0.0;
		for (local1_x_1264 = 0;toCheck(local1_x_1264, 19, 1);local1_x_1264 += 1) {
			{
				var local1_y_1265 = 0.0;
				for (local1_y_1265 = 0;toCheck(local1_y_1265, 9, 1);local1_y_1265 += 1) {
					global3_hit.arrAccess(~~(local1_x_1264), ~~(local1_y_1265)).values[tmpPositionCache] = ((RND(2)) + (1));
		...
		for (global1_i = 0;toCheck(global1_i, global7_maxball, 1);global1_i += 1) {
			...
			};
			{
				for (global1_j = 0;toCheck(global1_j, global6_maxbat, 1);global1_j += 1) {
					if ((((BOXCOLL(~~(global4_batx.arrAccess(~~(global1_j)).values[tmpPositionCache]), ~~(global4_baty.arrAccess(~~(global1_j)).values[tmpPositionCache]), 128, 16, ~~(global2_xa), ~~(global2_ya), 16, 16)) && ((((global5_bdiry.arrAccess(~~(global1_i)).values[tmpPositionCache]) > (0)) ? 1 : 0))) ? 1 : 0)) {
						global5_swapy = 1;
						global5_swapx = 0;
...
window['ShowAll'] = function() {
	var local1_x_1267 = 0.0, local1_y_1268 = 0.0, local1_f_1269 = 0.0;
	local1_f_1269 = ((global7_screenx_ref[0]) / (640));
	{
		for (local1_x_1267 = 0;toCheck(local1_x_1267, 19, 1);local1_x_1267 += 1) {
			{
				for (local1_y_1268 = 0;toCheck(local1_y_1268, 29, 1);local1_y_1268 += 1) {
					if ((((global3_hit.arrAccess(~~(local1_x_1267), ~~(local1_y_1268)).values[tmpPositionCache]) > (0)) ? 1 : 0)) {
						DRAWRECT(((((local1_x_1267) * (32))) * (local1_f_1269)), ((((local1_y_1268) * (16))) * (local1_f_1269)), ((30) * (local1_f_1269)), ((14) * (local1_f_1269)), ~~(global6_colors.arrAccess(~~(((global3_hit.arrAccess(~~(local1_x_1267), ~~(local1_y_1268)).values[tmpPositionCache]) - (1)))).values[tmpPositionCache]));
	...
	{
		for (local1_x_1267 = 0;toCheck(local1_x_1267, global7_maxball, 1);local1_x_1267 += 1) {
			DRAWRECT(((global2_bx.arrAccess(~~(local1_x_1267)).values[tmpPositionCache]) * (local1_f_1269)), ((global2_by.arrAccess(~~(local1_x_1267)).values[tmpPositionCache]) * (local1_f_1269)), ((16) * (local1_f_1269)), ((16) * (local1_f_1269)), RGB(255, 255, 64));
			
		};
		
	};
	{
		for (local1_x_1267 = 0;toCheck(local1_x_1267, global6_maxbat, 1);local1_x_1267 += 1) {
			DRAWRECT(((global4_batx.arrAccess(~~(local1_x_1267)).values[tmpPositionCache]) * (local1_f_1269)), ((global4_baty.arrAccess(~~(local1_x_1267)).values[tmpPositionCache]) * (local1_f_1269)), ((128) * (local1_f_1269)), ((16) * (local1_f_1269)), RGB(255, 255, 64));
...
window['func8_BallColl'] = function(param3_num) {
	...
	if ((((global2_by.arrAccess(~~(param3_num)).values[tmpPositionCache]) >= (464)) ? 1 : 0)) {
		global5_bdiry.arrAccess(~~(param3_num)).values[tmpPositionCache] = -(ABS(global5_bdiry.arrAccess(~~(param3_num)).values[tmpPositionCache]));
	...
	if ((((global1_h) == (0)) ? 1 : 0)) {
		return tryClone(local5_docol_1271);
...
window['func17_TouchBlockAtPixel'] = function(param1_x, param1_y) {
	var local1_h_1275 = 0.0;
	local1_h_1275 = global3_hit.arrAccess(~~(param1_x), ~~(param1_y)).values[tmpPositionCache];
	if (local1_h_1275) {
