...
window['main'] = function(){
	...
	DIM(global5_coins, [~~(((global5_MAX_X) + (1))), ~~(((global5_MAX_Y) + (1)))], 0.0);
	DIM(global9_winnerpos, [4], 0.0);
	LIMITFPS(30);
	global3_col = 1;
	global3_scx_ref[0] = 0;
	global3_scy_ref[0] = 0;
...
window['GLB_ON_MOUSEWAIT'] = function() {
	if (ANYMOUSE()) {
		END();
...
window['GLB_ON_LOOP'] = function() {
	{
		var local17___SelectHelper11__1272 = 0.0;
		local17___SelectHelper11__1272 = global5_State;
		if ((((local17___SelectHelper11__1272) == (1)) ? 1 : 0)) {
			func6_DoMove(unref(global2_mx_ref[0]), global3_col);
			if (func11_CheckWinner(global3_col, unref(global9_winnerpos))) {
				{
					for (global2_mx_ref[0] = MIN(global9_winnerpos.arrAccess(0).values[tmpPositionCache], global9_winnerpos.arrAccess(2).values[tmpPositionCache]);toCheck(global2_mx_ref[0], MAX(global9_winnerpos.arrAccess(0).values[tmpPositionCache], global9_winnerpos.arrAccess(2).values[tmpPositionCache]), 1);global2_mx_ref[0] += 1) {
						{
							var local2_my_1274 = 0.0;
							for (local2_my_1274 = MIN(global9_winnerpos.arrAccess(1).values[tmpPositionCache], global9_winnerpos.arrAccess(3).values[tmpPositionCache]);toCheck(local2_my_1274, MAX(global9_winnerpos.arrAccess(1).values[tmpPositionCache], global9_winnerpos.arrAccess(3).values[tmpPositionCache]), 1);local2_my_1274 += 1) {
								global5_coins.arrAccess(~~(global2_mx_ref[0]), ~~(local2_my_1274)).values[tmpPositionCache] = 3;
				...
				func9_ShowField(unref(global3_scx_ref[0]), unref(global3_scy_ref[0]));
		...
		} else if ((((local17___SelectHelper11__1272) == (2)) ? 1 : 0)) {
			MOUSESTATE(global2_mx_ref, global2_my_ref, global2_b1_ref, global2_b2_ref);
			if (((((((global2_b1_ref[0]) == (0)) ? 1 : 0)) && (((global3_was) ? 0 : 1))) ? 1 : 0)) {
				func9_ShowField(unref(global3_scx_ref[0]), unref(global3_scy_ref[0]));
				...
				PRINT(CAST2STRING(func7_RatePos(unref(global2_mx_ref[0]), unref(global2_my_ref[0]), global3_col)), 0, 300, 0);
				SHOWSCREEN();
				HIBERNATE();
		...
		} else if ((((local17___SelectHelper11__1272) == (3)) ? 1 : 0)) {
			if ((((global3_col) == (1)) ? 1 : 0)) {
				global5_State = 2;
...
window['func9_ShowField'] = function(param2_wx, param2_wy) {
	var local1_x_1279 = 0.0, local1_y_1280 = 0.0, local3_col_1281 = new GLBArray(), local2_dx_1282 = 0.0, local2_dy_1283 = 0.0;
	DIM(local3_col_1281, [4], 0.0);
	local3_col_1281.arrAccess(1).values[tmpPositionCache] = RGB(0, 255, 128);
	local3_col_1281.arrAccess(2).values[tmpPositionCache] = RGB(128, 128, 255);
	local3_col_1281.arrAccess(3).values[tmpPositionCache] = RGB(255, 255, 64);
	param2_wx = ((param2_wx) / (((global5_MAX_X) + (1))));
	param2_wy = ((param2_wy) / (((global5_MAX_Y) + (1))));
	{
		for (local1_x_1279 = 0;toCheck(local1_x_1279, global5_MAX_X, 1);local1_x_1279 += 1) {
			{
				for (local1_y_1280 = 0;toCheck(local1_y_1280, global5_MAX_Y, 1);local1_y_1280 += 1) {
					local2_dx_1282 = ((local1_x_1279) * (param2_wx));
					local2_dy_1283 = ((local1_y_1280) * (param2_wy));
					DRAWRECT(local2_dx_1282, local2_dy_1283, param2_wx, param2_wy, RGB(255, 255, 255));
					DRAWRECT(((local2_dx_1282) + (1)), ((local2_dy_1283) + (1)), ((param2_wx) - (2)), ((param2_wy) - (2)), ~~(local3_col_1281.arrAccess(~~(global5_coins.arrAccess(~~(local1_x_1279), ~~(local1_y_1280)).values[tmpPositionCache])).values[tmpPositionCache]));
...
window['func6_DoMove'] = function(param4_xpos, param5_color) {
	var local1_y_1286 = 0.0;
	{
		for (local1_y_1286 = global5_MAX_Y;toCheck(local1_y_1286, 0, -(1));local1_y_1286 += -(1)) {
			if ((((global5_coins.arrAccess(~~(param4_xpos), ~~(local1_y_1286)).values[tmpPositionCache]) == (0)) ? 1 : 0)) {
				global5_coins.arrAccess(~~(param4_xpos), ~~(local1_y_1286)).values[tmpPositionCache] = param5_color;
				return tryClone(local1_y_1286);
...
window['func8_UnDoMove'] = function(param4_xpos) {
	var local1_y_1335 = 0.0;
	{
		for (local1_y_1335 = 0;toCheck(local1_y_1335, global5_MAX_Y, 1);local1_y_1335 += 1) {
			if ((((global5_coins.arrAccess(~~(param4_xpos), ~~(local1_y_1335)).values[tmpPositionCache]) != (0)) ? 1 : 0)) {
				global5_coins.arrAccess(~~(param4_xpos), ~~(local1_y_1335)).values[tmpPositionCache] = 0;
				return tryClone(1);
...
window['func10_OtherColor'] = function(param3_col) {
	if ((((param3_col) == (1)) ? 1 : 0)) {
		return tryClone(2);
...
window['func7_CanMove'] = function() {
	var local1_x_1336 = 0.0;
	{
		for (local1_x_1336 = 0;toCheck(local1_x_1336, global5_MAX_X, 1);local1_x_1336 += 1) {
			if ((((global5_coins.arrAccess(~~(local1_x_1336), 1).values[tmpPositionCache]) == (0)) ? 1 : 0)) {
				return tryClone(1);
...
window['func11_CheckWinner'] = function(param3_col, param6_winpos) {
	var __labels = {"__DrawFrames__": 3449, "skip": 2185};
	
	var local1_x_1290 = 0.0, local1_y_1291 = 0.0, local1_l_1292 = 0.0;
	var __pc = 1871;
	while(__pc >= 0) {
		switch(__pc) {
			case 1871:
			...
			case 1875: //dummy for1
				if (!toCheck(local1_x_1290, global5_MAX_X, 1)) {__pc = 1878; break;}
			...
			case 1884: //dummy for1
				if (!toCheck(local1_y_1291, global5_MAX_Y, 1)) {__pc = 1887; break;}
				
				case 1900:
					if (!((((global5_coins.arrAccess(~~(local1_x_1290), ~~(local1_y_1291)).values[tmpPositionCache]) != (param3_col)) ? 1 : 0))) { __pc = 1897; break; }
			...
			case 1897: //dummy jumper1
				;
					
				param6_winpos.arrAccess(0).values[tmpPositionCache] = local1_x_1290;
				param6_winpos.arrAccess(1).values[tmpPositionCache] = local1_y_1291;
				case 2048:
					if (!((((local1_x_1290) < (((global5_MAX_X) - (2)))) ? 1 : 0))) { __pc = 1917; break; }
				
				case 1972:
					if (!((((((((((global5_coins.arrAccess(~~(((local1_x_1290) + (1))), ~~(local1_y_1291)).values[tmpPositionCache]) == (param3_col)) ? 1 : 0)) && ((((global5_coins.arrAccess(~~(((local1_x_1290) + (2))), ~~(local1_y_1291)).values[tmpPositionCache]) == (param3_col)) ? 1 : 0))) ? 1 : 0)) && ((((global5_coins.arrAccess(~~(((local1_x_1290) + (3))), ~~(local1_y_1291)).values[tmpPositionCache]) == (param3_col)) ? 1 : 0))) ? 1 : 0))) { __pc = 1954; break; }
				
				case 1963:
					param6_winpos.arrAccess(2).values[tmpPositionCache] = ((local1_x_1290) + (3));
					
				param6_winpos.arrAccess(3).values[tmpPositionCache] = local1_y_1291;
				return tryClone(1);
				
				
			case 1954: //dummy jumper1
				;
					
				case 2047:
					if (!((((local1_y_1291) < (((global5_MAX_Y) - (2)))) ? 1 : 0))) { __pc = 1979; break; }
				
				case 2046:
					if (!((((((((((global5_coins.arrAccess(~~(((local1_x_1290) + (1))), ~~(((local1_y_1291) + (1)))).values[tmpPositionCache]) == (param3_col)) ? 1 : 0)) && ((((global5_coins.arrAccess(~~(((local1_x_1290) + (2))), ~~(((local1_y_1291) + (2)))).values[tmpPositionCache]) == (param3_col)) ? 1 : 0))) ? 1 : 0)) && ((((global5_coins.arrAccess(~~(((local1_x_1290) + (3))), ~~(((local1_y_1291) + (3)))).values[tmpPositionCache]) == (param3_col)) ? 1 : 0))) ? 1 : 0))) { __pc = 2025; break; }
				
				case 2034:
					param6_winpos.arrAccess(2).values[tmpPositionCache] = ((local1_x_1290) + (3));
					
				param6_winpos.arrAccess(3).values[tmpPositionCache] = ((local1_y_1291) + (3));
				return tryClone(1);
				
				
			case 2025: //dummy jumper1
				;
					
				
				
			case 1979: //dummy jumper1
				;
					
				
				
			case 1917: //dummy jumper1
				;
					
				case 2184:
					if (!((((local1_y_1291) < (((global5_MAX_Y) - (2)))) ? 1 : 0))) { __pc = 2055; break; }
				
				case 2110:
					if (!((((((((((global5_coins.arrAccess(~~(local1_x_1290), ~~(((local1_y_1291) + (1)))).values[tmpPositionCache]) == (param3_col)) ? 1 : 0)) && ((((global5_coins.arrAccess(~~(local1_x_1290), ~~(((local1_y_1291) + (2)))).values[tmpPositionCache]) == (param3_col)) ? 1 : 0))) ? 1 : 0)) && ((((global5_coins.arrAccess(~~(local1_x_1290), ~~(((local1_y_1291) + (3)))).values[tmpPositionCache]) == (param3_col)) ? 1 : 0))) ? 1 : 0))) { __pc = 2092; break; }
				
				case 2098:
					param6_winpos.arrAccess(2).values[tmpPositionCache] = local1_x_1290;
					
				param6_winpos.arrAccess(3).values[tmpPositionCache] = ((local1_y_1291) + (3));
				return tryClone(1);
				
				
			case 2092: //dummy jumper1
				;
					
				case 2183:
					if (!((((local1_x_1290) > (3)) ? 1 : 0))) { __pc = 2115; break; }
				
				case 2182:
					if (!((((((((((global5_coins.arrAccess(~~(((local1_x_1290) - (1))), ~~(((local1_y_1291) + (1)))).values[tmpPositionCache]) == (param3_col)) ? 1 : 0)) && ((((global5_coins.arrAccess(~~(((local1_x_1290) - (2))), ~~(((local1_y_1291) + (2)))).values[tmpPositionCache]) == (param3_col)) ? 1 : 0))) ? 1 : 0)) && ((((global5_coins.arrAccess(~~(((local1_x_1290) - (3))), ~~(((local1_y_1291) + (3)))).values[tmpPositionCache]) == (param3_col)) ? 1 : 0))) ? 1 : 0))) { __pc = 2161; break; }
			...
			case 2161: //dummy jumper1
				;
					
				
				
			case 2115: //dummy jumper1
				;
					
				
				
			case 2055: //dummy jumper1
				;
...
window['func5_GetAt'] = function(param1_x, param1_y) {
	if (((((((((((((param1_x) < (0)) ? 1 : 0)) || ((((param1_y) < (0)) ? 1 : 0))) ? 1 : 0)) || ((((param1_x) > (global5_MAX_X)) ? 1 : 0))) ? 1 : 0)) || ((((param1_y) > (global5_MAX_Y)) ? 1 : 0))) ? 1 : 0)) {
		return tryClone(-(1));
		
	};
	return tryClone(global5_coins.arrAccess(~~(param1_x), ~~(param1_y)).values[tmpPositionCache]);
	return 0;
	
};
window['func7_RatePos'] = function(param1_x, param1_y, param5_color) {
	var local1_c_1296 = 0.0, local4_mode_1297 = 0.0, local1_i_1298 = 0.0, local2_dx_1299 = 0.0, local2_dy_1300 = 0.0, local7_allgood_1301 = 0.0, local4_good_1302 = 0.0, local8_possible_1303 = 0.0, local9_activepos_1304 = 0.0, local9_activeneg_1305 = 0.0;
	{
		for (local4_mode_1297 = 0;toCheck(local4_mode_1297, 3, 1);local4_mode_1297 += 1) {
			{
				var local17___SelectHelper12__1306 = 0.0;
				local17___SelectHelper12__1306 = local4_mode_1297;
				if ((((local17___SelectHelper12__1306) == (0)) ? 1 : 0)) {
					local2_dx_1299 = 1;
					local2_dy_1300 = 0;
					
				} else if ((((local17___SelectHelper12__1306) == (1)) ? 1 : 0)) {
					local2_dx_1299 = 0;
					local2_dy_1300 = 1;
					
				} else if ((((local17___SelectHelper12__1306) == (2)) ? 1 : 0)) {
					local2_dx_1299 = 1;
					local2_dy_1300 = -(1);
					
				} else if ((((local17___SelectHelper12__1306) == (3)) ? 1 : 0)) {
					local2_dx_1299 = 1;
					local2_dy_1300 = 1;
			...
			local8_possible_1303 = 1;
			local4_good_1302 = 1;
			local9_activepos_1304 = 1;
			local9_activeneg_1305 = 1;
			{
				for (local1_i_1298 = 1;toCheck(local1_i_1298, 3, 1);local1_i_1298 += 1) {
					local1_c_1296 = func5_GetAt(((param1_x) + (((local1_i_1298) * (local2_dx_1299)))), ((param1_y) + (((local1_i_1298) * (local2_dy_1300)))));
					if (local9_activepos_1304) {
						if ((((local1_c_1296) == (param5_color)) ? 1 : 0)) {
							local4_good_1302 = ((local4_good_1302) + (1));
							local8_possible_1303 = ((local8_possible_1303) + (1));
							
						} else {
							if ((((local1_c_1296) == (0)) ? 1 : 0)) {
								local8_possible_1303 = ((local8_possible_1303) + (1));
								
							} else {
								local9_activepos_1304 = 0;
			...
			if ((((local8_possible_1303) < (4)) ? 1 : 0)) {
				local4_good_1302 = 1;
				
			};
			if ((((local4_good_1302) > (3)) ? 1 : 0)) {
				return tryClone(10000);
				
			};
			local7_allgood_1301 = ((local7_allgood_1301) + (local4_good_1302));
			
		};
		
	};
	return tryClone(local7_allgood_1301);
	return 0;
	
};
window['func8_RateMove'] = function(param4_xpos, param5_color, param5_depth, param8_solution) {
	var local4_ypos_1333 = 0.0;
	if (((((((param5_depth) > (2)) ? 1 : 0)) || ((((param8_solution.arrAccess(~~(param5_color)).values[tmpPositionCache]) >= (10000)) ? 1 : 0))) ? 1 : 0)) {
		return 0;
		
	};
	local4_ypos_1333 = func6_DoMove(param4_xpos, param5_color);
	if ((((local4_ypos_1333) < (0)) ? 1 : 0)) {
		if (func7_CanMove()) {
			return 0;
			
		};
		return tryClone(param5_depth);
		
	};
	param8_solution.arrAccess(~~(param5_color)).values[tmpPositionCache] = MAX(param8_solution.arrAccess(~~(param5_color)).values[tmpPositionCache], func7_RatePos(param4_xpos, local4_ypos_1333, param5_color));
	param8_solution.arrAccess(~~(param5_color)).values[tmpPositionCache] = MAX(param8_solution.arrAccess(~~(param5_color)).values[tmpPositionCache], func7_RatePos(param4_xpos, local4_ypos_1333, func10_OtherColor(param5_color)));
	if ((((param8_solution.arrAccess(~~(param5_color)).values[tmpPositionCache]) < (10000)) ? 1 : 0)) {
		func8_RateMove(func7_GetBest(func10_OtherColor(param5_color), ((param5_depth) + (1))), func10_OtherColor(param5_color), ((param5_depth) + (1)), unref(param8_solution));
...
window['func7_GetBest'] = function(param5_color, param5_depth) {
	var local5_bestx_1309 = 0.0, local8_bestrate_1310 = 0.0, local5_ratex_1311 = 0.0, local1_i_1312 = 0.0, local1_x_1313 = 0.0, local8_solution_1314 = new GLBArray();
	DIM(local8_solution_1314, [3], 0.0);
	local5_bestx_1309 = -(1);
	local8_bestrate_1310 = 0;
	if ((((RND(100)) > (((global8_strength) * (100)))) ? 1 : 0)) {
		return tryClone(RND(global5_MAX_X));
		
	};
	{
		for (local1_i_1312 = 0;toCheck(local1_i_1312, global5_MAX_X, 1);local1_i_1312 += 1) {
			local8_solution_1314.arrAccess(~~(param5_color)).values[tmpPositionCache] = 0;
			local8_solution_1314.arrAccess(~~(func10_OtherColor(param5_color))).values[tmpPositionCache] = 0;
			local1_x_1313 = MOD(INTEGER(((((((((((1) - (((MOD(~~(((local1_i_1312) + (1))), 2)) * (2))))) * (local1_i_1312))) / (2))) + (MOD(~~(local1_i_1312), 2)))) + (((((global5_MAX_X) + (MOD(~~(global5_MAX_X), 2)))) / (2))))), ~~(((global5_MAX_X) + (1))));
			if ((((global5_coins.arrAccess(~~(local1_x_1313), 0).values[tmpPositionCache]) == (0)) ? 1 : 0)) {
				func8_RateMove(local1_x_1313, param5_color, param5_depth, unref(local8_solution_1314));
				if ((((local8_solution_1314.arrAccess(~~(param5_color)).values[tmpPositionCache]) >= (10000)) ? 1 : 0)) {
					local8_solution_1314.arrAccess(~~(func10_OtherColor(param5_color))).values[tmpPositionCache] = 1;
					
				};
				local5_ratex_1311 = ((local8_solution_1314.arrAccess(~~(param5_color)).values[tmpPositionCache]) / (local8_solution_1314.arrAccess(~~(func10_OtherColor(param5_color))).values[tmpPositionCache]));
				if ((((local5_ratex_1311) > (local8_bestrate_1310)) ? 1 : 0)) {
					local8_bestrate_1310 = local5_ratex_1311;
					local5_bestx_1309 = local1_x_1313;
					
				};
				func8_RateMove(local1_x_1313, func10_OtherColor(param5_color), param5_depth, unref(local8_solution_1314));
				if ((((local8_solution_1314.arrAccess(~~(func10_OtherColor(param5_color))).values[tmpPositionCache]) > (10000)) ? 1 : 0)) {
					local5_bestx_1309 = local1_x_1313;
					local8_bestrate_1310 = local8_solution_1314.arrAccess(~~(func10_OtherColor(param5_color))).values[tmpPositionCache];
	...
	if ((((local5_bestx_1309) < (0)) ? 1 : 0)) {
		local5_bestx_1309 = RND(global5_MAX_X);
		
	};
	return tryClone(local5_bestx_1309);
	return 0;
	
};
window['func6_MsgBox'] = function(param8_text_Str) {
	var local2_fx_ref_1316 = [0.0], local2_fy_ref_1317 = [0.0], local2_px_1318 = 0.0, local2_py_1319 = 0.0;
	GETFONTSIZE(local2_fx_ref_1316, local2_fy_ref_1317);
	local2_px_1318 = ((((global3_scx_ref[0]) - (((local2_fx_ref_1316[0]) * ((param8_text_Str).length))))) / (2));
	local2_py_1319 = ((global3_scy_ref[0]) / (4));
	local2_fx_ref_1316[0] = (((param8_text_Str).length) * (local2_fx_ref_1316[0]));
	DRAWRECT(((local2_px_1318) - (4)), ((local2_py_1319) - (4)), ((local2_fx_ref_1316[0]) + (8)), ((local2_fy_ref_1317[0]) + (8)), RGB(255, 255, 255));
	DRAWRECT(((local2_px_1318) - (1)), ((local2_py_1319) - (1)), ((local2_fx_ref_1316[0]) + (2)), ((local2_fy_ref_1317[0]) + (2)), RGB(0, 0, 0));
	PRINT(param8_text_Str, local2_px_1318, local2_py_1319, 0);
	return 0;
