...
window['main'] = function(){
	...
	try {
		__debugInfo = "9:\OneMore.gbas";
		DIM(global9_playfield, [10, 10], 0.0);
		__debugInfo = "11:\OneMore.gbas";
		global5_level = 0;
		__debugInfo = "9:\OneMore.gbas";
	} catch(ex) {
...
window['GLB_ON_LOOP'] = function() {
	...
	try {
		__debugInfo = "18:\OneMore.gbas";
		if (func15_IsLevelComplete()) {
			__debugInfo = "16:\OneMore.gbas";
			NewLevel();
			__debugInfo = "17:\OneMore.gbas";
			global9_mousefree = 0;
			__debugInfo = "16:\OneMore.gbas";
		};
		__debugInfo = "20:\OneMore.gbas";
		MOUSESTATE(global2_mx_ref, global2_my_ref, global2_b1_ref, global2_b2_ref);
		__debugInfo = "26:\OneMore.gbas";
		if (global2_b1_ref[0]) {
			__debugInfo = "22:\OneMore.gbas";
			if (global9_mousefree) {
				__debugInfo = "22:\OneMore.gbas";
				func5_Click(((global2_mx_ref[0]) / (32)), ((global2_my_ref[0]) / (32)));
				__debugInfo = "22:\OneMore.gbas";
			};
			__debugInfo = "23:\OneMore.gbas";
			global9_mousefree = 0;
			__debugInfo = "22:\OneMore.gbas";
		} else {
			__debugInfo = "25:\OneMore.gbas";
			global9_mousefree = 1;
			__debugInfo = "25:\OneMore.gbas";
		};
		__debugInfo = "28:\OneMore.gbas";
		ShowPlayfield();
		__debugInfo = "29:\OneMore.gbas";
		PRINT("<=", unref(global2_mx_ref[0]), ((global2_my_ref[0]) - (8)), 0);
		__debugInfo = "30:\OneMore.gbas";
		SHOWSCREEN();
		__debugInfo = "18:\OneMore.gbas";
	} catch(ex) {
		if (isKnownException(ex)) throw ex;
...
window['ShowPlayfield'] = function() {
	stackPush("sub: ShowPlayfield", __debugInfo);
	try {
		var local1_x_1249 = 0.0, local1_y_1250 = 0.0, local5_color_1251 = new GLBArray(0.0);
		__debugInfo = "40:\OneMore.gbas";
		DIMDATA(local5_color_1251, [RGB(50, 50, 255), RGB(50, 255, 50)]);
		__debugInfo = "42:\OneMore.gbas";
		DRAWRECT(0, 0, 320, 320, RGB(255, 255, 255));
		__debugInfo = "42:\OneMore.gbas";
		{
			__debugInfo = "47:\OneMore.gbas";
			for (local1_x_1249 = 0;toCheck(local1_x_1249, 9, 1);local1_x_1249 += 1) {
				__debugInfo = "43:\OneMore.gbas";
				{
					__debugInfo = "46:\OneMore.gbas";
					for (local1_y_1250 = 0;toCheck(local1_y_1250, 9, 1);local1_y_1250 += 1) {
						__debugInfo = "45:\OneMore.gbas";
						DRAWRECT(((((local1_x_1249) * (32))) + (1)), ((((local1_y_1250) * (32))) + (1)), 30, 30, ~~(local5_color_1251.arrAccess(~~(global9_playfield.arrAccess(~~(local1_x_1249), ~~(local1_y_1250)).values[tmpPositionCache])).values[tmpPositionCache]));
						__debugInfo = "45:\OneMore.gbas";
					};
					__debugInfo = "46:\OneMore.gbas";
				};
		...
		__debugInfo = "48:\OneMore.gbas";
		PRINT((("Clicks: ") + (CAST2STRING(global6_clicks))), 360, 120, 0);
		__debugInfo = "49:\OneMore.gbas";
		PRINT((("Level:  ") + (CAST2STRING(global5_level))), 360, 160, 0);
		__debugInfo = "40:\OneMore.gbas";
	} catch(ex) {
		if (isKnownException(ex)) throw ex;
		alert(formatError(ex));
...
window['func5_Click'] = function(param1_x, param1_y) {
	stackPush("function: Click", __debugInfo);
	try {
		__debugInfo = "59:\OneMore.gbas";
		global6_clicks = ((global6_clicks) + (1));
		__debugInfo = "60:\OneMore.gbas";
		func6_Change(((param1_x) - (1)), param1_y);
		__debugInfo = "61:\OneMore.gbas";
		func6_Change(((param1_x) + (1)), param1_y);
		__debugInfo = "62:\OneMore.gbas";
		func6_Change(param1_x, param1_y);
		__debugInfo = "63:\OneMore.gbas";
		func6_Change(param1_x, ((param1_y) - (1)));
		__debugInfo = "64:\OneMore.gbas";
		func6_Change(param1_x, ((param1_y) + (1)));
		__debugInfo = "65:\OneMore.gbas";
		return 0;
		__debugInfo = "59:\OneMore.gbas";
	} catch(ex) {
		if (isKnownException(ex)) throw ex;
...
window['func6_Change'] = function(param1_x, param1_y) {
	stackPush("function: Change", __debugInfo);
	try {
		__debugInfo = "85:\OneMore.gbas";
		if (((((((((((((param1_x) >= (0)) ? 1 : 0)) && ((((param1_x) < (10)) ? 1 : 0))) ? 1 : 0)) && ((((param1_y) >= (0)) ? 1 : 0))) ? 1 : 0)) && ((((param1_y) < (10)) ? 1 : 0))) ? 1 : 0)) {
			__debugInfo = "75:\OneMore.gbas";
			global3_set = global9_playfield.arrAccess(~~(param1_x), ~~(param1_y)).values[tmpPositionCache];
			__debugInfo = "81:\OneMore.gbas";
			if ((((global3_set) == (1)) ? 1 : 0)) {
				__debugInfo = "78:\OneMore.gbas";
				global3_set = 0;
				__debugInfo = "78:\OneMore.gbas";
			} else {
				__debugInfo = "80:\OneMore.gbas";
				global3_set = 1;
				__debugInfo = "80:\OneMore.gbas";
			};
			__debugInfo = "84:\OneMore.gbas";
			global9_playfield.arrAccess(~~(param1_x), ~~(param1_y)).values[tmpPositionCache] = global3_set;
			__debugInfo = "75:\OneMore.gbas";
		};
		__debugInfo = "86:\OneMore.gbas";
		return 0;
		__debugInfo = "85:\OneMore.gbas";
	} catch(ex) {
		if (isKnownException(ex)) throw ex;
...
window['NewLevel'] = function() {
	...
	try {
		var local1_x_1258 = 0.0, local1_y_1259 = 0.0, local1_i_1260 = 0.0;
		__debugInfo = "95:\OneMore.gbas";
		{
			__debugInfo = "100:\OneMore.gbas";
			for (local1_x_1258 = 0;toCheck(local1_x_1258, 9, 1);local1_x_1258 += 1) {
				__debugInfo = "96:\OneMore.gbas";
				{
					__debugInfo = "99:\OneMore.gbas";
					for (local1_y_1259 = 0;toCheck(local1_y_1259, 9, 1);local1_y_1259 += 1) {
						__debugInfo = "98:\OneMore.gbas";
						global9_playfield.arrAccess(~~(local1_x_1258), ~~(local1_y_1259)).values[tmpPositionCache] = 0;
						__debugInfo = "98:\OneMore.gbas";
					};
					__debugInfo = "99:\OneMore.gbas";
				};
		...
		__debugInfo = "102:\OneMore.gbas";
		global5_level = ((global5_level) + (1));
		__debugInfo = "104:\OneMore.gbas";
		{
			__debugInfo = "107:\OneMore.gbas";
			for (local1_i_1260 = 0;toCheck(local1_i_1260, global5_level, 1);local1_i_1260 += 1) {
				__debugInfo = "106:\OneMore.gbas";
				func5_Click(RND(9), RND(9));
				__debugInfo = "106:\OneMore.gbas";
			};
			__debugInfo = "107:\OneMore.gbas";
		};
		__debugInfo = "108:\OneMore.gbas";
		global6_clicks = 0;
		__debugInfo = "109:\OneMore.gbas";
		ShowPlayfield();
		__debugInfo = "110:\OneMore.gbas";
		PRINT((((("Level: ") + (CAST2STRING(global5_level)))) + (" - get ready")), 0, 360, 0);
		__debugInfo = "111:\OneMore.gbas";
		SHOWSCREEN();
		__debugInfo = "112:\OneMore.gbas";
...
window['MOUSEWAIT_LOOP'] = function() {
	stackPush("sub: MOUSEWAIT_LOOP", __debugInfo);
	try {
		__debugInfo = "116:\OneMore.gbas";
		if (ANYMOUSE()) {
			__debugInfo = "116:\OneMore.gbas";
			POPLOOP();
			__debugInfo = "116:\OneMore.gbas";
...
window['func15_IsLevelComplete'] = function() {
	stackPush("function: IsLevelComplete", __debugInfo);
	try {
		var local1_x_1261 = 0.0, local1_y_1262 = 0.0;
		__debugInfo = "125:\OneMore.gbas";
		{
			__debugInfo = "130:\OneMore.gbas";
			for (local1_x_1261 = 0;toCheck(local1_x_1261, 9, 1);local1_x_1261 += 1) {
				__debugInfo = "126:\OneMore.gbas";
				{
					__debugInfo = "129:\OneMore.gbas";
					for (local1_y_1262 = 0;toCheck(local1_y_1262, 9, 1);local1_y_1262 += 1) {
						__debugInfo = "128:\OneMore.gbas";
						if ((((global9_playfield.arrAccess(~~(local1_x_1261), ~~(local1_y_1262)).values[tmpPositionCache]) == (1)) ? 1 : 0)) {
							__debugInfo = "128:\OneMore.gbas";
							return 0;
							__debugInfo = "128:\OneMore.gbas";
						};
		...
		__debugInfo = "131:\OneMore.gbas";
		return tryClone(1);
		__debugInfo = "132:\OneMore.gbas";
		return 0;
		__debugInfo = "125:\OneMore.gbas";
	} catch(ex) {
		if (isKnownException(ex)) throw ex;
...
window['method13_type7_TObject_12_ToString_Str'] = function(param4_self) {
	...
	try {
		__debugInfo = "157:\OneMore.gbas";
		return "Object";
		__debugInfo = "158:\OneMore.gbas";
		return "";
		__debugInfo = "157:\OneMore.gbas";
	} catch(ex) {
		if (isKnownException(ex)) throw ex;
...
window['method13_type7_TObject_6_Equals'] = function(param3_Obj, param4_self) {
	...
	try {
		__debugInfo = "164:\OneMore.gbas";
		if ((((param3_Obj) == (param4_self)) ? 1 : 0)) {
			__debugInfo = "161:\OneMore.gbas";
			return 1;
			__debugInfo = "161:\OneMore.gbas";
		} else {
			__debugInfo = "163:\OneMore.gbas";
			return tryClone(0);
			__debugInfo = "163:\OneMore.gbas";
		};
		__debugInfo = "165:\OneMore.gbas";
		return 0;
		__debugInfo = "164:\OneMore.gbas";
	} catch(ex) {
		if (isKnownException(ex)) throw ex;
...
window['method13_type7_TObject_10_ToHashCode'] = function(param4_self) {
	...
	try {
		__debugInfo = "167:\OneMore.gbas";
		return 0;
		__debugInfo = "168:\OneMore.gbas";
		return 0;
		__debugInfo = "167:\OneMore.gbas";
	} catch(ex) {
		if (isKnownException(ex)) throw ex;
