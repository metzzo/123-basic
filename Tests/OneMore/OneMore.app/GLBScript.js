...
window["main"] = function() {
  ...
  try {
    ...
    DIM(unref(global9_playfield), [10, 10], 0);
...
window["ShowPlayfield"] = function() {
  ...
  try {
    var local1_x_588 = 0, local1_y_589 = 0, local5_color_590 = new GLBArray;
    __debugInfo = "40:OneMore.gbas";
    DIMDATA(local5_color_590, [RGB(50, 50, 255), RGB(50, 255, 50)]);
    __debugInfo = "42:OneMore.gbas";
    DRAWRECT(0, 0, 320, 320, RGB(255, 255, 255));
    __debugInfo = "47:OneMore.gbas";
    for(local1_x_588 = 0;toCheck(local1_x_588, 9, 1);local1_x_588 += 1) {
      __debugInfo = "46:OneMore.gbas";
      for(local1_y_589 = 0;toCheck(local1_y_589, 9, 1);local1_y_589 += 1) {
        __debugInfo = "45:OneMore.gbas";
        DRAWRECT(local1_x_588 * 32 + 1, local1_y_589 * 32 + 1, 30, 30, unref(~~local5_color_590.arrAccess(~~global9_playfield.arrAccess(~~local1_x_588, ~~local1_y_589).values[tmpPositionCache]).values[tmpPositionCache]));
        __debugInfo = "45:OneMore.gbas"
      }
      __debugInfo = "46:OneMore.gbas"
    }
...
window["NewLevel"] = function() {
  ...
  try {
    var local1_x_597 = 0, local1_y_598 = 0, local1_i_599 = 0;
    __debugInfo = "100:OneMore.gbas";
    for(local1_x_597 = 0;toCheck(local1_x_597, 9, 1);local1_x_597 += 1) {
      __debugInfo = "99:OneMore.gbas";
      for(local1_y_598 = 0;toCheck(local1_y_598, 9, 1);local1_y_598 += 1) {
        __debugInfo = "98:OneMore.gbas";
        global9_playfield.arrAccess(~~local1_x_597, ~~local1_y_598).values[tmpPositionCache] = 0;
        __debugInfo = "98:OneMore.gbas"
      }
      __debugInfo = "99:OneMore.gbas"
    }
    ...
    for(local1_i_599 = 0;toCheck(local1_i_599, global5_level, 1);local1_i_599 += 1) {
...
window["func15_IsLevelComplete"] = function() {
  ...
  try {
    var local1_x_600 = 0, local1_y_601 = 0;
    __debugInfo = "130:OneMore.gbas";
    for(local1_x_600 = 0;toCheck(local1_x_600, 9, 1);local1_x_600 += 1) {
      __debugInfo = "129:OneMore.gbas";
      for(local1_y_601 = 0;toCheck(local1_y_601, 9, 1);local1_y_601 += 1) {
        __debugInfo = "128:OneMore.gbas";
        if(global9_playfield.arrAccess(~~local1_x_600, ~~local1_y_601).values[tmpPositionCache] == 1 ? 1 : 0) {
          __debugInfo = "128:OneMore.gbas";
          return 0;
          __debugInfo = "128:OneMore.gbas"
        }
...
var global2_mx_ref = [0], global2_my_ref = [0], global2_b1_ref = [0], global2_b2_ref = [0], global9_playfield = new GLBArray, global5_level = 0, global9_mousefree = 0, global6_clicks = 0, global3_set = 0;
