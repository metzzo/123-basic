...
window['main'] = function(){
	var local5_l_Str_ref_1239 = [""], local3_bin_ref_1240 = [0], local4_bbin_ref_1241 = [0.0], local6_Hi_Str_ref_1242 = [""], local9_color_Str_1243 = "", local9_shape_Str_1244 = "", local10_splits_Str_1245 = new GLBArray(), local3_num_1246 = 0.0, local7_cur_Str_1248 = "", local9_files_Str_1249 = new GLBArray(), local7_num_dir_1250 = 0.0, local8_num_file_1251 = 0.0;
	STDOUT((((("Commandline: ") + (GETCOMMANDLINE_Str()))) + ("\n")));
	SETCURRENTDIR("Media");
	if (((OPENFILE(0, "hallo123.txt", 0)) ? 0 : 1)) {
		STDOUT("ERROR WRITE!\n");
		END();
	...
	local5_l_Str_ref_1239[0] = "";
	READSTR(0, local5_l_Str_ref_1239, 4);
	STDOUT((((("BackRead: ") + (local5_l_Str_ref_1239[0]))) + ("\n")));
	CLOSEFILE(0);
	OPENFILE(0, "greetings.txt", -(1));
	WRITESTR(0, "Guten Tag! ");
	CLOSEFILE(0);
	...
	READUBYTE(0, local3_bin_ref_1240);
	STDOUT((((("UBYTE: ") + (CAST2STRING(local3_bin_ref_1240[0])))) + ("\n")));
	READBYTE(0, local3_bin_ref_1240);
	STDOUT((((("BYTE: ") + (CAST2STRING(local3_bin_ref_1240[0])))) + ("\n")));
	READWORD(0, local3_bin_ref_1240);
	STDOUT((((("Word: ") + (CAST2STRING(local3_bin_ref_1240[0])))) + ("\n")));
	READUWORD(0, local3_bin_ref_1240);
	STDOUT((((("UWord: ") + (CAST2STRING(local3_bin_ref_1240[0])))) + ("\n")));
	READLONG(0, local3_bin_ref_1240);
	STDOUT((((("Long: ") + (CAST2STRING(local3_bin_ref_1240[0])))) + ("\n")));
	READULONG(0, local3_bin_ref_1240);
	STDOUT((((("ULong: ") + (CAST2STRING(local3_bin_ref_1240[0])))) + ("\n")));
	READIEEE(0, local4_bbin_ref_1241);
	STDOUT((((("IEEE: ") + (CAST2STRING(local4_bbin_ref_1241[0])))) + ("\n")));
	READSHORTIEEE(0, local4_bbin_ref_1241);
	STDOUT((((("SHORT IEEE: ") + (CAST2STRING(local4_bbin_ref_1241[0])))) + ("\n")));
	READSTR(0, local6_Hi_Str_ref_1242, 2);
	STDOUT((((("STR: ") + (local6_Hi_Str_ref_1242[0]))) + ("\n")));
	CLOSEFILE(0);
	local5_l_Str_ref_1239[0] = "";
	OPENFILE(0, "greetings.txt", 0);
	STDOUT((((("Filesize: ") + (CAST2STRING(func13_MyGETFILESIZE(0))))) + ("\n")));
	READSTR(0, local5_l_Str_ref_1239, ~~(func13_MyGETFILESIZE(0)));
	STDOUT((((("Begrüßung: ") + (local5_l_Str_ref_1239[0]))) + ("\n")));
	KILLFILE("test.ini");
	INIOPEN("test.ini");
	local9_color_Str_1243 = "Colors";
	local9_shape_Str_1244 = "Shapes";
	INIPUT(local9_color_Str_1243, "red", CAST2STRING(1));
	INIPUT(local9_color_Str_1243, "green", CAST2STRING(2));
	INIPUT(local9_shape_Str_1244, "Circle", CAST2STRING(1));
	INIPUT(local9_shape_Str_1244, "Poly", "fine");
	INIOPEN("");
	INIOPEN("test.ini");
	STDOUT((((("Red  = ") + (INIGET_Str(local9_color_Str_1243, "rEd", "NO_DATA")))) + ("\n")));
	STDOUT((((("Poly = ") + (INIGET_Str(local9_shape_Str_1244, "polY", "NO_DATA")))) + ("\n")));
	STDOUT((("nach dem loeschen: ") + ("\n")));
	INIPUT(local9_color_Str_1243, "", "");
	INIPUT(local9_shape_Str_1244, "pOLy", "");
	STDOUT((((("Red  = ") + (INIGET_Str(local9_color_Str_1243, "Red", "NO_DATA")))) + ("\n")));
	STDOUT((((("Poly = ") + (INIGET_Str(local9_shape_Str_1244, "PoLy", "NO_DATA")))) + ("\n")));
	local3_num_1246 = SPLITSTR("  Dream.Design - Entertainment", unref(local10_splits_Str_1245), ". -", 1);
	STDOUT((((("count: ") + (CAST2STRING(local3_num_1246)))) + ("\n")));
	{
		var local1_i_1247 = 0.0;
		for (local1_i_1247 = 0;toCheck(local1_i_1247, ((local3_num_1246) - (1)), 1);local1_i_1247 += 1) {
			STDOUT(((((">") + (local10_splits_Str_1245.arrAccess(~~(local1_i_1247)).values[tmpPositionCache]))) + ("<\n")));
			
		};
		
	};
	local7_cur_Str_1248 = GETCURRENTDIR_Str();
	local3_num_1246 = GETFILELIST("*.*", unref(local9_files_Str_1249));
	local7_num_dir_1250 = INTEGER(((local3_num_1246) / (65536)));
	local8_num_file_1251 = MOD(~~(local3_num_1246), 65536);
	STDOUT((((("CUR: ") + (local7_cur_Str_1248))) + ("\n")));
	STDOUT((((((((((((("num: ") + (CAST2STRING(local3_num_1246)))) + (" -> nDir: "))) + (CAST2STRING(local7_num_dir_1250)))) + (" nFile: "))) + (CAST2STRING(local8_num_file_1251)))) + ("\n")));
	{
		var local1_i_1252 = 0.0;
		for (local1_i_1252 = 0;toCheck(local1_i_1252, ((BOUNDS(local9_files_Str_1249, 0)) - (1)), 1);local1_i_1252 += 1) {
			STDOUT(((((" - ") + (local9_files_Str_1249.arrAccess(~~(local1_i_1252)).values[tmpPositionCache]))) + ("\n")));
...
window['func13_MyGETFILESIZE'] = function(param7_channel) {
	var local3_pos_1254 = 0, local4_Size_1255 = 0;
	local3_pos_1254 = FILEPOSITION(param7_channel);
	FILESEEK(param7_channel, 0, 0);
	local4_Size_1255 = 0;
	while (((ENDOFFILE(param7_channel)) ? 0 : 1)) {
		var local3_tmp_ref_1256 = [0];
		READUBYTE(param7_channel, local3_tmp_ref_1256);
		local4_Size_1255+=1;
		
	};
	FILESEEK(param7_channel, local3_pos_1254, 0);
	return tryClone(local4_Size_1255);
	return 0;
