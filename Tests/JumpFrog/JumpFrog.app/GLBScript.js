		...
		__debugInfo = "124:\JumpFrog.gbas";
		{
			...
			for (local1_i_1284 = 0;toCheck(local1_i_1284, ((BOUNDS(global6_frog_x, 0)) - (1)), 1);local1_i_1284 += 1) {
				...
				if (global7_VIEW_3D) {
					...
					{
						var local16___SelectHelper1__1295 = 0.0;
						__debugInfo = "142:\JumpFrog.gbas";
						local16___SelectHelper1__1295 = global9_frog_jump.arrAccess(~~(local1_i_1284)).values[tmpPositionCache];
						__debugInfo = "149:\JumpFrog.gbas";
						if ((((local16___SelectHelper1__1295) < (0)) ? 1 : 0)) {
							__debugInfo = "144:\JumpFrog.gbas";
							X_DRAWANIM(0, 0, 6, -(global9_frog_jump.arrAccess(~~(local1_i_1284)).values[tmpPositionCache]), 1);
							__debugInfo = "144:\JumpFrog.gbas";
						} else if ((((local16___SelectHelper1__1295) == (0)) ? 1 : 0)) {
...
window['func10_HandleFrog'] = function(param3_num, param5_dtime) {
	...
	try {
		...
		{
			var local16___SelectHelper2__1304 = 0.0;
			__debugInfo = "233:\JumpFrog.gbas";
			local16___SelectHelper2__1304 = global9_frog_jump.arrAccess(~~(param3_num)).values[tmpPositionCache];
			__debugInfo = "245:\JumpFrog.gbas";
			if ((((local16___SelectHelper2__1304) < (0)) ? 1 : 0)) {
				...
				__debugInfo = "235:\JumpFrog.gbas";
			} else if ((((local16___SelectHelper2__1304) > (0)) ? 1 : 0)) {
...
window['func14_GetPlatformPos'] = function(param3_num, param5_dtime, param3_pos) {
	...
	try {
		...
		{
			var local16___SelectHelper3__1319 = 0;
			__debugInfo = "341:\JumpFrog.gbas";
			local16___SelectHelper3__1319 = MOD(~~(func10_PseudoRand(param3_num)), 6);
			__debugInfo = "384:\JumpFrog.gbas";
			if ((((local16___SelectHelper3__1319) == (0)) ? 1 : 0)) {
				...
				__debugInfo = "343:\JumpFrog.gbas";
			} else if ((((local16___SelectHelper3__1319) == (1)) ? 1 : 0)) {
				...
				{
					var local16___SelectHelper4__1320 = 0.0;
					__debugInfo = "354:\JumpFrog.gbas";
					local16___SelectHelper4__1320 = local1_x_1318;
					__debugInfo = "361:\JumpFrog.gbas";
					if ((((local16___SelectHelper4__1320) < (100)) ? 1 : 0)) {
						__debugInfo = "356:\JumpFrog.gbas";
						param3_pos.arrAccess(3).values[tmpPositionCache] = ((((-(local1_x_1318)) / (100))) - (0.1));
						__debugInfo = "356:\JumpFrog.gbas";
					} else if ((((local16___SelectHelper4__1320) > (600)) ? 1 : 0)) {
				...
				__debugInfo = "366:\JumpFrog.gbas";
			} else if ((((local16___SelectHelper3__1319) == (4)) ? 1 : 0)) {
				...
				{
					var local16___SelectHelper5__1321 = 0.0;
					__debugInfo = "372:\JumpFrog.gbas";
					local16___SelectHelper5__1321 = local1_x_1318;
					__debugInfo = "379:\JumpFrog.gbas";
					if ((((local16___SelectHelper5__1321) < (100)) ? 1 : 0)) {
						__debugInfo = "374:\JumpFrog.gbas";
						param3_pos.arrAccess(3).values[tmpPositionCache] = ((((-(local1_x_1318)) / (100))) + (0.1));
						__debugInfo = "374:\JumpFrog.gbas";
					} else if ((((local16___SelectHelper5__1321) > (600)) ? 1 : 0)) {
