...
window["main"] = function() {
  ...
  try {
    ...
    SETCURRENTDIR("Media");
    __debugInfo = "55:SprColTest.gbas";
    global1_x = 40;
    __debugInfo = "7:SprColTest.gbas"
  }catch(ex) {
...
window["method13_type7_TPlayer_6_Update"] = function(param4_self) {
  ...
  try {
    ...
    __debugInfo = "60:SprColTest.gbas";
    return 0;
    __debugInfo = "59:SprColTest.gbas"
  }catch(ex) {
    if(isKnownException(ex)) {
...
window["GLB_ON_LOOP"] = function() {
  ...
  try {
    ...
    STDOUT(unref(CAST2STRING(global1_x)));
    __debugInfo = "66:SprColTest.gbas";
    if(global1_x > 640 ? 1 : 0) {
      __debugInfo = "66:SprColTest.gbas";
      global1_x = -80;
      __debugInfo = "66:SprColTest.gbas"
    }
    __debugInfo = "67:SprColTest.gbas";
    PRINT("Hello World " + CAST2STRING(GETTIMERALL()) + ": " + CAST2STRING(global1_x), unref(global1_x), 10, 0);
...
window["method13_type7_TObject_12_ToString_Str"] = function(param4_self) {
  ...
  try {
    param4_self = unref(param4_self);
    __debugInfo = "79:SprColTest.gbas";
    return"Object";
    __debugInfo = "80:SprColTest.gbas";
    return"";
    __debugInfo = "79:SprColTest.gbas"
  }catch(ex) {
    if(isKnownException(ex)) {
...
window["method13_type7_TObject_6_Equals"] = function(param3_Obj, param4_self) {
  ...
  try {
    ...
    param4_self = unref(param4_self);
    __debugInfo = "86:SprColTest.gbas";
    if(param3_Obj == param4_self ? 1 : 0) {
      __debugInfo = "83:SprColTest.gbas";
      return 1;
      __debugInfo = "83:SprColTest.gbas"
    }else {
      __debugInfo = "85:SprColTest.gbas";
      return tryClone(0);
      __debugInfo = "85:SprColTest.gbas"
    }
    __debugInfo = "87:SprColTest.gbas";
    return 0;
    __debugInfo = "86:SprColTest.gbas"
  }catch(ex) {
    if(isKnownException(ex)) {
...
window["method13_type7_TObject_10_ToHashCode"] = function(param4_self) {
  ...
  try {
    param4_self = unref(param4_self);
    __debugInfo = "89:SprColTest.gbas";
    return 0;
    __debugInfo = "90:SprColTest.gbas";
    return 0;
    __debugInfo = "89:SprColTest.gbas"
  }catch(ex) {
    if(isKnownException(ex)) {
...
var vtbl_type7_TPlayer = {Update:method13_type7_TPlayer_6_Update, ToString_Str:method13_type7_TObject_12_ToString_Str, Equals:method13_type7_TObject_6_Equals, ToHashCode:method13_type7_TObject_10_ToHashCode};
...
var global1_x = 0, global1_P = new type7_TPlayer;
