...
window['main'] = function(){
	...
	try {
		__debugInfo = "7:\SprColTest.gbas";
		SETCURRENTDIR("Media");
		__debugInfo = "10:\SprColTest.gbas";
		LOADSPRITE("col1.png", 0);
		__debugInfo = "11:\SprColTest.gbas";
...
window['GLB_ON_LOOP'] = function() {
	...
	try {
		var local1_x_ref_1238 = [0.0], local1_y_ref_1239 = [0.0], local2_b1_ref_1240 = [0.0], local2_b2_ref_1241 = [0.0];
		__debugInfo = "21:\SprColTest.gbas";
		MOUSESTATE(local1_x_ref_1238, local1_y_ref_1239, local2_b1_ref_1240, local2_b2_ref_1241);
		__debugInfo = "27:\SprColTest.gbas";
		if (SPRCOLL(0, 20, 20, 1, unref(local1_x_ref_1238[0]), unref(local1_y_ref_1239[0]))) {
			__debugInfo = "24:\SprColTest.gbas";
			CLEARSCREEN(RGB(0, 255, 0));
			__debugInfo = "24:\SprColTest.gbas";
		} else {
			__debugInfo = "26:\SprColTest.gbas";
			CLEARSCREEN(RGB(255, 0, 0));
			__debugInfo = "26:\SprColTest.gbas";
		};
		__debugInfo = "30:\SprColTest.gbas";
		DRAWSPRITE(0, 20, 20);
		__debugInfo = "31:\SprColTest.gbas";
		DRAWSPRITE(1, unref(local1_x_ref_1238[0]), unref(local1_y_ref_1239[0]));
		__debugInfo = "34:\SprColTest.gbas";
		STARTPOLY(0, 2);
		__debugInfo = "35:\SprColTest.gbas";
		POLYVECTOR(0, 0, 0, 0, RGB(0, 0, 255));
		__debugInfo = "36:\SprColTest.gbas";
		POLYVECTOR(100, 0, 200, 0, RGB(0, 0, 255));
		__debugInfo = "37:\SprColTest.gbas";
		POLYVECTOR(100, 100, 200, 150, RGB(0, 0, 255));
		__debugInfo = "38:\SprColTest.gbas";
		POLYVECTOR(0, 100, 0, 150, RGB(0, 0, 255));
		__debugInfo = "39:\SprColTest.gbas";
		POLYNEWSTRIP();
		__debugInfo = "40:\SprColTest.gbas";
		ENDPOLY();
		__debugInfo = "42:\SprColTest.gbas";
		SHOWSCREEN();
		__debugInfo = "21:\SprColTest.gbas";
	} catch(ex) {
		if (isKnownException(ex)) throw ex;
...
window['GLB_ON_LOADING'] = function() {
	...
	try {
		__debugInfo = "46:\SprColTest.gbas";
		PRINT("Loading!", 10, 10, 0);
		__debugInfo = "48:\SprColTest.gbas";
		SHOWSCREEN();
		__debugInfo = "46:\SprColTest.gbas";
	} catch(ex) {
		if (isKnownException(ex)) throw ex;
...
window['method13_type7_TObject_12_ToString_Str'] = function(param4_self) {
	...
	try {
		__debugInfo = "58:\SprColTest.gbas";
		return "Object";
		__debugInfo = "59:\SprColTest.gbas";
		return "";
		__debugInfo = "58:\SprColTest.gbas";
	} catch(ex) {
		if (isKnownException(ex)) throw ex;
...
window['method13_type7_TObject_6_Equals'] = function(param3_Obj, param4_self) {
	...
	try {
		__debugInfo = "65:\SprColTest.gbas";
		if ((((param3_Obj) == (param4_self)) ? 1 : 0)) {
			__debugInfo = "62:\SprColTest.gbas";
			return 1;
			__debugInfo = "62:\SprColTest.gbas";
		} else {
			__debugInfo = "64:\SprColTest.gbas";
			return tryClone(0);
			__debugInfo = "64:\SprColTest.gbas";
		};
		__debugInfo = "66:\SprColTest.gbas";
		return 0;
		__debugInfo = "65:\SprColTest.gbas";
	} catch(ex) {
		if (isKnownException(ex)) throw ex;
...
window['method13_type7_TObject_10_ToHashCode'] = function(param4_self) {
	...
	try {
		__debugInfo = "68:\SprColTest.gbas";
		return 0;
		__debugInfo = "69:\SprColTest.gbas";
		return 0;
		__debugInfo = "68:\SprColTest.gbas";
	} catch(ex) {
		if (isKnownException(ex)) throw ex;
