...
window['GLB_ON_LOOP'] = function() {
	...
	try {
		__debugInfo = "7:\Pong.gbas";
		MoveAll();
		__debugInfo = "8:\Pong.gbas";
		ShowAll();
		__debugInfo = "7:\Pong.gbas";
	} catch(ex) {
		if (isKnownException(ex)) throw ex;
...
window['ShowAll'] = function() {
	...
	try {
		__debugInfo = "105:\Pong.gbas";
		{
			var local3_num_1247 = 0.0;
			__debugInfo = "112:\Pong.gbas";
			for (local3_num_1247 = 0;toCheck(local3_num_1247, 1, 1);local3_num_1247 += 1) {
				__debugInfo = "107:\Pong.gbas";
				ALPHAMODE(-(0.5));
				__debugInfo = "108:\Pong.gbas";
				...
				__debugInfo = "109:\Pong.gbas";
				ALPHAMODE(0);
				__debugInfo = "110:\Pong.gbas";
...
window['ResetBall'] = function() {
	...
	try {
		__debugInfo = "124:\Pong.gbas";
		global6_ball_x = 320;
		__debugInfo = "125:\Pong.gbas";
		global6_ball_y = 240;
		__debugInfo = "131:\Pong.gbas";
		if ((((global7_ball_sx) < (0)) ? 1 : 0)) {
			__debugInfo = "128:\Pong.gbas";
			global7_ball_sx = 1;
			__debugInfo = "128:\Pong.gbas";
		} else {
...
window['method13_type7_TObject_12_ToString_Str'] = function(param4_self) {
	...
	try {
		__debugInfo = "155:\Pong.gbas";
		return "Object";
		__debugInfo = "156:\Pong.gbas";
		return "";
		__debugInfo = "155:\Pong.gbas";
	} catch(ex) {
		if (isKnownException(ex)) throw ex;
