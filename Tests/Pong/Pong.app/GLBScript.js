...
window["MoveAll"] = function() {
  ...
  try {
    ...
    for(local3_num_580 = 0;toCheck(local3_num_580, 1, 1);local3_num_580 += 1) {
      ...
      if(global5_bat_y.arrAccess(~~local3_num_580).values[tmpPositionCache] < 0 ? 1 : 0) {
        __debugInfo = "49:Pong.gbas";
        global5_bat_y.arrAccess(~~local3_num_580).values[tmpPositionCache] = 0;
        __debugInfo = "49:Pong.gbas"
      }
      __debugInfo = "50:Pong.gbas";
      if(global5_bat_y.arrAccess(~~local3_num_580).values[tmpPositionCache] > 416 ? 1 : 0) {
        __debugInfo = "50:Pong.gbas";
        global5_bat_y.arrAccess(~~local3_num_580).values[tmpPositionCache] = 416;
        __debugInfo = "50:Pong.gbas"
      }
      __debugInfo = "43:Pong.gbas"
    }
    ...
    for(local3_num_585 = 0;toCheck(local3_num_585, 1, 1);local3_num_585 += 1) {
      __debugInfo = "96:Pong.gbas";
      if(BOXCOLL(unref(~~global5_bat_x.arrAccess(~~local3_num_585).values[tmpPositionCache]), unref(~~global5_bat_y.arrAccess(~~local3_num_585).values[tmpPositionCache]), 16, 64, unref(~~global6_ball_x), unref(~~global6_ball_y), 16, 16)) {
...
window["ShowAll"] = function() {
  ...
  try {
    ...
    for(local3_num_586 = 0;toCheck(local3_num_586, 1, 1);local3_num_586 += 1) {
      __debugInfo = "107:Pong.gbas";
      ALPHAMODE(-0.5);
      __debugInfo = "108:Pong.gbas";
      DRAWSPRITE(1, global5_bat_x.arrAccess(~~local3_num_586).values[tmpPositionCache] + 10, global5_bat_y.arrAccess(~~local3_num_586).values[tmpPositionCache] + 20);
      __debugInfo = "109:Pong.gbas";
      ALPHAMODE(0);
      __debugInfo = "110:Pong.gbas";
      DRAWSPRITE(1, unref(global5_bat_x.arrAccess(~~local3_num_586).values[tmpPositionCache]), unref(global5_bat_y.arrAccess(~~local3_num_586).values[tmpPositionCache]));
      __debugInfo = "111:Pong.gbas";
      PRINT(unref(CAST2STRING(global5_score.arrAccess(~~local3_num_586).values[tmpPositionCache])), local3_num_586 * 320 + 32, 16, 0);
      __debugInfo = "107:Pong.gbas"
    }
    ...
    DRAWSPRITE(0, INTEGER(unref(global6_ball_x)), INTEGER(unref(global6_ball_y)));
...
var global5_bat_y = new GLBArray, global5_bat_x = new GLBArray, global5_score = new GLBArray, global6_ball_x = 0, global7_ball_sx = 0, global6_ball_y = 0, global7_ball_sy = 0;
