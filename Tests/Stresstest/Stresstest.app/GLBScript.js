...
function ROTOSPRITE(num, x, y, phi) {
  if(phi % 360 == 0) {
    ...
    context.rotate(phi * Math.PI / 180);
    var spr = getSprite(num);
...
var static3_GetInt_lol = 0;
var __debugInfo = "";
var debugMode = true;
window["main"] = function() {
  stackPush("main", __debugInfo);
  try {
    var local1_i_603 = 0, local1_j_604 = 0, local1_k_605 = 0, local4_arr1_606 = new GLBArray, local4_arr2_607 = new GLBArray, local1_b_608 = new type4_Buch, local1_r_609 = new type5_Regal, local3_ptr_ref_610 = [funcPtr], local7_ptrType_611 = new type7_ptrTest, local7_refVari_ref_615 = [0], local1_s_616 = new type5_Seite, alias2_al_ref_617 = [0], alias4_ptr2_ref_618 = [funcPtr];
    __debugInfo = "9:Stresstest.gbas";
    local1_j_604 = 999;
    __debugInfo = "10:Stresstest.gbas";
    local1_k_605 = func6_GetInt();
    __debugInfo = "12:Stresstest.gbas";
    local1_i_603 = 816 + local1_i_603;
    __debugInfo = "13:Stresstest.gbas";
    STDOUT("i: " + CAST2STRING(local1_i_603) + "\n");
    __debugInfo = "14:Stresstest.gbas";
    STDOUT("j: " + CAST2STRING(local1_j_604) + "\n");
    __debugInfo = "15:Stresstest.gbas";
    STDOUT("k: " + CAST2STRING(local1_k_605) + "\n");
    __debugInfo = "17:Stresstest.gbas";
    STDOUT(CAST2STRING(12) + ": Zahl! \n");
    __debugInfo = "19:Stresstest.gbas";
    STDOUT("Hallo Welt " + CAST2STRING(100) + "\n");
    __debugInfo = "20:Stresstest.gbas";
    local4_arr1_606 = DIM(new GLBArray, [10, 10], [0]);
    __debugInfo = "21:Stresstest.gbas";
    DIM(unref(local4_arr1_606), [10], 0);
    __debugInfo = "22:Stresstest.gbas";
    REDIM(unref(local4_arr1_606), [14], 0);
    __debugInfo = "23:Stresstest.gbas";
    local4_arr1_606.arrAccess(8).values[tmpPositionCache] = 99;
    __debugInfo = "24:Stresstest.gbas";
    STDOUT("Array 1 an der Stelle 8: " + CAST2STRING(local4_arr1_606.arrAccess(8).values[tmpPositionCache]) + "\n");
    __debugInfo = "27:Stresstest.gbas";
    STDOUT("1--- \n");
    __debugInfo = "28:Stresstest.gbas";
    local4_arr2_607 = local4_arr1_606.clone();
    __debugInfo = "29:Stresstest.gbas";
    STDOUT("2--- \n");
    __debugInfo = "30:Stresstest.gbas";
    local4_arr1_606 = local4_arr2_607.clone();
    __debugInfo = "31:Stresstest.gbas";
    STDOUT("3--- \n");
    __debugInfo = "33:Stresstest.gbas";
    local4_arr2_607 = DIM(new GLBArray, [10, 10], [0]);
    __debugInfo = "36:Stresstest.gbas";
    local1_b_608.attr13_AktuelleSeite = 200;
    __debugInfo = "37:Stresstest.gbas";
    local1_b_608.GetTitel_Str(200, "lol");
    __debugInfo = "38:Stresstest.gbas";
    local1_b_608.getBuch();
    __debugInfo = "39:Stresstest.gbas";
    STDOUT("buch Seite: " + CAST2STRING(local1_b_608.attr13_AktuelleSeite) + "\n");
    __debugInfo = "40:Stresstest.gbas";
    DIM(unref(local1_b_608.attr10_Seiten_Str), [100, 100], "");
    __debugInfo = "44:Stresstest.gbas";
    DIM(unref(local1_r_609.attr7_Buecher), [100], new type4_Buch);
    __debugInfo = "45:Stresstest.gbas";
    local1_r_609.attr7_Buecher.arrAccess(0).values[tmpPositionCache] = local1_b_608.getBuch().clone();
    __debugInfo = "46:Stresstest.gbas";
    local1_r_609.attr7_Buecher.arrAccess(0).values[tmpPositionCache].attr9_Titel_Str = "Harry Potter";
    __debugInfo = "47:Stresstest.gbas";
    STDOUT("Erstes Buch im Regal: " + local1_r_609.attr7_Buecher.arrAccess(0).values[tmpPositionCache].attr9_Titel_Str + "\n");
    __debugInfo = "48:Stresstest.gbas";
    DIM(unref(local1_r_609.attr7_Buecher.arrAccess(0).values[tmpPositionCache].attr6_Seiten), [100], new type5_Seite);
    __debugInfo = "49:Stresstest.gbas";
    local1_r_609.attr7_Buecher.arrAccess(0).values[tmpPositionCache].getSeiten().arrAccess(0).values[tmpPositionCache].attr8_Text_Str = "lol";
    __debugInfo = "50:Stresstest.gbas";
    local1_r_609.attr7_Buecher.arrAccess(0).values[tmpPositionCache].getBesteSeite().attr8_Text_Str = "ICH MAG Z\u00dcGE";
    __debugInfo = "51:Stresstest.gbas";
    func13_getBesteSeite(local1_r_609.attr7_Buecher.arrAccess(0).values[tmpPositionCache]).attr8_Text_Str = "ICH NICHT";
    __debugInfo = "92:Stresstest.gbas";
    func16_testFunktion_Str(10, 20, 30);
    __debugInfo = "93:Stresstest.gbas";
    func16_testFunktion_Str(10, 20, FLOAT2STR("lolo"));
    __debugInfo = "94:Stresstest.gbas";
    func18_andereTestFunktion(40);
    __debugInfo = "95:Stresstest.gbas";
    func18_andereTestFunktion(80);
    __debugInfo = "96:Stresstest.gbas";
    mySub();
    __debugInfo = "97:Stresstest.gbas";
    func11_defaultTest(10, -1, 22);
    __debugInfo = "126:Stresstest.gbas";
    global1_l = func6_GetInt();
    __debugInfo = "144:Stresstest.gbas";
    local3_ptr_ref_610[0] = func5_func1;
    __debugInfo = "145:Stresstest.gbas";
    local3_ptr_ref_610[0](42);
    __debugInfo = "152:Stresstest.gbas";
    local7_ptrType_611.attr3_ptr(422);
    __debugInfo = "153:Stresstest.gbas";
    func13_prototypeTest(func5_func2)(100);
    __debugInfo = "160:Stresstest.gbas";
    if(1) {
      __debugInfo = "160:Stresstest.gbas";
      STDOUT("lol\n");
      __debugInfo = "160:Stresstest.gbas"
    }
    __debugInfo = "170:Stresstest.gbas";
    if(1) {
      __debugInfo = "163:Stresstest.gbas";
      STDOUT("a " + CAST2STRING(local1_i_603) + "\n");
      __debugInfo = "163:Stresstest.gbas"
    }else {
      if(2) {
        __debugInfo = "165:Stresstest.gbas";
        STDOUT("b\n");
        __debugInfo = "165:Stresstest.gbas"
      }else {
        if(3) {
          __debugInfo = "167:Stresstest.gbas";
          STDOUT("c\n");
          __debugInfo = "167:Stresstest.gbas"
        }else {
          __debugInfo = "169:Stresstest.gbas";
          STDOUT("ELSE\n");
          __debugInfo = "169:Stresstest.gbas"
        }
      }
    }
    __debugInfo = "186:Stresstest.gbas";
    for(local4_abcd_612 = 0;toCheck(local4_abcd_612, 10, 2);local4_abcd_612 += 2) {
      __debugInfo = "185:Stresstest.gbas";
      STDOUT("i step: " + CAST2STRING(local4_abcd_612) + "\n");
      __debugInfo = "185:Stresstest.gbas"
    }
    __debugInfo = "191:Stresstest.gbas";
    var Err_Str = "";
    __debugInfo = "193:Stresstest.gbas";
    try {
      __debugInfo = "189:Stresstest.gbas";
      STDOUT("lol\n");
      __debugInfo = "190:Stresstest.gbas";
      throw new GLBException("roflmao", "Stresstest.gbas", 190);__debugInfo = "189:Stresstest.gbas"
    }catch(Err_Str) {
      if(Err_Str instanceof GLBException) {
        Err_Str = Err_Str.getText()
      }else {
        throwError(Err_Str)
      }
      __debugInfo = "192:Stresstest.gbas";
      STDOUT("Error: " + Err_Str + "\n");
      __debugInfo = "192:Stresstest.gbas"
    }
    __debugInfo = "193:Stresstest.gbas";
    __debugInfo = "195:Stresstest.gbas";
    var local16___SelectHelper1__614 = 0;
    __debugInfo = "195:Stresstest.gbas";
    local16___SelectHelper1__614 = local1_i_603;
    __debugInfo = "202:Stresstest.gbas";
    if(((((local16___SelectHelper1__614 == 2 ? 1 : 0) || (local16___SelectHelper1__614 == 3 ? 1 : 0) ? 1 : 0) || (local16___SelectHelper1__614 == 4 ? 1 : 0) ? 1 : 0) || (local16___SelectHelper1__614 > 9 ? 1 : 0) ? 1 : 0) || (local16___SelectHelper1__614 <= 20 ? 1 : 0) ? 1 : 0) {
      __debugInfo = "197:Stresstest.gbas";
      STDOUT("DA\n");
      __debugInfo = "197:Stresstest.gbas"
    }else {
      if((local16___SelectHelper1__614 >= 2 ? 1 : 0) && (local16___SelectHelper1__614 <= 8 ? 1 : 0) ? 1 : 0) {
        __debugInfo = "199:Stresstest.gbas";
        STDOUT("NEUN\n");
        __debugInfo = "199:Stresstest.gbas"
      }else {
        __debugInfo = "201:Stresstest.gbas";
        STDOUT("ROFLMAO\n");
        __debugInfo = "201:Stresstest.gbas"
      }
    }
    __debugInfo = "195:Stresstest.gbas";
    __debugInfo = "204:Stresstest.gbas";
    RESTORE(datablock_dataBlock1);
    __debugInfo = "205:Stresstest.gbas";
    local1_i_603 = READ();
    local1_j_604 = READ();
    local1_k_605 = READ();
    __debugInfo = "207:Stresstest.gbas";
    STDOUT("i: " + CAST2STRING(local1_i_603) + " j: " + CAST2STRING(local1_j_604) + " k: " + CAST2STRING(local1_k_605) + "\n");
    __debugInfo = "214:Stresstest.gbas";
    local7_refVari_ref_615[0] = 42;
    __debugInfo = "215:Stresstest.gbas";
    STDOUT("RefTest: " + CAST2STRING(func9_byRefTest(local7_refVari_ref_615)) + " ref: " + CAST2STRING(local7_refVari_ref_615[0]) + "\n");
    __debugInfo = "217:Stresstest.gbas";
    STDOUT(CAST2STRING(func9_byRefTest(func8_getSeite().attr5_Alter_ref)) + "\n");
    __debugInfo = "219:Stresstest.gbas";
    func9_byRefTest(local1_r_609.attr7_Buecher.arrAccess(0).values[tmpPositionCache].attr10_BesteSeite.attr5_Alter_ref);
    __debugInfo = "220:Stresstest.gbas";
    STDOUT("Alter: " + CAST2STRING(local1_r_609.attr7_Buecher.arrAccess(0).values[tmpPositionCache].attr10_BesteSeite.attr5_Alter_ref[0]) + "\n");
    __debugInfo = "234:Stresstest.gbas";
    local1_s_616 = func8_getSeite().clone();
    __debugInfo = "236:Stresstest.gbas";
    alias2_al_ref_617 = local1_s_616.attr5_Alter_ref;
    __debugInfo = "237:Stresstest.gbas";
    alias2_al_ref_617[0] = 100;
    __debugInfo = "238:Stresstest.gbas";
    STDOUT("Seite ALIAS: " + CAST2STRING(alias2_al_ref_617[0]) + "\n");
    __debugInfo = "239:Stresstest.gbas";
    STDOUT("Seite REAL: " + CAST2STRING(local1_s_616.attr5_Alter_ref[0]) + "\n");
    __debugInfo = "241:Stresstest.gbas";
    alias4_ptr2_ref_618 = local3_ptr_ref_610;
    __debugInfo = "242:Stresstest.gbas";
    alias4_ptr2_ref_618[0](9999);
    __debugInfo = "9:Stresstest.gbas"
  }catch(ex) {
...
window["func13_getBesteSeite"] = function(param1_B) {
  stackPush("function: getBesteSeite", __debugInfo);
  try {
    param1_B = unref(param1_B);
    __debugInfo = "54:Stresstest.gbas";
    return tryClone(unref(param1_B.attr10_BesteSeite));
    __debugInfo = "55:Stresstest.gbas";
    return tryClone(unref(new type5_Seite));
    __debugInfo = "54:Stresstest.gbas"
  }catch(ex) {
    if(isKnownException(ex)) {
      throw ex;
...
window["method10_type4_Buch_9_getSeiten"] = function(param4_self) {
  stackPush("method: getSeiten", __debugInfo);
  try {
    param4_self = unref(param4_self);
    __debugInfo = "71:Stresstest.gbas";
    return tryClone(unref(param4_self.attr6_Seiten));
    __debugInfo = "72:Stresstest.gbas";
    return tryClone(unref(new GLBArray));
    __debugInfo = "71:Stresstest.gbas"
  }catch(ex) {
    if(isKnownException(ex)) {
      throw ex;
...
window["method10_type4_Buch_12_GetTitel_Str"] = function(param5_Param, param11_NoParam_Str, param4_self) {
  stackPush("method: GetTitel_Str", __debugInfo);
  try {
    param5_Param = unref(param5_Param);
    param11_NoParam_Str = unref(param11_NoParam_Str);
    param4_self = unref(param4_self);
    __debugInfo = "75:Stresstest.gbas";
    DIM(unref(param4_self.attr10_Seiten_Str), [40], "");
    __debugInfo = "76:Stresstest.gbas";
    return tryClone(param4_self.attr9_Titel_Str + "Param: " + CAST2STRING(param5_Param) + " - " + param11_NoParam_Str);
    __debugInfo = "77:Stresstest.gbas";
    return"";
    __debugInfo = "75:Stresstest.gbas"
  }catch(ex) {
    if(isKnownException(ex)) {
...
window["method10_type4_Buch_7_getBuch"] = function(param4_self) {
  stackPush("method: getBuch", __debugInfo);
  try {
    param4_self = unref(param4_self);
    __debugInfo = "80:Stresstest.gbas";
    return tryClone(unref(param4_self));
    __debugInfo = "81:Stresstest.gbas";
    return tryClone(unref(new type4_Buch));
    __debugInfo = "80:Stresstest.gbas"
  }catch(ex) {
    if(isKnownException(ex)) {
      throw ex;
...
window["method10_type4_Buch_13_getBesteSeite"] = function(param4_self) {
  stackPush("method: getBesteSeite", __debugInfo);
  try {
    param4_self = unref(param4_self);
    __debugInfo = "83:Stresstest.gbas";
    return tryClone(unref(param4_self.attr10_BesteSeite));
    __debugInfo = "84:Stresstest.gbas";
    return tryClone(unref(new type5_Seite));
    __debugInfo = "83:Stresstest.gbas"
  }catch(ex) {
    if(isKnownException(ex)) {
...
window["func16_testFunktion_Str"] = function(param6_param1, param6_param2, param6_param3) {
  stackPush("function: testFunktion_Str", __debugInfo);
  try {
    param6_param1 = unref(param6_param1);
    param6_param2 = unref(param6_param2);
    param6_param3 = unref(param6_param3);
    __debugInfo = "100:Stresstest.gbas";
    STDOUT("Ich bin in einer Funktion \\o/ " + CAST2STRING(param6_param1) + " " + CAST2STRING(param6_param2) + " " + CAST2STRING(param6_param3) + "\n");
    __debugInfo = "102:Stresstest.gbas";
    return"ROFL";
    __debugInfo = "103:Stresstest.gbas";
    return"";
    __debugInfo = "100:Stresstest.gbas"
  }catch(ex) {
    if(isKnownException(ex)) {
...
window["func11_defaultTest"] = function(param6_param1, param6_param2, param6_param3) {
  stackPush("function: defaultTest", __debugInfo);
  try {
    param6_param1 = unref(param6_param1);
    param6_param2 = unref(param6_param2);
    param6_param3 = unref(param6_param3);
    __debugInfo = "107:Stresstest.gbas";
    return 0;
    __debugInfo = "107:Stresstest.gbas"
  }catch(ex) {
    if(isKnownException(ex)) {
...
window["func18_andereTestFunktion"] = function(param6_param4) {
  stackPush("function: andereTestFunktion", __debugInfo);
  try {
    param6_param4 = unref(param6_param4);
    __debugInfo = "114:Stresstest.gbas";
    STDOUT("ICH BIN DA CaLLBACk\n");
    __debugInfo = "115:Stresstest.gbas";
    return 0;
    __debugInfo = "114:Stresstest.gbas"
  }catch(ex) {
    if(isKnownException(ex)) {
...
window["mySub"] = function() {
  stackPush("sub: mySub", __debugInfo);
  try {
    __debugInfo = "118:Stresstest.gbas";
    STDOUT("I'm in SUB!!! \n");
    __debugInfo = "119:Stresstest.gbas";
    return 0;
    __debugInfo = "120:Stresstest.gbas";
    STDOUT("Ich werde nie angezeigt lol! \n");
    __debugInfo = "122:Stresstest.gbas";
    global1_l = 200;
    __debugInfo = "118:Stresstest.gbas"
  }catch(ex) {
    if(isKnownException(ex)) {
...
window["func6_GetInt"] = function() {
  stackPush("function: GetInt", __debugInfo);
  try {
    __debugInfo = "130:Stresstest.gbas";
    static3_GetInt_lol = static3_GetInt_lol + 4;
    __debugInfo = "131:Stresstest.gbas";
    return 42;
    __debugInfo = "132:Stresstest.gbas";
    return 0;
    __debugInfo = "130:Stresstest.gbas"
  }catch(ex) {
    if(isKnownException(ex)) {
...
window["func5_func1"] = function(param1_a) {
  stackPush("function: func1", __debugInfo);
  try {
    param1_a = unref(param1_a);
    __debugInfo = "138:Stresstest.gbas";
    STDOUT("Ich bin in 1: " + CAST2STRING(param1_a) + "\n");
    __debugInfo = "139:Stresstest.gbas";
    return 0;
    __debugInfo = "138:Stresstest.gbas"
  }catch(ex) {
    if(isKnownException(ex)) {
...
window["func5_func2"] = function(param1_a) {
  stackPush("function: func2", __debugInfo);
  try {
    param1_a = unref(param1_a);
    __debugInfo = "141:Stresstest.gbas";
    STDOUT("Ich bin in 2: " + CAST2STRING(param1_a) + "\n");
    __debugInfo = "142:Stresstest.gbas";
    return 0;
    __debugInfo = "141:Stresstest.gbas"
  }catch(ex) {
    if(isKnownException(ex)) {
...
window["func13_prototypeTest"] = function(param3_inp) {
  stackPush("function: prototypeTest", __debugInfo);
  try {
    param3_inp = unref(param3_inp);
    __debugInfo = "156:Stresstest.gbas";
    param3_inp(112);
    __debugInfo = "157:Stresstest.gbas";
    return tryClone(unref(param3_inp));
    __debugInfo = "158:Stresstest.gbas";
    return tryClone(unref(funcPtr));
    __debugInfo = "156:Stresstest.gbas"
  }catch(ex) {
    if(isKnownException(ex)) {
      throw ex;
...
window["func8_getSeite"] = function() {
  stackPush("function: getSeite", __debugInfo);
  try {
    var local1_S_641 = new type5_Seite;
    __debugInfo = "224:Stresstest.gbas";
    local1_S_641.attr5_Alter_ref[0] = 0;
    __debugInfo = "225:Stresstest.gbas";
    STDOUT("I AM CALLEN \n");
    __debugInfo = "226:Stresstest.gbas";
    return tryClone(unref(local1_S_641));
    __debugInfo = "227:Stresstest.gbas";
    return tryClone(unref(new type5_Seite));
    __debugInfo = "224:Stresstest.gbas"
  }catch(ex) {
    if(isKnownException(ex)) {
...
window["func9_byRefTest"] = function(param3_lol_ref) {
  stackPush("function: byRefTest", __debugInfo);
  try {
    __debugInfo = "230:Stresstest.gbas";
    param3_lol_ref[0] = 12233;
    __debugInfo = "231:Stresstest.gbas";
    return tryClone(200);
    __debugInfo = "232:Stresstest.gbas";
    return 0;
    __debugInfo = "230:Stresstest.gbas"
  }catch(ex) {
    if(isKnownException(ex)) {
...
window["method13_type7_TObject_12_ToString_Str"] = function(param4_self) {
  ...
  try {
    param4_self = unref(param4_self);
    __debugInfo = "251:Stresstest.gbas";
    return"Object";
    __debugInfo = "252:Stresstest.gbas";
    return"";
    __debugInfo = "251:Stresstest.gbas"
  }catch(ex) {
    if(isKnownException(ex)) {
...
window["method13_type7_TObject_6_Equals"] = function(param3_Obj, param4_self) {
  ...
  try {
    ...
    param4_self = unref(param4_self);
    __debugInfo = "258:Stresstest.gbas";
    if(param3_Obj == param4_self ? 1 : 0) {
      __debugInfo = "255:Stresstest.gbas";
      return 1;
      __debugInfo = "255:Stresstest.gbas"
    }else {
      __debugInfo = "257:Stresstest.gbas";
      return tryClone(0);
      __debugInfo = "257:Stresstest.gbas"
    }
    __debugInfo = "259:Stresstest.gbas";
    return 0;
    __debugInfo = "258:Stresstest.gbas"
  }catch(ex) {
    if(isKnownException(ex)) {
...
window["method13_type7_TObject_10_ToHashCode"] = function(param4_self) {
  ...
  try {
    param4_self = unref(param4_self);
    __debugInfo = "261:Stresstest.gbas";
    return 0;
    __debugInfo = "262:Stresstest.gbas";
    return 0;
    __debugInfo = "261:Stresstest.gbas"
  }catch(ex) {
    if(isKnownException(ex)) {
...
window["funcPtr"] = function() {
  return function() {
    throwError("NullPrototypeException")
  }
};
var vtbl_type5_Regal = {ToString_Str:method13_type7_TObject_12_ToString_Str, Equals:method13_type7_TObject_6_Equals, ToHashCode:method13_type7_TObject_10_ToHashCode};
window["type5_Regal"] = function() {
  this.attr7_Buecher = new GLBArray;
  this.vtbl = vtbl_type5_Regal;
  return this
};
window["type5_Regal"].prototype.clone = function() {
  var other = new type5_Regal;
  other.attr7_Buecher = tryClone(this.attr7_Buecher);
  other.vtbl = this.vtbl;
  return other
};
type5_Regal.prototype.ToString_Str = function() {
  return this.vtbl.ToString_Str(this)
};
type5_Regal.prototype.Equals = function() {
  return this.vtbl.Equals(arguments[0], this)
};
type5_Regal.prototype.ToHashCode = function() {
  return this.vtbl.ToHashCode(this)
};
var vtbl_type4_Buch = {getSeiten:method10_type4_Buch_9_getSeiten, GetTitel_Str:method10_type4_Buch_12_GetTitel_Str, getBuch:method10_type4_Buch_7_getBuch, getBesteSeite:method10_type4_Buch_13_getBesteSeite, ToString_Str:method13_type7_TObject_12_ToString_Str, Equals:method13_type7_TObject_6_Equals, ToHashCode:method13_type7_TObject_10_ToHashCode};
window["type4_Buch"] = function() {
  this.attr13_AktuelleSeite = 0;
  this.attr9_Titel_Str = "";
  this.attr12_Besitzer_Str = "";
  this.attr10_Seiten_Str = new GLBArray;
  this.attr6_Seiten = new GLBArray;
  this.attr10_BesteSeite = new type5_Seite;
  this.vtbl = vtbl_type4_Buch;
  this.attr13_AktuelleSeite = func6_GetInt();
  this.attr10_Seiten_Str = DIM(new GLBArray, [100], [""]);
  this.attr6_Seiten = DIM(new GLBArray, [20], [new type5_Seite]);
  return this
};
window["type4_Buch"].prototype.clone = function() {
  var other = new type4_Buch;
  other.attr13_AktuelleSeite = this.attr13_AktuelleSeite;
  other.attr9_Titel_Str = this.attr9_Titel_Str;
  other.attr12_Besitzer_Str = this.attr12_Besitzer_Str;
  other.attr10_Seiten_Str = tryClone(this.attr10_Seiten_Str);
  other.attr6_Seiten = tryClone(this.attr6_Seiten);
  other.attr10_BesteSeite = tryClone(this.attr10_BesteSeite);
  other.vtbl = this.vtbl;
  return other
};
type4_Buch.prototype.getSeiten = function() {
  return this.vtbl.getSeiten(this)
};
type4_Buch.prototype.GetTitel_Str = function() {
  return this.vtbl.GetTitel_Str(arguments[0], arguments[1], this)
};
type4_Buch.prototype.getBuch = function() {
  return this.vtbl.getBuch(this)
};
type4_Buch.prototype.getBesteSeite = function() {
  return this.vtbl.getBesteSeite(this)
};
type4_Buch.prototype.ToString_Str = function() {
  return this.vtbl.ToString_Str(this)
};
type4_Buch.prototype.Equals = function() {
  return this.vtbl.Equals(arguments[0], this)
};
type4_Buch.prototype.ToHashCode = function() {
  return this.vtbl.ToHashCode(this)
};
var vtbl_type5_Seite = {ToString_Str:method13_type7_TObject_12_ToString_Str, Equals:method13_type7_TObject_6_Equals, ToHashCode:method13_type7_TObject_10_ToHashCode};
window["type5_Seite"] = function() {
  this.attr5_Alter_ref = [0];
  this.attr8_Text_Str = "";
  this.vtbl = vtbl_type5_Seite;
  this.attr5_Alter_ref = [global1_l];
  return this
};
window["type5_Seite"].prototype.clone = function() {
  var other = new type5_Seite;
  other.attr5_Alter_ref = tryClone(this.attr5_Alter_ref);
  other.attr8_Text_Str = this.attr8_Text_Str;
  other.vtbl = this.vtbl;
  return other
};
type5_Seite.prototype.ToString_Str = function() {
  return this.vtbl.ToString_Str(this)
};
type5_Seite.prototype.Equals = function() {
  return this.vtbl.Equals(arguments[0], this)
};
type5_Seite.prototype.ToHashCode = function() {
  return this.vtbl.ToHashCode(this)
};
var vtbl_type7_ptrTest = {ToString_Str:method13_type7_TObject_12_ToString_Str, Equals:method13_type7_TObject_6_Equals, ToHashCode:method13_type7_TObject_10_ToHashCode};
window["type7_ptrTest"] = function() {
  this.attr3_ptr = funcPtr;
  this.vtbl = vtbl_type7_ptrTest;
  this.attr3_ptr = func5_func2;
  return this
};
window["type7_ptrTest"].prototype.clone = function() {
  var other = new type7_ptrTest;
  other.attr3_ptr = tryClone(this.attr3_ptr);
  other.vtbl = this.vtbl;
  return other
};
type7_ptrTest.prototype.ToString_Str = function() {
  return this.vtbl.ToString_Str(this)
};
type7_ptrTest.prototype.Equals = function() {
  return this.vtbl.Equals(arguments[0], this)
};
type7_ptrTest.prototype.ToHashCode = function() {
  return this.vtbl.ToHashCode(this)
};
...
var datablock_dataBlock1 = [1, 2, 3, 4, func6_GetInt(), 6, "lol", "roflmao", 2, 3, 4, 5];
var global1_l = 0;
window["initStatics"] = function() {
  static3_GetInt_lol = 200
};
